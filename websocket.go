...
var wsServeSubscribeLazy = func(cfg *WsConfig, handler WsHandler, errHandler ErrHandler) (doneCh, stopCh chan struct{}, subscribeEventCh chan Payload, err error) {
	subscribeEventCh = make(chan Payload)
	...
	if err != nil {
		return nil, nil, subscribeEventCh, err
	}
	c.SetReadLimit(655350)
	doneCh = make(chan struct{})
	stopCh = make(chan struct{})

	// subscribeEventCh = cfg.SubscribeEventCh
	go func() {
