...
// RestAPIClient manages communication with the Dual Investment REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Dual Investment REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-dualinvestment/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
