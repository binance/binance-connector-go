...
// RestAPIClient manages communication with the Binance Dual Investment REST API API v1.2.0
...
// NewRestAPIClient creates a new Binance Binance Dual Investment REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-dualinvestment/1.2.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
