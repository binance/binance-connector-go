# Binance Go Dual Investment SDK
...
```bash
go get github.com/binance/binance-connector-go/clients/dualinvestment
```
...
For information on migrating from previous versions of the Binance Go Dual Investment SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
