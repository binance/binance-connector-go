...
func (a *FlexibleRateAPIService) CheckCollateralRepayRateExecute(r ApiCheckCollateralRepayRateRequest) (*common.RestApiResponse[models.CheckCollateralRepayRateResponse], error) {
	...
	resp, err := SendRequest[models.CheckCollateralRepayRateResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) FlexibleLoanAdjustLtvExecute(r ApiFlexibleLoanAdjustLtvRequest) (*common.RestApiResponse[models.FlexibleLoanAdjustLtvResponse], error) {
	...
	resp, err := SendRequest[models.FlexibleLoanAdjustLtvResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) FlexibleLoanBorrowExecute(r ApiFlexibleLoanBorrowRequest) (*common.RestApiResponse[models.FlexibleLoanBorrowResponse], error) {
	...
	resp, err := SendRequest[models.FlexibleLoanBorrowResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) FlexibleLoanRepayExecute(r ApiFlexibleLoanRepayRequest) (*common.RestApiResponse[models.FlexibleLoanRepayResponse], error) {
	...
	resp, err := SendRequest[models.FlexibleLoanRepayResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanAssetsDataExecute(r ApiGetFlexibleLoanAssetsDataRequest) (*common.RestApiResponse[models.GetFlexibleLoanAssetsDataResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanAssetsDataResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanBorrowHistoryExecute(r ApiGetFlexibleLoanBorrowHistoryRequest) (*common.RestApiResponse[models.GetFlexibleLoanBorrowHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanBorrowHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanCollateralAssetsDataExecute(r ApiGetFlexibleLoanCollateralAssetsDataRequest) (*common.RestApiResponse[models.GetFlexibleLoanCollateralAssetsDataResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanCollateralAssetsDataResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanInterestRateHistoryExecute(r ApiGetFlexibleLoanInterestRateHistoryRequest) (*common.RestApiResponse[models.GetFlexibleLoanInterestRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanInterestRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanLiquidationHistoryExecute(r ApiGetFlexibleLoanLiquidationHistoryRequest) (*common.RestApiResponse[models.GetFlexibleLoanLiquidationHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanLiquidationHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanLtvAdjustmentHistoryExecute(r ApiGetFlexibleLoanLtvAdjustmentHistoryRequest) (*common.RestApiResponse[models.GetFlexibleLoanLtvAdjustmentHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanLtvAdjustmentHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanOngoingOrdersExecute(r ApiGetFlexibleLoanOngoingOrdersRequest) (*common.RestApiResponse[models.GetFlexibleLoanOngoingOrdersResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanOngoingOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleRateAPIService) GetFlexibleLoanRepaymentHistoryExecute(r ApiGetFlexibleLoanRepaymentHistoryRequest) (*common.RestApiResponse[models.GetFlexibleLoanRepaymentHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleLoanRepaymentHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
