...
// RestAPIClient manages communication with the Crypto Loan REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Crypto Loan REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-cryptoloan/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
