...
// checks if the PreviewOtcBlocktradeResponseOrderData type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &PreviewOtcBlocktradeResponseOrderData{}

// PreviewOtcBlocktradeResponseOrderData struct for PreviewOtcBlocktradeResponseOrderData
type PreviewOtcBlocktradeResponseOrderData struct {
...
type _PreviewOtcBlocktradeResponseOrderData PreviewOtcBlocktradeResponseOrderData
...
func NewPreviewOtcBlocktradeResponseOrderData() *PreviewOtcBlocktradeResponseOrderData {
	this := PreviewOtcBlocktradeResponseOrderData{}
	return &this
}
...
func (o *PreviewOtcBlocktradeResponseOrderData) GetPrice() float64 {
...
// and a boolean to check if the value has been set.
func (o *PreviewOtcBlocktradeResponseOrderData) GetPriceOk() (*float64, bool) {
	if o == nil || common.IsNil(o.Price) {
		return nil, false
	}
	return o.Price, true
...
func (o *PreviewOtcBlocktradeResponseOrderData) SetPrice(v float64) {
	o.Price = &v
}
...
func (o PreviewOtcBlocktradeResponseOrderData) MarshalJSON() ([]byte, error) {
...
func (o PreviewOtcBlocktradeResponseOrderData) ToMap() (map[string]interface{}, error) {
...
func (o *PreviewOtcBlocktradeResponseOrderData) UnmarshalJSON(data []byte) (err error) {
	varPreviewOtcBlocktradeResponseOrderData := _PreviewOtcBlocktradeResponseOrderData{}

	err = json.Unmarshal(data, &varPreviewOtcBlocktradeResponseOrderData)

	if err != nil {
		return err
	}

	*o = PreviewOtcBlocktradeResponseOrderData(varPreviewOtcBlocktradeResponseOrderData)
...
type NullablePreviewOtcBlocktradeResponseOrderData struct {
	value *PreviewOtcBlocktradeResponseOrderData
	isSet bool
}

func (v NullablePreviewOtcBlocktradeResponseOrderData) Get() *PreviewOtcBlocktradeResponseOrderData {
	return v.value
}

func (v *NullablePreviewOtcBlocktradeResponseOrderData) Set(val *PreviewOtcBlocktradeResponseOrderData) {
	v.value = val
	v.isSet = true
}

func (v NullablePreviewOtcBlocktradeResponseOrderData) IsSet() bool {
	return v.isSet
}

func (v *NullablePreviewOtcBlocktradeResponseOrderData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePreviewOtcBlocktradeResponseOrderData(val *PreviewOtcBlocktradeResponseOrderData) *NullablePreviewOtcBlocktradeResponseOrderData {
	return &NullablePreviewOtcBlocktradeResponseOrderData{value: val, isSet: true}
}

func (v NullablePreviewOtcBlocktradeResponseOrderData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePreviewOtcBlocktradeResponseOrderData) UnmarshalJSON(src []byte) error {
	v.isSet = true
