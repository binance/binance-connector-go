...
// RestAPIClient manages communication with the Prediction Trading REST API API v1.7.0
...
// NewRestAPIClient creates a new Binance Prediction Trading REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-w3wprediction/1.7.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
	...
	c.WalletAPI = &WalletAPIService{client: c}
