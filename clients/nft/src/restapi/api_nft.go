...
func (a *NFTAPIService) GetNFTAssetExecute(r ApiGetNFTAssetRequest) (*common.RestApiResponse[models.GetNFTAssetResponse], error) {
	...
	resp, err := SendRequest[models.GetNFTAssetResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, true)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *NFTAPIService) GetNFTDepositHistoryExecute(r ApiGetNFTDepositHistoryRequest) (*common.RestApiResponse[models.GetNFTDepositHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetNFTDepositHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, true)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *NFTAPIService) GetNFTTransactionHistoryExecute(r ApiGetNFTTransactionHistoryRequest) (*common.RestApiResponse[models.GetNFTTransactionHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetNFTTransactionHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, true)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *NFTAPIService) GetNFTWithdrawHistoryExecute(r ApiGetNFTWithdrawHistoryRequest) (*common.RestApiResponse[models.GetNFTWithdrawHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetNFTWithdrawHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, true)
	if err != nil || resp == nil {
		return nil, err
	}
