...
```bash
go get github.com/binance/binance-connector-go/clients/nft
```
...
For information on migrating from previous versions of the Binance Go NFT SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
