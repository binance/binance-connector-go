...
**Reject** | Pointer to **int64** | Rejection rate | [optional] 

## Methods

### NewRequestForDetailMinerListResponseDataInnerHashrateDatasInner
...
### NewRequestForDetailMinerListResponseDataInnerHashrateDatasInnerWithDefaults
