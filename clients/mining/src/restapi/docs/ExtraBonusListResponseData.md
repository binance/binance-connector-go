...
------------ | ------------- | ------------- | -------------
**OtherProfits** | Pointer to [**[]ExtraBonusListResponseDataOtherProfitsInner**](ExtraBonusListResponseDataOtherProfitsInner.md) |  | [optional] 
**TotalNum** | Pointer to **int64** | Total rows | [optional] 
**PageSize** | Pointer to **int64** | Rows per page | [optional] 

## Methods

### NewExtraBonusListResponseData
...
### NewExtraBonusListResponseDataWithDefaults
