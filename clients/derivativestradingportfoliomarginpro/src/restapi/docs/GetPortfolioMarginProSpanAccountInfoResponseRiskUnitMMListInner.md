...
### NewGetPortfolioMarginProSpanAccountInfoResponseRiskUnitMMListInner
...
### NewGetPortfolioMarginProSpanAccountInfoResponseRiskUnitMMListInnerWithDefaults
...
GetUniMaintainUsd returns the UniMaintainUsd field if non-nil, zero value otherwise.

### GetUniMaintainUsdOk

`func (o *GetPortfolioMarginProSpanAccountInfoResponseRiskUnitMMListInner) GetUniMaintainUsdOk() (*string, bool)`

GetUniMaintainUsdOk returns a tuple with the UniMaintainUsd field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetUniMaintainUsd sets UniMaintainUsd field to given value.
