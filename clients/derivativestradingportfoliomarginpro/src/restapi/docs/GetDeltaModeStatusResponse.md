...
### NewGetDeltaModeStatusResponseWithDefaults
...
GetDeltaEnabled returns the DeltaEnabled field if non-nil, zero value otherwise.

### GetDeltaEnabledOk

`func (o *GetDeltaModeStatusResponse) GetDeltaEnabledOk() (*bool, bool)`

GetDeltaEnabledOk returns a tuple with the DeltaEnabled field if it's non-nil, zero value otherwise
...
SetDeltaEnabled sets DeltaEnabled field to given value.
