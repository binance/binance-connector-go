...
// RestAPIClient manages communication with the Portfolio Margin Pro REST API API v1.10.2
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingportfoliomarginpro/1.10.2 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
