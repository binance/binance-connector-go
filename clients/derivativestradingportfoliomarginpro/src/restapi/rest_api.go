...
// RestAPIClient manages communication with the Portfolio Margin Pro REST API API v1.7.0
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingportfoliomarginpro/1.7.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
