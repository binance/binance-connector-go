...
// WebsocketStreamsClient manages communication with the Binance Binance Derivatives Trading Portfolio Margin Pro WebSocket Market Streams WebSocket Streams v1.3.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingportfoliomarginpro/1.3.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
