...
// WebsocketStreamsClient manages communication with the Binance Portfolio Margin Pro WebSocket Market Streams WebSocket Streams v1.8.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingportfoliomarginpro/1.8.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
