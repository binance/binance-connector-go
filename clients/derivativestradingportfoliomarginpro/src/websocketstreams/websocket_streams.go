...
// WebsocketStreamsClient manages communication with the Binance Portfolio Margin Pro WebSocket Market Streams WebSocket Streams v1.10.2
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingportfoliomarginpro/1.10.2 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
