...
**PriceChange** | Pointer to **string** | 24-hour price change | [optional] 
**PriceChangePercent** | Pointer to **string** | 24-hour percent price change | [optional] 
**LastPrice** | Pointer to **string** | Last trade price | [optional] 
**LastQty** | Pointer to **string** | Last trade amount | [optional] 
**Open** | Pointer to **string** | 24-hour open price | [optional] 
**High** | Pointer to **string** | 24-hour high | [optional] 
**Low** | Pointer to **string** | 24-hour low | [optional] 
**Volume** | Pointer to **string** | Trading volume(contracts) | [optional] 
**Amount** | Pointer to **string** | Trade amount(in quote asset) | [optional] 
**BidPrice** | Pointer to **string** | The best buy price | [optional] 
**AskPrice** | Pointer to **string** | The best sell price | [optional] 
**OpenTime** | Pointer to **int64** | Time the first trade occurred within the last 24 hours | [optional] 
**CloseTime** | Pointer to **int64** | Time the last trade occurred within the last 24 hours | [optional] 
**FirstTradeId** | Pointer to **int64** | First trade ID | [optional] 
**TradeCount** | Pointer to **int64** | Number of trades | [optional] 
**StrikePrice** | Pointer to **string** | Strike price | [optional] 
**ExercisePrice** | Pointer to **string** | return estimated settlement price one hour before exercise, return index price at other times | [optional] 

## Methods

### NewTicker24hrPriceChangeStatisticsResponseInner
...
### NewTicker24hrPriceChangeStatisticsResponseInnerWithDefaults
