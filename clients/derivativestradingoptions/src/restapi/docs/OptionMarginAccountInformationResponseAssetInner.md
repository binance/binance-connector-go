...
### NewOptionMarginAccountInformationResponseAssetInner
...
### NewOptionMarginAccountInformationResponseAssetInnerWithDefaults
...
GetAdjustedEquity returns the AdjustedEquity field if non-nil, zero value otherwise.

### GetAdjustedEquityOk

`func (o *OptionMarginAccountInformationResponseAssetInner) GetAdjustedEquityOk() (*string, bool)`

GetAdjustedEquityOk returns a tuple with the AdjustedEquity field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetAdjustedEquity sets AdjustedEquity field to given value.
