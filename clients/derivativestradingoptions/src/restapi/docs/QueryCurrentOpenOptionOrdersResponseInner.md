...
**ExecutedQty** | Pointer to **string** | Number of completed trades | [optional] 
...
### NewQueryCurrentOpenOptionOrdersResponseInner
...
### NewQueryCurrentOpenOptionOrdersResponseInnerWithDefaults
