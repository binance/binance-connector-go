...
### NewUserCommissionResponseCommissionsInner
...
### NewUserCommissionResponseCommissionsInnerWithDefaults
...
GetMakerFee returns the MakerFee field if non-nil, zero value otherwise.

### GetMakerFeeOk

`func (o *UserCommissionResponseCommissionsInner) GetMakerFeeOk() (*string, bool)`

GetMakerFeeOk returns a tuple with the MakerFee field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetMakerFee sets MakerFee field to given value.
...
GetTakerFee returns the TakerFee field if non-nil, zero value otherwise.

### GetTakerFeeOk

`func (o *UserCommissionResponseCommissionsInner) GetTakerFeeOk() (*string, bool)`

GetTakerFeeOk returns a tuple with the TakerFee field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetTakerFee sets TakerFee field to given value.
