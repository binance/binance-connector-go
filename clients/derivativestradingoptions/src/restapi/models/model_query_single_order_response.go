...
// checks if the QuerySingleOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &QuerySingleOrderResponse{}
...
func (o QuerySingleOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QuerySingleOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varQuerySingleOrderResponse := _QuerySingleOrderResponse{}

	err = json.Unmarshal(data, &varQuerySingleOrderResponse)

	if err != nil {
		return err
	}

	*o = QuerySingleOrderResponse(varQuerySingleOrderResponse)
...
type NullableQuerySingleOrderResponse struct {
	value *QuerySingleOrderResponse
	isSet bool
}

func (v NullableQuerySingleOrderResponse) Get() *QuerySingleOrderResponse {
	return v.value
}

func (v *NullableQuerySingleOrderResponse) Set(val *QuerySingleOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQuerySingleOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQuerySingleOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuerySingleOrderResponse(val *QuerySingleOrderResponse) *NullableQuerySingleOrderResponse {
	return &NullableQuerySingleOrderResponse{value: val, isSet: true}
}

func (v NullableQuerySingleOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuerySingleOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
