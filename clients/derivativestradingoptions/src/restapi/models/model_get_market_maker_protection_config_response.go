...
// checks if the GetMarketMakerProtectionConfigResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &GetMarketMakerProtectionConfigResponse{}
...
func NewGetMarketMakerProtectionConfigResponse() *GetMarketMakerProtectionConfigResponse {
	this := GetMarketMakerProtectionConfigResponse{}
	return &this
}
...
func (o GetMarketMakerProtectionConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o GetMarketMakerProtectionConfigResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GetMarketMakerProtectionConfigResponse) UnmarshalJSON(data []byte) (err error) {
	varGetMarketMakerProtectionConfigResponse := _GetMarketMakerProtectionConfigResponse{}

	err = json.Unmarshal(data, &varGetMarketMakerProtectionConfigResponse)

	if err != nil {
		return err
	}

	*o = GetMarketMakerProtectionConfigResponse(varGetMarketMakerProtectionConfigResponse)
...
type NullableGetMarketMakerProtectionConfigResponse struct {
	value *GetMarketMakerProtectionConfigResponse
	isSet bool
}

func (v NullableGetMarketMakerProtectionConfigResponse) Get() *GetMarketMakerProtectionConfigResponse {
	return v.value
}

func (v *NullableGetMarketMakerProtectionConfigResponse) Set(val *GetMarketMakerProtectionConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetMarketMakerProtectionConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetMarketMakerProtectionConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetMarketMakerProtectionConfigResponse(val *GetMarketMakerProtectionConfigResponse) *NullableGetMarketMakerProtectionConfigResponse {
	return &NullableGetMarketMakerProtectionConfigResponse{value: val, isSet: true}
}

func (v NullableGetMarketMakerProtectionConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetMarketMakerProtectionConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
