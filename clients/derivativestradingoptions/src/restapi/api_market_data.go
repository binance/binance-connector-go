...
func (a *MarketDataAPIService) HistoricalExerciseRecordsExecute(r ApiHistoricalExerciseRecordsRequest) (*common.RestApiResponse[models.HistoricalExerciseRecordsResponse], error) {
	...
	resp, err := SendRequest[models.HistoricalExerciseRecordsResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *MarketDataAPIService) IndexPriceExecute(r ApiIndexPriceRequest) (*common.RestApiResponse[models.IndexPriceResponse], error) {
	...
	resp, err := SendRequest[models.IndexPriceResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
type ApiKlineCandlestickDataRequest struct {
	...
	ApiService *MarketDataAPIService
	symbol     *string
	interval   *models.KlineCandlestickDataIntervalParameter
	startTime  *int64
	endTime    *int64
	limit      *int64
}
...
// Time interval
func (r ApiKlineCandlestickDataRequest) Interval(interval models.KlineCandlestickDataIntervalParameter) ApiKlineCandlestickDataRequest {
	r.interval = &interval
	return r
}
...
func (a *MarketDataAPIService) OptionMarkPriceExecute(r ApiOptionMarkPriceRequest) (*common.RestApiResponse[models.OptionMarkPriceResponse], error) {
	...
	resp, err := SendRequest[models.OptionMarkPriceResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *MarketDataAPIService) RecentBlockTradesListExecute(r ApiRecentBlockTradesListRequest) (*common.RestApiResponse[models.RecentBlockTradesListResponse], error) {
	...
	resp, err := SendRequest[models.RecentBlockTradesListResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
