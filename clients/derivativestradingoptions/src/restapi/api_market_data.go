...
func (a *MarketDataAPIService) HistoricalExerciseRecordsExecute(r ApiHistoricalExerciseRecordsRequest) (*common.RestApiResponse[models.HistoricalExerciseRecordsResponse], error) {
	...
	resp, err := SendRequest[models.HistoricalExerciseRecordsResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, false)
	if err != nil || resp == nil {
		return nil, err
	}
...
type ApiIndexPriceRequest struct {
	ctx        context.Context
	ApiService *MarketDataAPIService
	underlying *string
}
...
func (r ApiIndexPriceRequest) Underlying(underlying string) ApiIndexPriceRequest {
	r.underlying = &underlying
	return r
}

func (r ApiIndexPriceRequest) Execute() (*common.RestApiResponse[models.IndexPriceResponse], error) {
	return r.ApiService.IndexPriceExecute(r)
}
...
@return ApiIndexPriceRequest
*/
func (a *MarketDataAPIService) IndexPrice(ctx context.Context) ApiIndexPriceRequest {
	return ApiIndexPriceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *MarketDataAPIService) IndexPriceExecute(r ApiIndexPriceRequest) (*common.RestApiResponse[models.IndexPriceResponse], error) {
	localVarHTTPMethod := http.MethodGet
	...
	resp, err := SendRequest[models.IndexPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, false)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) OptionMarkPriceExecute(r ApiOptionMarkPriceRequest) (*common.RestApiResponse[models.OptionMarkPriceResponse], error) {
	...
	resp, err := SendRequest[models.OptionMarkPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, false)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) RecentBlockTradesListExecute(r ApiRecentBlockTradesListRequest) (*common.RestApiResponse[models.RecentBlockTradesListResponse], error) {
	...
	resp, err := SendRequest[models.RecentBlockTradesListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, false)
	if err != nil || resp == nil {
		return nil, err
	}
