...
func (a *FlexibleLockedAPIService) GetCollateralRecordExecute(r ApiGetCollateralRecordRequest) (*common.RestApiResponse[models.GetCollateralRecordResponse], error) {
	...
	resp, err := SendRequest[models.GetCollateralRecordResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexiblePersonalLeftQuotaExecute(r ApiGetFlexiblePersonalLeftQuotaRequest) (*common.RestApiResponse[models.GetFlexiblePersonalLeftQuotaResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexiblePersonalLeftQuotaResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexibleProductPositionExecute(r ApiGetFlexibleProductPositionRequest) (*common.RestApiResponse[models.GetFlexibleProductPositionResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleProductPositionResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexibleRedemptionRecordExecute(r ApiGetFlexibleRedemptionRecordRequest) (*common.RestApiResponse[models.GetFlexibleRedemptionRecordResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleRedemptionRecordResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexibleRewardsHistoryExecute(r ApiGetFlexibleRewardsHistoryRequest) (*common.RestApiResponse[models.GetFlexibleRewardsHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleRewardsHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexibleSubscriptionPreviewExecute(r ApiGetFlexibleSubscriptionPreviewRequest) (*common.RestApiResponse[models.GetFlexibleSubscriptionPreviewResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleSubscriptionPreviewResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetFlexibleSubscriptionRecordExecute(r ApiGetFlexibleSubscriptionRecordRequest) (*common.RestApiResponse[models.GetFlexibleSubscriptionRecordResponse], error) {
	...
	resp, err := SendRequest[models.GetFlexibleSubscriptionRecordResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedPersonalLeftQuotaExecute(r ApiGetLockedPersonalLeftQuotaRequest) (*common.RestApiResponse[models.GetLockedPersonalLeftQuotaResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedPersonalLeftQuotaResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedProductPositionExecute(r ApiGetLockedProductPositionRequest) (*common.RestApiResponse[models.GetLockedProductPositionResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedProductPositionResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedRedemptionRecordExecute(r ApiGetLockedRedemptionRecordRequest) (*common.RestApiResponse[models.GetLockedRedemptionRecordResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedRedemptionRecordResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedRewardsHistoryExecute(r ApiGetLockedRewardsHistoryRequest) (*common.RestApiResponse[models.GetLockedRewardsHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedRewardsHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedSubscriptionPreviewExecute(r ApiGetLockedSubscriptionPreviewRequest) (*common.RestApiResponse[models.GetLockedSubscriptionPreviewResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedSubscriptionPreviewResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetLockedSubscriptionRecordExecute(r ApiGetLockedSubscriptionRecordRequest) (*common.RestApiResponse[models.GetLockedSubscriptionRecordResponse], error) {
	...
	resp, err := SendRequest[models.GetLockedSubscriptionRecordResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetRateHistoryExecute(r ApiGetRateHistoryRequest) (*common.RestApiResponse[models.GetRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetSimpleEarnFlexibleProductListExecute(r ApiGetSimpleEarnFlexibleProductListRequest) (*common.RestApiResponse[models.GetSimpleEarnFlexibleProductListResponse], error) {
	...
	resp, err := SendRequest[models.GetSimpleEarnFlexibleProductListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) GetSimpleEarnLockedProductListExecute(r ApiGetSimpleEarnLockedProductListRequest) (*common.RestApiResponse[models.GetSimpleEarnLockedProductListResponse], error) {
	...
	resp, err := SendRequest[models.GetSimpleEarnLockedProductListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) RedeemFlexibleProductExecute(r ApiRedeemFlexibleProductRequest) (*common.RestApiResponse[models.RedeemFlexibleProductResponse], error) {
	...
	resp, err := SendRequest[models.RedeemFlexibleProductResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) RedeemLockedProductExecute(r ApiRedeemLockedProductRequest) (*common.RestApiResponse[models.RedeemLockedProductResponse], error) {
	...
	resp, err := SendRequest[models.RedeemLockedProductResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SetFlexibleAutoSubscribeExecute(r ApiSetFlexibleAutoSubscribeRequest) (*common.RestApiResponse[models.SetFlexibleAutoSubscribeResponse], error) {
	...
	resp, err := SendRequest[models.SetFlexibleAutoSubscribeResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SetLockedAutoSubscribeExecute(r ApiSetLockedAutoSubscribeRequest) (*common.RestApiResponse[models.SetLockedAutoSubscribeResponse], error) {
	...
	resp, err := SendRequest[models.SetLockedAutoSubscribeResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SetLockedProductRedeemOptionExecute(r ApiSetLockedProductRedeemOptionRequest) (*common.RestApiResponse[models.SetLockedProductRedeemOptionResponse], error) {
	...
	resp, err := SendRequest[models.SetLockedProductRedeemOptionResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SimpleAccountExecute(r ApiSimpleAccountRequest) (*common.RestApiResponse[models.SimpleAccountResponse], error) {
	...
	resp, err := SendRequest[models.SimpleAccountResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SubscribeFlexibleProductExecute(r ApiSubscribeFlexibleProductRequest) (*common.RestApiResponse[models.SubscribeFlexibleProductResponse], error) {
	...
	resp, err := SendRequest[models.SubscribeFlexibleProductResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FlexibleLockedAPIService) SubscribeLockedProductExecute(r ApiSubscribeLockedProductRequest) (*common.RestApiResponse[models.SubscribeLockedProductResponse], error) {
	...
	resp, err := SendRequest[models.SubscribeLockedProductResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
