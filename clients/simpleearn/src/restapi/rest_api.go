...
// RestAPIClient manages communication with the Simple Earn REST API API v1.11.0
type RestAPIClient struct {
	...
	YieldArenaAPI     *YieldArenaAPIService
}
...
// NewRestAPIClient creates a new Binance Simple Earn REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-simpleearn/1.11.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
	...
	c.YieldArenaAPI = &YieldArenaAPIService{client: c}
