...
```bash
go get github.com/binance/binance-connector-go/clients/simpleearn
```
...
func GetSimpleEarnFlexibleProductList() {
...
For information on migrating from previous versions of the Binance Go Simple Earn SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
