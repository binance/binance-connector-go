...
func GetFlexibleSubscriptionPreview() {
	...
	resp, err := apiClient.RestApi.FlexibleLockedAPI.GetFlexibleSubscriptionPreview(context.Background()).ProductId("1").Amount(1.0).Execute()
	if err != nil {
		log.Println(err)
		return
	}
