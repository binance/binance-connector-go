...
func GetLockedSubscriptionPreview() {
	...
	resp, err := apiClient.RestApi.FlexibleLockedAPI.GetLockedSubscriptionPreview(context.Background()).ProjectId("1").Amount(1.0).Execute()
	if err != nil {
		log.Println(err)
		return
	}
