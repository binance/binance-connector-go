...
func ContinuousContractKlineCandlestickStreams() {
	...
	handler, err := wsClient.WebsocketStreams.DefaultAPI.ContinuousContractKlineCandlestickStreams().Pair("btcusdt").ContractType(models.ContinuousContractKlineCandlestickStreamsContractTypeParameterPerpetual).Interval(models.ContinuousContractKlineCandlestickStreamsIntervalParameterInterval1m).Execute()
	if err != nil {
