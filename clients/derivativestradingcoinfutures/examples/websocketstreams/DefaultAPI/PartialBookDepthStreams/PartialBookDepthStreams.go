...
func PartialBookDepthStreams() {
	...
	handler, err := wsClient.WebsocketStreams.DefaultAPI.PartialBookDepthStreams().Symbol("btcusdt").Levels(models.PartialBookDepthStreamsLevelsParameterLevels5).Execute()
	if err != nil {
