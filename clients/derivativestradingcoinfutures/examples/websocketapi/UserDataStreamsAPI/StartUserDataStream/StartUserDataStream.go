...
func StartUserDataStream() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.UserDataStreamsAPI.StartUserDataStream().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing StartUserDataStream request: %v\n", err)
		return
	}
