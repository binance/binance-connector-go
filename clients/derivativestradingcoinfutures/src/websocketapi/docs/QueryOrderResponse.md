...
**RateLimits** | Pointer to [**[]CancelOrderResponseRateLimitsInner**](CancelOrderResponseRateLimitsInner.md) | Rate limit definitions. | [optional] 
...
`func (o *QueryOrderResponse) GetRateLimits() []CancelOrderResponseRateLimitsInner`

GetRateLimits returns the RateLimits field if non-nil, zero value otherwise.

### GetRateLimitsOk

`func (o *QueryOrderResponse) GetRateLimitsOk() (*[]CancelOrderResponseRateLimitsInner, bool)`
...
`func (o *QueryOrderResponse) SetRateLimits(v []CancelOrderResponseRateLimitsInner)`

SetRateLimits sets RateLimits field to given value.

### HasRateLimits

`func (o *QueryOrderResponse) HasRateLimits() bool`
