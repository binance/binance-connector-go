...
// WebsocketAPIClient manages communication with the Binance Binance Derivatives Trading COIN Futures WebSocket API WebSocketAPI v1.4.0
...
func NewWebsocketAPIClient(cfg *common.ConfigurationWebsocketApi) *WebsocketAPIClient {
	...
	c := &WebsocketAPIClient{
		cfg:                cfg,
		userAgent:          "binance-derivativestradingcoinfutures/1.4.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")",
		Ws:                 wsClient,
