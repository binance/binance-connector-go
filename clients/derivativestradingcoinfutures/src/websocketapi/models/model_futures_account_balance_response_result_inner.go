...
// checks if the FuturesAccountBalanceResponseResultInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &FuturesAccountBalanceResponseResultInner{}
...
type _FuturesAccountBalanceResponseResultInner FuturesAccountBalanceResponseResultInner
...
func NewFuturesAccountBalanceResponseResultInner() *FuturesAccountBalanceResponseResultInner {
	this := FuturesAccountBalanceResponseResultInner{}
	return &this
}
...
func (o *FuturesAccountBalanceResponseResultInner) GetWithdrawAvailable() string {
...
// and a boolean to check if the value has been set.
func (o *FuturesAccountBalanceResponseResultInner) GetWithdrawAvailableOk() (*string, bool) {
	if o == nil || common.IsNil(o.WithdrawAvailable) {
		return nil, false
	}
...
func (o *FuturesAccountBalanceResponseResultInner) HasWithdrawAvailable() bool {
	if o != nil && !common.IsNil(o.WithdrawAvailable) {
		return true
	}
...
func (o *FuturesAccountBalanceResponseResultInner) SetWithdrawAvailable(v string) {
...
func (o FuturesAccountBalanceResponseResultInner) MarshalJSON() ([]byte, error) {
...
func (o FuturesAccountBalanceResponseResultInner) ToMap() (map[string]interface{}, error) {
...
func (o *FuturesAccountBalanceResponseResultInner) UnmarshalJSON(data []byte) (err error) {
	varFuturesAccountBalanceResponseResultInner := _FuturesAccountBalanceResponseResultInner{}

	err = json.Unmarshal(data, &varFuturesAccountBalanceResponseResultInner)

	if err != nil {
		return err
	}

	*o = FuturesAccountBalanceResponseResultInner(varFuturesAccountBalanceResponseResultInner)
...
type NullableFuturesAccountBalanceResponseResultInner struct {
	value *FuturesAccountBalanceResponseResultInner
	isSet bool
}

func (v NullableFuturesAccountBalanceResponseResultInner) Get() *FuturesAccountBalanceResponseResultInner {
	return v.value
}

func (v *NullableFuturesAccountBalanceResponseResultInner) Set(val *FuturesAccountBalanceResponseResultInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFuturesAccountBalanceResponseResultInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFuturesAccountBalanceResponseResultInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFuturesAccountBalanceResponseResultInner(val *FuturesAccountBalanceResponseResultInner) *NullableFuturesAccountBalanceResponseResultInner {
	return &NullableFuturesAccountBalanceResponseResultInner{value: val, isSet: true}
}

func (v NullableFuturesAccountBalanceResponseResultInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFuturesAccountBalanceResponseResultInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
