...
https://developers.binance.com/docs/derivatives/coin-margined-futures/portfolio-margin-endpoints/Classic-Portfolio-Margin-Account-Information
...
func (a *PortfolioMarginEndpointsAPIService) ClassicPortfolioMarginAccountInformationExecute(r ApiClassicPortfolioMarginAccountInformationRequest) (*common.RestApiResponse[models.ClassicPortfolioMarginAccountInformationResponse], error) {
	...
	localVarPath := a.client.cfg.BasePath + "/dapi/v1/pmAccountInfo"
	...
	resp, err := SendRequest[models.ClassicPortfolioMarginAccountInformationResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg, true)
	if err != nil || resp == nil {
		return nil, err
	}
