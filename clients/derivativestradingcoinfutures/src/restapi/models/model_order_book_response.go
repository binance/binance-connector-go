...
func (o *OrderBookResponse) GetSymbol() string {
...
// and a boolean to check if the value has been set.
func (o *OrderBookResponse) GetSymbolOk() (*string, bool) {
	if o == nil || common.IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *OrderBookResponse) HasSymbol() bool {
	if o != nil && !common.IsNil(o.Symbol) {
		return true
	}
...
func (o *OrderBookResponse) SetSymbol(v string) {
	o.Symbol = &v
}

// GetPair returns the Pair field value if set, zero value otherwise.
func (o *OrderBookResponse) GetPair() string {
...
// and a boolean to check if the value has been set.
func (o *OrderBookResponse) GetPairOk() (*string, bool) {
	if o == nil || common.IsNil(o.Pair) {
		return nil, false
	}
	return o.Pair, true
...
func (o *OrderBookResponse) HasPair() bool {
	if o != nil && !common.IsNil(o.Pair) {
		return true
	}
...
func (o *OrderBookResponse) SetPair(v string) {
	o.Pair = &v
}
