...
func (o *ExchangeInformationResponseSymbolsInner) GetContractStatus() string {
	if o == nil || common.IsNil(o.ContractStatus) {
		var ret string
		return ret
	}
...
func (o *ExchangeInformationResponseSymbolsInner) GetContractSize() int64 {
	if o == nil || common.IsNil(o.ContractSize) {
		var ret int64
		return ret
	}
...
// SetContractSize gets a reference to the given int64 and assigns it to the ContractSize field.
...
func (o *ExchangeInformationResponseSymbolsInner) GetEqualQtyPrecision() int64 {
	if o == nil || common.IsNil(o.EqualQtyPrecision) {
		var ret int64
		return ret
	}
...
// SetEqualQtyPrecision gets a reference to the given int64 and assigns it to the EqualQtyPrecision field.
...
func (o ExchangeInformationResponseSymbolsInner) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.ContractStatus) {
		toSerialize["contractStatus"] = o.ContractStatus
	}
	if !common.IsNil(o.ContractSize) {
	...
	if !common.IsNil(o.EqualQtyPrecision) {
...
func (o *ExchangeInformationResponseSymbolsInner) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ExchangeInformationResponseSymbolsInner(varExchangeInformationResponseSymbolsInner)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "equalQtyPrecision")
