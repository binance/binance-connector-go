...
------------ | ------------- | ------------- | -------------
**Before** | Pointer to **string** | Before value. | [optional] 
**After** | Pointer to **string** | After value. | [optional] 

## Methods

### NewGetOrderModifyHistoryResponseInnerAmendmentOrigQty
...
### NewGetOrderModifyHistoryResponseInnerAmendmentOrigQtyWithDefaults
