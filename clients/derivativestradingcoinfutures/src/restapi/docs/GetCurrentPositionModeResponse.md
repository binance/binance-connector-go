...
------------ | ------------- | ------------- | -------------
**DualSidePosition** | Pointer to **bool** | Whether dual-side position mode is enabled. | [optional] 

## Methods

### NewGetCurrentPositionModeResponse
...
### NewGetCurrentPositionModeResponseWithDefaults
