...
### NewTakerBuySellVolumeResponseInner
...
### NewTakerBuySellVolumeResponseInnerWithDefaults
...
GetTakerSellVolValue returns the TakerSellVolValue field if non-nil, zero value otherwise.
