...
`func (o *NotionalBracketForSymbolResponseInner) GetNotionalCoef() float64`

GetNotionalCoef returns the NotionalCoef field if non-nil, zero value otherwise.

### GetNotionalCoefOk

`func (o *NotionalBracketForSymbolResponseInner) GetNotionalCoefOk() (*float64, bool)`
...
`func (o *NotionalBracketForSymbolResponseInner) SetNotionalCoef(v float64)`
