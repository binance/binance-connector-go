...
------------ | ------------- | ------------- | -------------
**Filters** | Pointer to [**[]ExchangeInformationResponseSymbolsInnerFiltersInner**](ExchangeInformationResponseSymbolsInnerFiltersInner.md) | Trading filters and constraints. | [optional] 
**OrderTypes** | Pointer to **[]string** | Supported order types. | [optional] 
**TimeInForce** | Pointer to **[]string** | Time in force | [optional] 
**LiquidationFee** | Pointer to **string** | liquidation fee rate | [optional] 
**MarketTakeBound** | Pointer to **string** | the max price difference rate( from mark price) a market order can make | [optional] 
...
**DeliveryDate** | Pointer to **int64** | Delivery timestamp. | [optional] 
**OnboardDate** | Pointer to **int64** | Onboard timestamp. | [optional] 
**ContractStatus** | Pointer to **string** | Contract status. | [optional] 
**ContractSize** | Pointer to **int64** | Contract size. | [optional] 
...
**PricePrecision** | Pointer to **int64** | please do not use it as tickSize | [optional] 
**QuantityPrecision** | Pointer to **int64** | please do not use it as stepSize | [optional] 
...
**EqualQtyPrecision** | Pointer to **int64** | ignore | [optional] 
**TriggerProtect** | Pointer to **string** | threshold for algo order with \&quot;priceProtect\&quot; | [optional] 
**MaintMarginPercent** | Pointer to **string** | ignore | [optional] 
**RequiredMarginPercent** | Pointer to **string** | ignore | [optional] 
**UnderlyingType** | Pointer to **string** | Underlying asset type. | [optional] 
**UnderlyingSubType** | Pointer to **[]string** | Underlying asset sub-type. | [optional] 
