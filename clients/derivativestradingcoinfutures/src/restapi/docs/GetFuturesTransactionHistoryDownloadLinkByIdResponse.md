...
**IsExpired** | Pointer to **string** | Whether the record is expired. | [optional] 

## Methods

### NewGetFuturesTransactionHistoryDownloadLinkByIdResponse
...
### NewGetFuturesTransactionHistoryDownloadLinkByIdResponseWithDefaults
