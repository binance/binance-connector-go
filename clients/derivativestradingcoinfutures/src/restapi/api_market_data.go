...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param pair -  After CM migration, accepts both CM and UM pair values.
@param contractType -
...
func (a *MarketDataAPIService) GetFundingRateHistoryOfPerpetualFuturesExecute(r ApiGetFundingRateHistoryOfPerpetualFuturesRequest) (*common.RestApiResponse[models.GetFundingRateHistoryOfPerpetualFuturesResponse], error) {
	...
	resp, err := SendRequest[models.GetFundingRateHistoryOfPerpetualFuturesResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *MarketDataAPIService) IndexPriceAndMarkPriceExecute(r ApiIndexPriceAndMarkPriceRequest) (*common.RestApiResponse[models.IndexPriceAndMarkPriceResponse], error) {
	...
	resp, err := SendRequest[models.IndexPriceAndMarkPriceResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param symbol -  After CM migration, accepts both CM and UM symbols.
@param interval -  Interval
@param startTime -  Start time
@param endTime -  End time
@param limit -  Maximum number of records to return.
...
/*
TopTraderLongShortRatioAccounts Top Trader Long/Short Account Ratio
...
/*
TopTraderLongShortRatioPositions Top Trader Long/Short Position Ratio
