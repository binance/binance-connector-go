...
// WebsocketStreamsClient manages communication with the Binance Futures (COIN-M) WebSocket Market Streams WebSocket Streams v1.11.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingcoinfutures/1.11.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
