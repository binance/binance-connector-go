...
// WebsocketStreamsClient manages communication with the Binance Futures (COIN-M) WebSocket Market Streams WebSocket Streams v1.13.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingcoinfutures/1.13.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
