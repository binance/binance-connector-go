...
// WebsocketStreamsClient manages communication with the Binance Futures (COIN-M) WebSocket Market Streams WebSocket Streams v1.19.1
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingcoinfutures/1.19.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
