...
**Ma** | Pointer to **string** | Margin Asset | [optional] 
...
**B** | Pointer to **string** | Bid quantity of base asset | [optional] 
**A** | Pointer to **string** | Ask quantity of base asset | [optional] 
...
**PP** | Pointer to **bool** | If conditional order trigger is protected | [optional] 
...
`func (o *OrderTradeUpdateO) GetMa() string`

GetMa returns the Ma field if non-nil, zero value otherwise.

### GetMaOk

`func (o *OrderTradeUpdateO) GetMaOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetMa(v string)`

SetMa sets Ma field to given value.

### HasMa

`func (o *OrderTradeUpdateO) HasMa() bool`
