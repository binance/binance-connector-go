...
// RestAPIClient manages communication with the Copy Trading REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Copy Trading REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-copytrading/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
