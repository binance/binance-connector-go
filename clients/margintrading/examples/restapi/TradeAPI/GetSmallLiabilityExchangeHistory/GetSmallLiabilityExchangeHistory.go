...
func GetSmallLiabilityExchangeHistory() {
	...
	resp, err := apiClient.RestApi.TradeAPI.GetSmallLiabilityExchangeHistory(context.Background()).Current(1).Size(10).Execute()
	if err != nil {
		log.Println(err)
		return
	}
