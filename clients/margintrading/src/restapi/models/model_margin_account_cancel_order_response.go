...
// checks if the MarginAccountCancelOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &MarginAccountCancelOrderResponse{}
...
type _MarginAccountCancelOrderResponse MarginAccountCancelOrderResponse
...
func NewMarginAccountCancelOrderResponse() *MarginAccountCancelOrderResponse {
	this := MarginAccountCancelOrderResponse{}
	return &this
}
...
func (o MarginAccountCancelOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *MarginAccountCancelOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varMarginAccountCancelOrderResponse := _MarginAccountCancelOrderResponse{}

	err = json.Unmarshal(data, &varMarginAccountCancelOrderResponse)

	if err != nil {
		return err
	}

	*o = MarginAccountCancelOrderResponse(varMarginAccountCancelOrderResponse)
...
type NullableMarginAccountCancelOrderResponse struct {
	value *MarginAccountCancelOrderResponse
	isSet bool
}

func (v NullableMarginAccountCancelOrderResponse) Get() *MarginAccountCancelOrderResponse {
	return v.value
}

func (v *NullableMarginAccountCancelOrderResponse) Set(val *MarginAccountCancelOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMarginAccountCancelOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMarginAccountCancelOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarginAccountCancelOrderResponse(val *MarginAccountCancelOrderResponse) *NullableMarginAccountCancelOrderResponse {
	return &NullableMarginAccountCancelOrderResponse{value: val, isSet: true}
}

func (v NullableMarginAccountCancelOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarginAccountCancelOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
