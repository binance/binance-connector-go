...
### NewGetLimitPricePairsResponseWithDefaults
...
GetCrossMarginSymbols returns the CrossMarginSymbols field if non-nil, zero value otherwise.

### GetCrossMarginSymbolsOk

`func (o *GetLimitPricePairsResponse) GetCrossMarginSymbolsOk() (*[]string, bool)`

GetCrossMarginSymbolsOk returns a tuple with the CrossMarginSymbols field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetCrossMarginSymbols

`func (o *GetLimitPricePairsResponse) SetCrossMarginSymbols(v []string)`

SetCrossMarginSymbols sets CrossMarginSymbols field to given value.

### HasCrossMarginSymbols
