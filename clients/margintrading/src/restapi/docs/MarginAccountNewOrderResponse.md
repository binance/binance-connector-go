...
**MarginBuyBorrowAmount** | Pointer to **int64** | margin Buy Borrow Amount. | [optional] 
**MarginBuyBorrowAsset** | Pointer to **string** | margin Buy Borrow Asset. | [optional] 
**Fills** | Pointer to [**[]MarginAccountNewOrderResponseFillsInner**](MarginAccountNewOrderResponseFillsInner.md) | fills list. | [optional] 
