...
### NewGetMarginAssetRiskBasedLiquidationRatioResponseInner
...
### NewGetMarginAssetRiskBasedLiquidationRatioResponseInnerWithDefaults
...
### GetRiskBasedLiquidationRatio

`func (o *GetMarginAssetRiskBasedLiquidationRatioResponseInner) GetRiskBasedLiquidationRatio() string`

GetRiskBasedLiquidationRatio returns the RiskBasedLiquidationRatio field if non-nil, zero value otherwise.

### GetRiskBasedLiquidationRatioOk

`func (o *GetMarginAssetRiskBasedLiquidationRatioResponseInner) GetRiskBasedLiquidationRatioOk() (*string, bool)`

GetRiskBasedLiquidationRatioOk returns a tuple with the RiskBasedLiquidationRatio field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetRiskBasedLiquidationRatio

`func (o *GetMarginAssetRiskBasedLiquidationRatioResponseInner) SetRiskBasedLiquidationRatio(v string)`

SetRiskBasedLiquidationRatio sets RiskBasedLiquidationRatio field to given value.

### HasRiskBasedLiquidationRatio
