...
------------ | ------------- | ------------- | -------------
**Rows** | Pointer to [**[]GetInterestHistoryResponseRowsInner**](GetInterestHistoryResponseRowsInner.md) | rows list. | [optional] 
**Total** | Pointer to **int64** | total. | [optional] 

## Methods

### NewGetInterestHistoryResponse
...
### NewGetInterestHistoryResponseWithDefaults
