...
### NewGetCrossMarginTransferHistoryResponseRowsInner
...
### NewGetCrossMarginTransferHistoryResponseRowsInnerWithDefaults
...
GetFromSymbol returns the FromSymbol field if non-nil, zero value otherwise.

### GetFromSymbolOk

`func (o *GetCrossMarginTransferHistoryResponseRowsInner) GetFromSymbolOk() (*string, bool)`

GetFromSymbolOk returns a tuple with the FromSymbol field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetFromSymbol sets FromSymbol field to given value.
