...
**Ip** | Pointer to **string** | 0.0.0.0 is just an initial statereference (no extra meaning). | [optional] 
...
### NewQuerySpecialKeyResponseWithDefaults
