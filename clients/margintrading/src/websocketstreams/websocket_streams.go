...
// WebsocketStreamsClient manages communication with the Binance Margin WebSocket Market Streams WebSocket Streams v1.11.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-margintrading/1.11.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
