...
// WebsocketStreamsClient manages communication with the Binance Binance Margin Trading WebSocket Market Streams WebSocket Streams v1.5.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-margintrading/1.5.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
