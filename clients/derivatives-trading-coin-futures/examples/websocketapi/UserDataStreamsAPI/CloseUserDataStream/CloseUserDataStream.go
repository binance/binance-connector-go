...
func CloseUserDataStream() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.UserDataStreamsAPI.CloseUserDataStream().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing CloseUserDataStream request: %v\n", err)
		return
	}
