...
func (r ApiAutoCancelAllOpenOrdersRequest) Execute() (struct{}, error) {
...
// Execute executes the request
func (a *TradeAPIService) AutoCancelAllOpenOrdersExecute(r ApiAutoCancelAllOpenOrdersRequest) (struct{}, error) {
	...
	if r.symbol == nil {
		return struct{}{}, common.ReportError("symbol is required and must be specified")
	}
	if r.countdownTime == nil {
		return struct{}{}, common.ReportError("countdownTime is required and must be specified")
	}
