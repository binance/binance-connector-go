...
### NewMarkPriceKlineCandlestickStreamsResponse
...
### NewMarkPriceKlineCandlestickStreamsResponseWithDefaults
...
`func (o *MarkPriceKlineCandlestickStreamsResponse) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *MarkPriceKlineCandlestickStreamsResponse) GetEOk() (*string, bool)`
...
`func (o *MarkPriceKlineCandlestickStreamsResponse) SetE(v string)`
...
`func (o *MarkPriceKlineCandlestickStreamsResponse) GetPs() string`

GetPs returns the Ps field if non-nil, zero value otherwise.

### GetPsOk

`func (o *MarkPriceKlineCandlestickStreamsResponse) GetPsOk() (*string, bool)`
...
`func (o *MarkPriceKlineCandlestickStreamsResponse) SetPs(v string)`

SetPs sets Ps field to given value.

### HasPs

`func (o *MarkPriceKlineCandlestickStreamsResponse) HasPs() bool`

HasPs returns a boolean if a field has been set.

### GetK

`func (o *MarkPriceKlineCandlestickStreamsResponse) GetK() MarkPriceKlineCandlestickStreamsResponseK`

GetK returns the K field if non-nil, zero value otherwise.

### GetKOk

`func (o *MarkPriceKlineCandlestickStreamsResponse) GetKOk() (*MarkPriceKlineCandlestickStreamsResponseK, bool)`
...
`func (o *MarkPriceKlineCandlestickStreamsResponse) SetK(v MarkPriceKlineCandlestickStreamsResponseK)`

SetK sets K field to given value.

### HasK

`func (o *MarkPriceKlineCandlestickStreamsResponse) HasK() bool`
