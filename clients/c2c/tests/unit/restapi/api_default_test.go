...
func Test_binancec2crestapi_DefaultAPIService(t *testing.T) {

	t.Run("Test DefaultAPIService GetC2CTradeHistory Success", func(t *testing.T) {
		...
		resp, err := apiClient.RestApi.DefaultAPI.GetC2CTradeHistory(context.Background()).Execute()
		require.NoError(t, err)
	...
	t.Run("Test DefaultAPIService GetC2CTradeHistory Server Error", func(t *testing.T) {
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
