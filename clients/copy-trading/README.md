...
```bash
go get github.com/binance/binance-connector-go/clients/copytrading
```
...
For information on migrating from previous versions of the Binance Go Copy Trading SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
