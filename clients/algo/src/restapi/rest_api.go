...
// RestAPIClient manages communication with the Algo Trading REST API API v1.11.0
...
// NewRestAPIClient creates a new Binance Algo Trading REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-algo/1.11.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
