...
func Test_binancepayrestapi_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService GetPayTradeHistory Success", func(t *testing.T) {
		...
		resp, err := apiClient.RestApi.DefaultAPI.GetPayTradeHistory(context.Background()).Execute()
		require.NoError(t, err)
	...
	t.Run("Test DefaultAPIService GetPayTradeHistory Server Error", func(t *testing.T) {
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
