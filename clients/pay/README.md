...
```bash
go get github.com/binance/binance-connector-go/clients/pay
```
...
For information on migrating from previous versions of the Binance Go Pay SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
