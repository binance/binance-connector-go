...
// RestAPIClient manages communication with the Binance Pay REST API API v1.11.0
...
// NewRestAPIClient creates a new Binance Binance Pay REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-pay/1.11.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
