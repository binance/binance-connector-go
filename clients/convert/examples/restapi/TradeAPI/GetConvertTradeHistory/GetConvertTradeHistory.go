...
func GetConvertTradeHistory() {
	...
	resp, err := apiClient.RestApi.TradeAPI.GetConvertTradeHistory(context.Background()).StartTime(1623319461670).EndTime(1641782889000).Execute()
	if err != nil {
		log.Println(err)
		return
	}
