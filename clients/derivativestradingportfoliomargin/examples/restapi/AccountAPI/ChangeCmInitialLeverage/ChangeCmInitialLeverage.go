...
func ChangeCmInitialLeverage() {
	...
	resp, err := apiClient.RestApi.AccountAPI.ChangeCmInitialLeverage(context.Background()).Symbol("symbol_example").Leverage(789).Execute()
	if err != nil {
		log.Println(err)
		return
	}
