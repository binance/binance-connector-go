...
// WebsocketStreamsClient manages communication with the Binance Portfolio Margin WebSocket Market Streams WebSocket Streams v1.18.1
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingportfoliomargin/1.18.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
