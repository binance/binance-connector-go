...
func (o *OrderTradeUpdateO) GetSmallst() string {
...
// and a boolean to check if the value has been set.
func (o *OrderTradeUpdateO) GetSmallstOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smallst) {
		return nil, false
	}
...
func (o *OrderTradeUpdateO) HasSmallst() bool {
	if o != nil && !common.IsNil(o.Smallst) {
		return true
	}
...
func (o *OrderTradeUpdateO) SetSmallst(v string) {
	o.Smallst = &v
}
