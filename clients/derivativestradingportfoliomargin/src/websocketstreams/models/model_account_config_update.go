...
func (o *AccountConfigUpdate) GetSmallfs() string {
...
func (o *AccountConfigUpdate) GetSmallfsOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smallfs) {
		return nil, false
	}
...
func (o *AccountConfigUpdate) HasSmallfs() bool {
	if o != nil && !common.IsNil(o.Smallfs) {
		return true
	}
...
func (o *AccountConfigUpdate) SetSmallfs(v string) {
	o.Smallfs = &v
}
