...
**T** | Pointer to **int64** | Transaction | [optional] 
...
`func (o *AccountUpdate) GetFs() string`

GetFs returns the Fs field if non-nil, zero value otherwise.

### GetFsOk

`func (o *AccountUpdate) GetFsOk() (*string, bool)`
...
`func (o *AccountUpdate) SetFs(v string)`

SetFs sets Fs field to given value.

### HasFs

`func (o *AccountUpdate) HasFs() bool`
