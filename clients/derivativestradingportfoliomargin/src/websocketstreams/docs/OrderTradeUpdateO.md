...
**Sp** | Pointer to **string** | Ignore | [optional] 
...
**N** | Pointer to **string** | Commission Asset, will not push if no commission | [optional] 
**N** | Pointer to **string** | Commission, will not push if no commission | [optional] 
...
**St** | Pointer to **string** | Strategy type, only pushed with conditional order triggered | [optional] 
**Si** | Pointer to **int64** | StrategyId, only pushed with conditional order triggered | [optional] 
...
`func (o *OrderTradeUpdateO) GetSt() string`

GetSt returns the St field if non-nil, zero value otherwise.

### GetStOk

`func (o *OrderTradeUpdateO) GetStOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetSt(v string)`

SetSt sets St field to given value.

### HasSt

`func (o *OrderTradeUpdateO) HasSt() bool`
