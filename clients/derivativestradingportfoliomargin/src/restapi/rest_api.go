...
// RestAPIClient manages communication with the Portfolio Margin REST API API v1.13.0
...
// NewRestAPIClient creates a new Binance Portfolio Margin REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingportfoliomargin/1.13.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
