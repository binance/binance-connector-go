...
// RestAPIClient manages communication with the Binance Derivatives Trading Portfolio Margin REST API API v1.1.0
...
// NewRestAPIClient creates a new Binance Binance Derivatives Trading Portfolio Margin REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingportfoliomargin/1.1.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
