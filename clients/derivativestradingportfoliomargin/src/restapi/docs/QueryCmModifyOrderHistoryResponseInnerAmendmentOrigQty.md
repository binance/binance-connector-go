...
------------ | ------------- | ------------- | -------------
**Before** | Pointer to **string** | Before. | [optional] 
**After** | Pointer to **string** | After. | [optional] 

## Methods

### NewQueryCmModifyOrderHistoryResponseInnerAmendmentOrigQty
...
### NewQueryCmModifyOrderHistoryResponseInnerAmendmentOrigQtyWithDefaults
