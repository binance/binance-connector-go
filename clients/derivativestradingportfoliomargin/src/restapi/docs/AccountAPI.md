...
func main() {
	...
	leverage := int64(21) // int64 | target initial leverage
	recvWindow := int64(5000) // int64 |  (optional)
...
func main() {
	dualSidePosition := models.ChangeAutoRepayFuturesStatusAutoRepayParameterTrue // ChangeAutoRepayFuturesStatusAutoRepayParameter | \"true\": Hedge Mode; \"false\": One-way Mode
	recvWindow := int64(5000) // int64 |  (optional)
...
Name          | Type          | Description   | Notes
------------- | ------------- | ------------- | -------------
 **dualSidePosition** | [**ChangeAutoRepayFuturesStatusAutoRepayParameter**](ChangeAutoRepayFuturesStatusAutoRepayParameter.md) | \&quot;true\&quot;: Hedge Mode; \&quot;false\&quot;: One-way Mode | 
 **recvWindow** | **int64** |  | 
...
func main() {
	...
	incomeType := models.GetCmIncomeHistoryIncomeTypeParameterTransfer // GetCmIncomeHistoryIncomeTypeParameter |  (optional)
	...
	limit := int64(100) // int64 | Number of results returned. (optional)
	recvWindow := int64(5000) // int64 |  (optional)
...
------------- | ------------- | ------------- | -------------
 **symbol** | **string** |  | 
 **incomeType** | [**GetCmIncomeHistoryIncomeTypeParameter**](GetCmIncomeHistoryIncomeTypeParameter.md) |  | 
...
func main() {
	...
	archived := models.ChangeAutoRepayFuturesStatusAutoRepayParameterTrue // ChangeAutoRepayFuturesStatusAutoRepayParameter | Set to true to query archived data from 6 months ago. (optional)
 ...
 **archived** | [**ChangeAutoRepayFuturesStatusAutoRepayParameter**](ChangeAutoRepayFuturesStatusAutoRepayParameter.md) | Set to true to query archived data from 6 months ago. | 
...
func main() {
	...
	incomeType := models.GetUmIncomeHistoryIncomeTypeParameterTransfer // GetUmIncomeHistoryIncomeTypeParameter | Income type. (optional)
	startTime := int64(1623319461670) // int64 | Timestamp in ms to get funding from INCLUSIVE. (optional)
	endTime := int64(1641782889000) // int64 | Timestamp in ms to get funding until INCLUSIVE. (optional)
...
------------- | ------------- | ------------- | -------------
 **symbol** | **string** |  | 
 **incomeType** | [**GetUmIncomeHistoryIncomeTypeParameter**](GetUmIncomeHistoryIncomeTypeParameter.md) | Income type. | 
 **startTime** | **int64** | Timestamp in ms to get funding from INCLUSIVE. | 
 **endTime** | **int64** | Timestamp in ms to get funding until INCLUSIVE. | 
...
func main() {
	...
	pair := "BTCUSD_201225" // string |  (optional)
	recvWindow := int64(5000) // int64 |  (optional)
...
func main() {
	asset := "USDT" // string | 
	txId := int64(1) // int64 | the `tranId` in `POST /papi/v1/repayLoan` (optional)
	startTime := int64(1623319461670) // int64 | Timestamp in ms to get funding from INCLUSIVE. (optional)
	endTime := int64(1641782889000) // int64 | Timestamp in ms to get funding until INCLUSIVE. (optional)
	current := int64(1) // int64 | Current page number. (optional)
	size := int64(10) // int64 | Number of results returned. (optional)
