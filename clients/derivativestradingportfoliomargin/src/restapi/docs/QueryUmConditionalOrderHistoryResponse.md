...
**Status** | Pointer to **string** | Normal order status after trigger if appliable, only have when the strategy is triggered | [optional] 
**BookTime** | Pointer to **int64** | order time | [optional] 
**UpdateTime** | Pointer to **int64** | last update time | [optional] 
**TriggerTime** | Pointer to **int64** | Trigger Time. | [optional] 
...
### NewQueryUmConditionalOrderHistoryResponse
...
### NewQueryUmConditionalOrderHistoryResponseWithDefaults
