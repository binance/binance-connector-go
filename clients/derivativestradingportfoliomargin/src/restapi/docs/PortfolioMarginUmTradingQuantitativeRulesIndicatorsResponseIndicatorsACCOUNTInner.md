...
**TriggerValue** | Pointer to **int64** | Trigger Value. | [optional] 
**PlannedRecoverTime** | Pointer to **int64** | Planned Recover Time. | [optional] 
**IsLocked** | Pointer to **bool** | Is Locked. | [optional] 

## Methods

### NewPortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicatorsACCOUNTInner
...
### NewPortfolioMarginUmTradingQuantitativeRulesIndicatorsResponseIndicatorsACCOUNTInnerWithDefaults
