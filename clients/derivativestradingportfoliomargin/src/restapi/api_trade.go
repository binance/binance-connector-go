...
func (a *TradeAPIService) CancelAllCmOpenConditionalOrdersExecute(r ApiCancelAllCmOpenConditionalOrdersRequest) (*common.RestApiResponse[models.CancelAllCmOpenConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllCmOpenConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelAllCmOpenOrdersExecute(r ApiCancelAllCmOpenOrdersRequest) (*common.RestApiResponse[models.CancelAllCmOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllCmOpenOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelAllUmAlgoOpenOrdersExecute(r ApiCancelAllUmAlgoOpenOrdersRequest) (*common.RestApiResponse[models.CancelAllUmAlgoOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllUmAlgoOpenOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelAllUmOpenConditionalOrdersExecute(r ApiCancelAllUmOpenConditionalOrdersRequest) (*common.RestApiResponse[models.CancelAllUmOpenConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllUmOpenConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelAllUmOpenOrdersExecute(r ApiCancelAllUmOpenOrdersRequest) (*common.RestApiResponse[models.CancelAllUmOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllUmOpenOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelCmConditionalOrderExecute(r ApiCancelCmConditionalOrderRequest) (*common.RestApiResponse[models.CancelCmConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelCmConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelCmOrderExecute(r ApiCancelCmOrderRequest) (*common.RestApiResponse[models.CancelCmOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelCmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelMarginAccountAllOpenOrdersOnASymbolExecute(r ApiCancelMarginAccountAllOpenOrdersOnASymbolRequest) (*common.RestApiResponse[models.CancelMarginAccountAllOpenOrdersOnASymbolResponse], error) {
	...
	resp, err := SendRequest[models.CancelMarginAccountAllOpenOrdersOnASymbolResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param newClientOrderId -  Used to uniquely identify this cancel request.
...
func (a *TradeAPIService) CancelMarginAccountOcoOrdersExecute(r ApiCancelMarginAccountOcoOrdersRequest) (*common.RestApiResponse[models.CancelMarginAccountOcoOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelMarginAccountOcoOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelMarginAccountOrderExecute(r ApiCancelMarginAccountOrderRequest) (*common.RestApiResponse[models.CancelMarginAccountOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelMarginAccountOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param algoId -  Algo order ID
@param clientAlgoId -  Client algo order ID
@param recvWindow -
...
func (a *TradeAPIService) CancelUmAlgoOrderExecute(r ApiCancelUmAlgoOrderRequest) (*common.RestApiResponse[models.CancelUmAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelUmAlgoOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelUmConditionalOrderExecute(r ApiCancelUmConditionalOrderRequest) (*common.RestApiResponse[models.CancelUmConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelUmConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CancelUmOrderExecute(r ApiCancelUmOrderRequest) (*common.RestApiResponse[models.CancelUmOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelUmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CmAccountTradeListExecute(r ApiCmAccountTradeListRequest) (*common.RestApiResponse[models.CmAccountTradeListResponse], error) {
	...
	resp, err := SendRequest[models.CmAccountTradeListResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) CmPositionAdlQuantileEstimationExecute(r ApiCmPositionAdlQuantileEstimationRequest) (*common.RestApiResponse[models.CmPositionAdlQuantileEstimationResponse], error) {
	...
	resp, err := SendRequest[models.CmPositionAdlQuantileEstimationResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) GetUmFuturesBnbBurnStatusExecute(r ApiGetUmFuturesBnbBurnStatusRequest) (*common.RestApiResponse[models.GetUmFuturesBnbBurnStatusResponse], error) {
	...
	resp, err := SendRequest[models.GetUmFuturesBnbBurnStatusResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) MarginAccountBorrowExecute(r ApiMarginAccountBorrowRequest) (*common.RestApiResponse[models.MarginAccountBorrowResponse], error) {
	...
	resp, err := SendRequest[models.MarginAccountBorrowResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiMarginAccountNewOcoRequest) StopLimitTimeInForce(stopLimitTimeInForce models.NewMarginOrderTimeInForceParameter) ApiMarginAccountNewOcoRequest {
...
func (r ApiMarginAccountNewOcoRequest) SideEffectType(sideEffectType models.MarginAccountNewOcoSideEffectTypeParameter) ApiMarginAccountNewOcoRequest {
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param symbol -
@param side -  See enum definitions: order side
@param quantity -
@param price -
@param stopPrice -
...
func (a *TradeAPIService) MarginAccountRepayExecute(r ApiMarginAccountRepayRequest) (*common.RestApiResponse[models.MarginAccountRepayResponse], error) {
	...
	resp, err := SendRequest[models.MarginAccountRepayResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) MarginAccountRepayDebtExecute(r ApiMarginAccountRepayDebtRequest) (*common.RestApiResponse[models.MarginAccountRepayDebtResponse], error) {
	...
	resp, err := SendRequest[models.MarginAccountRepayDebtResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param fromId -  Trade ID to fetch from.
@param limit -  Number of results returned.
@param recvWindow -  Value cannot be greater than 60000
...
func (a *TradeAPIService) MarginAccountTradeListExecute(r ApiMarginAccountTradeListRequest) (*common.RestApiResponse[models.MarginAccountTradeListResponse], error) {
	...
	resp, err := SendRequest[models.MarginAccountTradeListResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiModifyCmOrderRequest) ModifyId(modifyId int64) ApiModifyCmOrderRequest {
	r.modifyId = &modifyId
	return r
}
...
func (a *TradeAPIService) ModifyCmOrderExecute(r ApiModifyCmOrderRequest) (*common.RestApiResponse[models.ModifyCmOrderResponse], error) {
	...
	resp, err := SendRequest[models.ModifyCmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
// User-defined modification identifier, returned as-is in the response. Optional; not validated for uniqueness.
func (r ApiModifyUmOrderRequest) ModifyId(modifyId int64) ApiModifyUmOrderRequest {
	r.modifyId = &modifyId
	return r
}
...
func (a *TradeAPIService) ModifyUmOrderExecute(r ApiModifyUmOrderRequest) (*common.RestApiResponse[models.ModifyUmOrderResponse], error) {
	...
	resp, err := SendRequest[models.ModifyUmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiNewCmConditionalOrderRequest) PriceProtect(priceProtect models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiNewCmConditionalOrderRequest {
...
@param newClientStrategyId -  A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,36}$`
...
func (a *TradeAPIService) NewCmConditionalOrderExecute(r ApiNewCmConditionalOrderRequest) (*common.RestApiResponse[models.NewCmConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewCmConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiNewCmOrderRequest) ReduceOnly(reduceOnly models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiNewCmOrderRequest {
	r.reduceOnly = &reduceOnly
	return r
}
...
@param positionSide -  Default `BOTH` for One-way Mode ; `LONG` or `SHORT` for Hedge Mode. It must be sent in Hedge Mode.
@param timeInForce -
@param quantity -  Place amount
@param reduceOnly -  \"true\" or \"false\". Cannot be sent in Hedge Mode.
@param price -  Order price
@param priceMatch -  only avaliable for `LIMIT`/`STOP`/`TAKE_PROFIT` order; can be set to `OPPONENT`/ `OPPONENT_5`/ `OPPONENT_10`/ `OPPONENT_20`: /`QUEUE`/ `QUEUE_5`/ `QUEUE_10`/ `QUEUE_20`; Can't be passed together with `price`
...
func (a *TradeAPIService) NewCmOrderExecute(r ApiNewCmOrderRequest) (*common.RestApiResponse[models.NewCmOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewCmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiNewMarginOrderRequest) Type(type_ models.NewMarginOrderTypeParameter) ApiNewMarginOrderRequest {
	r.type_ = &type_
	return r
}
...
func (r ApiNewMarginOrderRequest) NewOrderRespType(newOrderRespType models.NewMarginOrderNewOrderRespTypeParameter) ApiNewMarginOrderRequest {
	r.newOrderRespType = &newOrderRespType
	return r
}
...
func (r ApiNewMarginOrderRequest) TimeInForce(timeInForce models.NewMarginOrderTimeInForceParameter) ApiNewMarginOrderRequest {
	r.timeInForce = &timeInForce
	return r
}
...
func (a *TradeAPIService) NewMarginOrderExecute(r ApiNewMarginOrderRequest) (*common.RestApiResponse[models.NewMarginOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewMarginOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
type ApiNewUmAlgoOrderRequest struct {
	ctx                     context.Context
	ApiService              *TradeAPIService
	algoType                *models.NewUmAlgoOrderAlgoTypeParameter
	symbol                  *string
...
func (r ApiNewUmAlgoOrderRequest) AlgoType(algoType models.NewUmAlgoOrderAlgoTypeParameter) ApiNewUmAlgoOrderRequest {
	r.algoType = &algoType
	return r
}
...
func (r ApiNewUmAlgoOrderRequest) Side(side models.NewUmAlgoOrderSideParameter) ApiNewUmAlgoOrderRequest {
	r.side = &side
	return r
}

// Conditional order type
func (r ApiNewUmAlgoOrderRequest) Type(type_ models.NewUmAlgoOrderTypeParameter) ApiNewUmAlgoOrderRequest {
	r.type_ = &type_
	return r
}
...
func (r ApiNewUmAlgoOrderRequest) WorkingType(workingType models.NewUmAlgoOrderWorkingTypeParameter) ApiNewUmAlgoOrderRequest {
	r.workingType = &workingType
	return r
}

// Can&#39;t be passed together with &#x60;price&#x60;
func (r ApiNewUmAlgoOrderRequest) PriceMatch(priceMatch models.NewUmAlgoOrderPriceMatchParameter) ApiNewUmAlgoOrderRequest {
	r.priceMatch = &priceMatch
	return r
}
...
func (r ApiNewUmAlgoOrderRequest) SelfTradePreventionMode(selfTradePreventionMode models.NewUmAlgoOrderSelfTradePreventionModeParameter) ApiNewUmAlgoOrderRequest {
	r.selfTradePreventionMode = &selfTradePreventionMode
	return r
}
...
@param goodTillDate -  Order cancel time for `GTD` timeInForce, mandatory when timeInForce is `GTD`
@param recvWindow -
...
func (a *TradeAPIService) NewUmAlgoOrderExecute(r ApiNewUmAlgoOrderRequest) (*common.RestApiResponse[models.NewUmAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewUmAlgoOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (r ApiNewUmConditionalOrderRequest) TimeInForce(timeInForce models.NewUmConditionalOrderTimeInForceParameter) ApiNewUmConditionalOrderRequest {
	r.timeInForce = &timeInForce
	return r
}
...
func (r ApiNewUmConditionalOrderRequest) ReduceOnly(reduceOnly models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiNewUmConditionalOrderRequest {
	r.reduceOnly = &reduceOnly
	return r
}
...
func (r ApiNewUmConditionalOrderRequest) PriceProtect(priceProtect models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiNewUmConditionalOrderRequest {
	r.priceProtect = &priceProtect
	return r
}
...
func (a *TradeAPIService) NewUmConditionalOrderExecute(r ApiNewUmConditionalOrderRequest) (*common.RestApiResponse[models.NewUmConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewUmConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
// Valid values
func (r ApiNewUmOrderRequest) TimeInForce(timeInForce models.NewUmConditionalOrderTimeInForceParameter) ApiNewUmOrderRequest {
	r.timeInForce = &timeInForce
	return r
}
...
// \&quot;true\&quot; or \&quot;false\&quot;. default \&quot;false\&quot;. Cannot be sent in Hedge Mode .
func (r ApiNewUmOrderRequest) ReduceOnly(reduceOnly models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiNewUmOrderRequest {
	r.reduceOnly = &reduceOnly
	return r
}
...
@param type_ -
@param positionSide -  Default `BOTH` for One-way Mode ; `LONG` or `SHORT` for Hedge Mode. It must be sent in Hedge Mode.
@param timeInForce -  Valid values
@param quantity -  Place amount
@param reduceOnly -  \"true\" or \"false\". default \"false\". Cannot be sent in Hedge Mode .
@param price -  Order price
@param newClientOrderId -  A unique id among open orders. Automatically generated if not sent. Can only be string following the rule: `^[\\.A-Z\\:/a-z0-9_-]{1,32}$`
...
func (a *TradeAPIService) NewUmOrderExecute(r ApiNewUmOrderRequest) (*common.RestApiResponse[models.NewUmOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewUmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCmConditionalOrdersExecute(r ApiQueryAllCmConditionalOrdersRequest) (*common.RestApiResponse[models.QueryAllCmConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCmConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCmOrdersExecute(r ApiQueryAllCmOrdersRequest) (*common.RestApiResponse[models.QueryAllCmOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCmOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCurrentCmOpenConditionalOrdersExecute(r ApiQueryAllCurrentCmOpenConditionalOrdersRequest) (*common.RestApiResponse[models.QueryAllCurrentCmOpenConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCurrentCmOpenConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCurrentCmOpenOrdersExecute(r ApiQueryAllCurrentCmOpenOrdersRequest) (*common.RestApiResponse[models.QueryAllCurrentCmOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCurrentCmOpenOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCurrentUmOpenAlgoOrdersExecute(r ApiQueryAllCurrentUmOpenAlgoOrdersRequest) (*common.RestApiResponse[models.QueryAllCurrentUmOpenAlgoOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCurrentUmOpenAlgoOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCurrentUmOpenConditionalOrdersExecute(r ApiQueryAllCurrentUmOpenConditionalOrdersRequest) (*common.RestApiResponse[models.QueryAllCurrentUmOpenConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCurrentUmOpenConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllCurrentUmOpenOrdersExecute(r ApiQueryAllCurrentUmOpenOrdersRequest) (*common.RestApiResponse[models.QueryAllCurrentUmOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllCurrentUmOpenOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllMarginAccountOrdersExecute(r ApiQueryAllMarginAccountOrdersRequest) (*common.RestApiResponse[models.QueryAllMarginAccountOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllMarginAccountOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllUmConditionalOrdersExecute(r ApiQueryAllUmConditionalOrdersRequest) (*common.RestApiResponse[models.QueryAllUmConditionalOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllUmConditionalOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryAllUmOrdersExecute(r ApiQueryAllUmOrdersRequest) (*common.RestApiResponse[models.QueryAllUmOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllUmOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCmConditionalOrderHistoryExecute(r ApiQueryCmConditionalOrderHistoryRequest) (*common.RestApiResponse[models.QueryCmConditionalOrderHistoryResponse], error) {
	...
	resp, err := SendRequest[models.QueryCmConditionalOrderHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCmModifyOrderHistoryExecute(r ApiQueryCmModifyOrderHistoryRequest) (*common.RestApiResponse[models.QueryCmModifyOrderHistoryResponse], error) {
	...
	resp, err := SendRequest[models.QueryCmModifyOrderHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCmOrderExecute(r ApiQueryCmOrderRequest) (*common.RestApiResponse[models.QueryCmOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCurrentCmOpenConditionalOrderExecute(r ApiQueryCurrentCmOpenConditionalOrderRequest) (*common.RestApiResponse[models.QueryCurrentCmOpenConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentCmOpenConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param orderId -  Order ID.
@param origClientOrderId -  User-defined order ID.
@param recvWindow -
...
func (a *TradeAPIService) QueryCurrentCmOpenOrderExecute(r ApiQueryCurrentCmOpenOrderRequest) (*common.RestApiResponse[models.QueryCurrentCmOpenOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentCmOpenOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCurrentMarginOpenOrderExecute(r ApiQueryCurrentMarginOpenOrderRequest) (*common.RestApiResponse[models.QueryCurrentMarginOpenOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentMarginOpenOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCurrentUmOpenAlgoOrderExecute(r ApiQueryCurrentUmOpenAlgoOrderRequest) (*common.RestApiResponse[models.QueryCurrentUmOpenAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentUmOpenAlgoOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCurrentUmOpenConditionalOrderExecute(r ApiQueryCurrentUmOpenConditionalOrderRequest) (*common.RestApiResponse[models.QueryCurrentUmOpenConditionalOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentUmOpenConditionalOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryCurrentUmOpenOrderExecute(r ApiQueryCurrentUmOpenOrderRequest) (*common.RestApiResponse[models.QueryCurrentUmOpenOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryCurrentUmOpenOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryMarginAccountOrderExecute(r ApiQueryMarginAccountOrderRequest) (*common.RestApiResponse[models.QueryMarginAccountOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryMarginAccountOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param orderListId -  Either `orderListId` or `listClientOrderId` must be provided
@param origClientOrderId -  `orderListId` or `listClientOrderId` must be provided.
@param recvWindow -  Value cannot be greater than 60000
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param symbol -
@param algoId -  Only return orders >= this algoId
@param startTime -
@param endTime -
...
func (a *TradeAPIService) QueryUmAlgoOrderHistoryExecute(r ApiQueryUmAlgoOrderHistoryRequest) (*common.RestApiResponse[models.QueryUmAlgoOrderHistoryResponse], error) {
	...
	resp, err := SendRequest[models.QueryUmAlgoOrderHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUmConditionalOrderHistoryExecute(r ApiQueryUmConditionalOrderHistoryRequest) (*common.RestApiResponse[models.QueryUmConditionalOrderHistoryResponse], error) {
	...
	resp, err := SendRequest[models.QueryUmConditionalOrderHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUmModifyOrderHistoryExecute(r ApiQueryUmModifyOrderHistoryRequest) (*common.RestApiResponse[models.QueryUmModifyOrderHistoryResponse], error) {
	...
	resp, err := SendRequest[models.QueryUmModifyOrderHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUmOrderExecute(r ApiQueryUmOrderRequest) (*common.RestApiResponse[models.QueryUmOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryUmOrderResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUsersCmForceOrdersExecute(r ApiQueryUsersCmForceOrdersRequest) (*common.RestApiResponse[models.QueryUsersCmForceOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryUsersCmForceOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUsersMarginForceOrdersExecute(r ApiQueryUsersMarginForceOrdersRequest) (*common.RestApiResponse[models.QueryUsersMarginForceOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryUsersMarginForceOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) QueryUsersUmForceOrdersExecute(r ApiQueryUsersUmForceOrdersRequest) (*common.RestApiResponse[models.QueryUsersUmForceOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryUsersUmForceOrdersResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
type ApiToggleBnbBurnOnUmFuturesTradeRequest struct {
	ctx        context.Context
	ApiService *TradeAPIService
	feeBurn    *models.ChangeAutoRepayFuturesStatusAutoRepayParameter
	recvWindow *int64
}

// \&quot;true\&quot;: Fee Discount On; \&quot;false\&quot;: Fee Discount Off
func (r ApiToggleBnbBurnOnUmFuturesTradeRequest) FeeBurn(feeBurn models.ChangeAutoRepayFuturesStatusAutoRepayParameter) ApiToggleBnbBurnOnUmFuturesTradeRequest {
	r.feeBurn = &feeBurn
	return r
}
...
func (a *TradeAPIService) ToggleBnbBurnOnUmFuturesTradeExecute(r ApiToggleBnbBurnOnUmFuturesTradeRequest) (*common.RestApiResponse[models.ToggleBnbBurnOnUmFuturesTradeResponse], error) {
	...
	resp, err := SendRequest[models.ToggleBnbBurnOnUmFuturesTradeResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) UmAccountTradeListExecute(r ApiUmAccountTradeListRequest) (*common.RestApiResponse[models.UmAccountTradeListResponse], error) {
	...
	resp, err := SendRequest[models.UmAccountTradeListResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
func (a *TradeAPIService) UmPositionAdlQuantileEstimationExecute(r ApiUmPositionAdlQuantileEstimationRequest) (*common.RestApiResponse[models.UmPositionAdlQuantileEstimationResponse], error) {
	...
	resp, err := SendRequest[models.UmPositionAdlQuantileEstimationResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
