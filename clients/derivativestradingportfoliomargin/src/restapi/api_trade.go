...
type ApiNewUmOrderRequest struct {
	...
	type_                   *models.NewCmOrderTypeParameter
	positionSide            *models.NewCmConditionalOrderPositionSideParameter
	timeInForce             *models.NewUmOrderTimeInForceParameter
	quantity                *float64
	reduceOnly              *models.ChangeAutoRepayFuturesStatusAutoRepayParameter
	price                   *float64
	newClientOrderId        *string
...
// Valid values
func (r ApiNewUmOrderRequest) TimeInForce(timeInForce models.NewUmOrderTimeInForceParameter) ApiNewUmOrderRequest {
	r.timeInForce = &timeInForce
	return r
}
