...
// checks if the QueryUmAlgoOrderHistoryResponseInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &QueryUmAlgoOrderHistoryResponseInner{}

// QueryUmAlgoOrderHistoryResponseInner struct for QueryUmAlgoOrderHistoryResponseInner
type QueryUmAlgoOrderHistoryResponseInner struct {
...
type _QueryUmAlgoOrderHistoryResponseInner QueryUmAlgoOrderHistoryResponseInner
...
func NewQueryUmAlgoOrderHistoryResponseInner() *QueryUmAlgoOrderHistoryResponseInner {
	this := QueryUmAlgoOrderHistoryResponseInner{}
	return &this
}
...
func (o QueryUmAlgoOrderHistoryResponseInner) MarshalJSON() ([]byte, error) {
...
func (o QueryUmAlgoOrderHistoryResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *QueryUmAlgoOrderHistoryResponseInner) UnmarshalJSON(data []byte) (err error) {
	varQueryUmAlgoOrderHistoryResponseInner := _QueryUmAlgoOrderHistoryResponseInner{}

	err = json.Unmarshal(data, &varQueryUmAlgoOrderHistoryResponseInner)

	if err != nil {
		return err
	}

	*o = QueryUmAlgoOrderHistoryResponseInner(varQueryUmAlgoOrderHistoryResponseInner)
...
type NullableQueryUmAlgoOrderHistoryResponseInner struct {
	value *QueryUmAlgoOrderHistoryResponseInner
	isSet bool
}

func (v NullableQueryUmAlgoOrderHistoryResponseInner) Get() *QueryUmAlgoOrderHistoryResponseInner {
	return v.value
}

func (v *NullableQueryUmAlgoOrderHistoryResponseInner) Set(val *QueryUmAlgoOrderHistoryResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryUmAlgoOrderHistoryResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryUmAlgoOrderHistoryResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryUmAlgoOrderHistoryResponseInner(val *QueryUmAlgoOrderHistoryResponseInner) *NullableQueryUmAlgoOrderHistoryResponseInner {
	return &NullableQueryUmAlgoOrderHistoryResponseInner{value: val, isSet: true}
}

func (v NullableQueryUmAlgoOrderHistoryResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryUmAlgoOrderHistoryResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
