...
// checks if the NewUmAlgoOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &NewUmAlgoOrderResponse{}

// NewUmAlgoOrderResponse struct for NewUmAlgoOrderResponse
type NewUmAlgoOrderResponse struct {
...
type _NewUmAlgoOrderResponse NewUmAlgoOrderResponse
...
func (o NewUmAlgoOrderResponse) MarshalJSON() ([]byte, error) {
...
func (o NewUmAlgoOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *NewUmAlgoOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varNewUmAlgoOrderResponse := _NewUmAlgoOrderResponse{}

	err = json.Unmarshal(data, &varNewUmAlgoOrderResponse)

	if err != nil {
		return err
	}

	*o = NewUmAlgoOrderResponse(varNewUmAlgoOrderResponse)
...
type NullableNewUmAlgoOrderResponse struct {
	value *NewUmAlgoOrderResponse
	isSet bool
}

func (v NullableNewUmAlgoOrderResponse) Get() *NewUmAlgoOrderResponse {
	return v.value
}

func (v *NullableNewUmAlgoOrderResponse) Set(val *NewUmAlgoOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNewUmAlgoOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNewUmAlgoOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewUmAlgoOrderResponse(val *NewUmAlgoOrderResponse) *NullableNewUmAlgoOrderResponse {
	return &NullableNewUmAlgoOrderResponse{value: val, isSet: true}
}

func (v NullableNewUmAlgoOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewUmAlgoOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
