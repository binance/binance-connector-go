...
------------ | ------------- | ------------- | -------------
**E** | Pointer to **string** | Event type, always &#x60;\&quot;kline\&quot;&#x60;. | [optional] 
**E** | Pointer to **int64** | Event time (epoch milliseconds); server-side system time when the message is pushed. | [optional] 
