...
// WebsocketStreamsClient manages communication with the Binance Stocks Trading WebSocket Streams WebSocket Streams v1.2.1
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-stocks/1.2.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
