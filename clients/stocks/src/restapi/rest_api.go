...
// RestAPIClient manages communication with the Stocks Trading REST API API v1.1.0
type RestAPIClient struct {
	...
	TokenizedAPI       *TokenizedAPIService
...
// NewRestAPIClient creates a new Binance Stocks Trading REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-stocks/1.1.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
	...
	c.TokenizedAPI = &TokenizedAPIService{client: c}
