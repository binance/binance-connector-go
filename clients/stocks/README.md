...
This is a client library for the Binance Stocks API, enabling developers to interact programmatically with Binance Stocks. The library provides tools to access trade U.S.-listed stocks and ETFs programmatically through a secure and developer-friendly through two distinct endpoints:
...
```bash
go get github.com/binance/binance-connector-go/clients/stocks
```

## Documentation

For detailed information, refer to the [Binance API Documentation](https://developers.binance.com/en/docs/products/stocks/introduction).
