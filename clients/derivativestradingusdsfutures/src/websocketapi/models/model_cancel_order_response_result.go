...
// checks if the CancelOrderResponseResult type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &CancelOrderResponseResult{}
...
type _CancelOrderResponseResult CancelOrderResponseResult
...
func NewCancelOrderResponseResult() *CancelOrderResponseResult {
	this := CancelOrderResponseResult{}
	return &this
}
...
func (o *CancelOrderResponseResult) GetActivatePrice() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponseResult) GetActivatePriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.ActivatePrice) {
		return nil, false
	}
...
func (o *CancelOrderResponseResult) HasActivatePrice() bool {
	if o != nil && !common.IsNil(o.ActivatePrice) {
		return true
	}
...
func (o *CancelOrderResponseResult) SetActivatePrice(v string) {
	o.ActivatePrice = &v
}

// GetPriceRate returns the PriceRate field value if set, zero value otherwise.
func (o *CancelOrderResponseResult) GetPriceRate() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponseResult) GetPriceRateOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceRate) {
		return nil, false
	}
...
func (o *CancelOrderResponseResult) HasPriceRate() bool {
	if o != nil && !common.IsNil(o.PriceRate) {
		return true
	}
...
func (o *CancelOrderResponseResult) SetPriceRate(v string) {
	o.PriceRate = &v
}
...
func (o *CancelOrderResponseResult) GetPriceMatch() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponseResult) GetPriceMatchOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceMatch) {
		return nil, false
	}
...
func (o *CancelOrderResponseResult) HasPriceMatch() bool {
	if o != nil && !common.IsNil(o.PriceMatch) {
		return true
	}
...
func (o *CancelOrderResponseResult) SetPriceMatch(v string) {
	o.PriceMatch = &v
}

// GetSelfTradePreventionMode returns the SelfTradePreventionMode field value if set, zero value otherwise.
func (o *CancelOrderResponseResult) GetSelfTradePreventionMode() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponseResult) GetSelfTradePreventionModeOk() (*string, bool) {
	if o == nil || common.IsNil(o.SelfTradePreventionMode) {
		return nil, false
	}
...
func (o *CancelOrderResponseResult) HasSelfTradePreventionMode() bool {
	if o != nil && !common.IsNil(o.SelfTradePreventionMode) {
		return true
	}
...
func (o *CancelOrderResponseResult) SetSelfTradePreventionMode(v string) {
	o.SelfTradePreventionMode = &v
}

// GetGoodTillDate returns the GoodTillDate field value if set, zero value otherwise.
func (o *CancelOrderResponseResult) GetGoodTillDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponseResult) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || common.IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *CancelOrderResponseResult) HasGoodTillDate() bool {
	if o != nil && !common.IsNil(o.GoodTillDate) {
		return true
	}
...
func (o *CancelOrderResponseResult) SetGoodTillDate(v int64) {
	o.GoodTillDate = &v
}

func (o CancelOrderResponseResult) MarshalJSON() ([]byte, error) {
...
func (o CancelOrderResponseResult) ToMap() (map[string]interface{}, error) {
...
func (o *CancelOrderResponseResult) UnmarshalJSON(data []byte) (err error) {
	varCancelOrderResponseResult := _CancelOrderResponseResult{}

	err = json.Unmarshal(data, &varCancelOrderResponseResult)

	if err != nil {
		return err
	}

	*o = CancelOrderResponseResult(varCancelOrderResponseResult)
...
type NullableCancelOrderResponseResult struct {
	value *CancelOrderResponseResult
	isSet bool
}

func (v NullableCancelOrderResponseResult) Get() *CancelOrderResponseResult {
	return v.value
}

func (v *NullableCancelOrderResponseResult) Set(val *CancelOrderResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableCancelOrderResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableCancelOrderResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCancelOrderResponseResult(val *CancelOrderResponseResult) *NullableCancelOrderResponseResult {
	return &NullableCancelOrderResponseResult{value: val, isSet: true}
}

func (v NullableCancelOrderResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCancelOrderResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
