...
// checks if the AccountInformationV2ResponseResultAssetsInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &AccountInformationV2ResponseResultAssetsInner{}
...
// NewAccountInformationV2ResponseResultAssetsInner instantiates a new AccountInformationV2ResponseResultAssetsInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAccountInformationV2ResponseResultAssetsInner() *AccountInformationV2ResponseResultAssetsInner {
	this := AccountInformationV2ResponseResultAssetsInner{}
	return &this
}

// NewAccountInformationV2ResponseResultAssetsInnerWithDefaults instantiates a new AccountInformationV2ResponseResultAssetsInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAccountInformationV2ResponseResultAssetsInnerWithDefaults() *AccountInformationV2ResponseResultAssetsInner {
	this := AccountInformationV2ResponseResultAssetsInner{}
	return &this
}

// GetAsset returns the Asset field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetAsset() string {
...
func (o *AccountInformationV2ResponseResultAssetsInner) GetAssetOk() (*string, bool) {
	if o == nil || common.IsNil(o.Asset) {
		return nil, false
	}
	return o.Asset, true
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasAsset() bool {
	if o != nil && !common.IsNil(o.Asset) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetAsset(v string) {
	o.Asset = &v
}

// GetWalletBalance returns the WalletBalance field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetWalletBalance() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetWalletBalanceOk() (*string, bool) {
	if o == nil || common.IsNil(o.WalletBalance) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasWalletBalance() bool {
	if o != nil && !common.IsNil(o.WalletBalance) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetWalletBalance(v string) {
	o.WalletBalance = &v
}

// GetUnrealizedProfit returns the UnrealizedProfit field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetUnrealizedProfit() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetUnrealizedProfitOk() (*string, bool) {
	if o == nil || common.IsNil(o.UnrealizedProfit) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasUnrealizedProfit() bool {
	if o != nil && !common.IsNil(o.UnrealizedProfit) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetUnrealizedProfit(v string) {
	o.UnrealizedProfit = &v
}

// GetMarginBalance returns the MarginBalance field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMarginBalance() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMarginBalanceOk() (*string, bool) {
	if o == nil || common.IsNil(o.MarginBalance) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasMarginBalance() bool {
	if o != nil && !common.IsNil(o.MarginBalance) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetMarginBalance(v string) {
	o.MarginBalance = &v
}

// GetMaintMargin returns the MaintMargin field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMaintMargin() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMaintMarginOk() (*string, bool) {
	if o == nil || common.IsNil(o.MaintMargin) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasMaintMargin() bool {
	if o != nil && !common.IsNil(o.MaintMargin) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetMaintMargin(v string) {
	o.MaintMargin = &v
}

// GetInitialMargin returns the InitialMargin field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetInitialMargin() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetInitialMarginOk() (*string, bool) {
	if o == nil || common.IsNil(o.InitialMargin) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasInitialMargin() bool {
	if o != nil && !common.IsNil(o.InitialMargin) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetInitialMargin(v string) {
	o.InitialMargin = &v
}

// GetPositionInitialMargin returns the PositionInitialMargin field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetPositionInitialMargin() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetPositionInitialMarginOk() (*string, bool) {
	if o == nil || common.IsNil(o.PositionInitialMargin) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasPositionInitialMargin() bool {
	if o != nil && !common.IsNil(o.PositionInitialMargin) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetPositionInitialMargin(v string) {
...
func (o *AccountInformationV2ResponseResultAssetsInner) GetOpenOrderInitialMargin() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetOpenOrderInitialMarginOk() (*string, bool) {
	if o == nil || common.IsNil(o.OpenOrderInitialMargin) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasOpenOrderInitialMargin() bool {
	if o != nil && !common.IsNil(o.OpenOrderInitialMargin) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetOpenOrderInitialMargin(v string) {
	o.OpenOrderInitialMargin = &v
}

// GetCrossWalletBalance returns the CrossWalletBalance field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetCrossWalletBalance() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetCrossWalletBalanceOk() (*string, bool) {
	if o == nil || common.IsNil(o.CrossWalletBalance) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasCrossWalletBalance() bool {
	if o != nil && !common.IsNil(o.CrossWalletBalance) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetCrossWalletBalance(v string) {
	o.CrossWalletBalance = &v
}

// GetCrossUnPnl returns the CrossUnPnl field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetCrossUnPnl() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetCrossUnPnlOk() (*string, bool) {
	if o == nil || common.IsNil(o.CrossUnPnl) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasCrossUnPnl() bool {
	if o != nil && !common.IsNil(o.CrossUnPnl) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetCrossUnPnl(v string) {
	o.CrossUnPnl = &v
}

// GetAvailableBalance returns the AvailableBalance field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetAvailableBalance() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetAvailableBalanceOk() (*string, bool) {
	if o == nil || common.IsNil(o.AvailableBalance) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasAvailableBalance() bool {
	if o != nil && !common.IsNil(o.AvailableBalance) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetAvailableBalance(v string) {
	o.AvailableBalance = &v
}

// GetMaxWithdrawAmount returns the MaxWithdrawAmount field value if set, zero value otherwise.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMaxWithdrawAmount() string {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMaxWithdrawAmountOk() (*string, bool) {
	if o == nil || common.IsNil(o.MaxWithdrawAmount) {
		return nil, false
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) HasMaxWithdrawAmount() bool {
	if o != nil && !common.IsNil(o.MaxWithdrawAmount) {
		return true
	}
...
func (o *AccountInformationV2ResponseResultAssetsInner) SetMaxWithdrawAmount(v string) {
...
// and a boolean to check if the value has been set.
func (o *AccountInformationV2ResponseResultAssetsInner) GetMarginAvailableOk() (*bool, bool) {
	if o == nil || common.IsNil(o.MarginAvailable) {
		return nil, false
	}
...
func (o AccountInformationV2ResponseResultAssetsInner) ToMap() (map[string]interface{}, error) {
...
func (o *AccountInformationV2ResponseResultAssetsInner) UnmarshalJSON(data []byte) (err error) {
	varAccountInformationV2ResponseResultAssetsInner := _AccountInformationV2ResponseResultAssetsInner{}

	err = json.Unmarshal(data, &varAccountInformationV2ResponseResultAssetsInner)

	if err != nil {
		return err
	}

	*o = AccountInformationV2ResponseResultAssetsInner(varAccountInformationV2ResponseResultAssetsInner)
...
type NullableAccountInformationV2ResponseResultAssetsInner struct {
	value *AccountInformationV2ResponseResultAssetsInner
	isSet bool
}

func (v NullableAccountInformationV2ResponseResultAssetsInner) Get() *AccountInformationV2ResponseResultAssetsInner {
	return v.value
}

func (v *NullableAccountInformationV2ResponseResultAssetsInner) Set(val *AccountInformationV2ResponseResultAssetsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountInformationV2ResponseResultAssetsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountInformationV2ResponseResultAssetsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountInformationV2ResponseResultAssetsInner(val *AccountInformationV2ResponseResultAssetsInner) *NullableAccountInformationV2ResponseResultAssetsInner {
	return &NullableAccountInformationV2ResponseResultAssetsInner{value: val, isSet: true}
}

func (v NullableAccountInformationV2ResponseResultAssetsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountInformationV2ResponseResultAssetsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
