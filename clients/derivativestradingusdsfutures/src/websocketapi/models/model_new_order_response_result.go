...
func (o *NewOrderResponseResult) GetCumQuote() string {
...
// and a boolean to check if the value has been set.
func (o *NewOrderResponseResult) GetCumQuoteOk() (*string, bool) {
	if o == nil || common.IsNil(o.CumQuote) {
		return nil, false
	}
...
func (o *NewOrderResponseResult) HasCumQuote() bool {
	if o != nil && !common.IsNil(o.CumQuote) {
		return true
	}
...
func (o *NewOrderResponseResult) SetCumQuote(v string) {
	o.CumQuote = &v
}
...
func (o *NewOrderResponseResult) GetPriceMatch() string {
...
// and a boolean to check if the value has been set.
func (o *NewOrderResponseResult) GetPriceMatchOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceMatch) {
		return nil, false
	}
...
func (o *NewOrderResponseResult) HasPriceMatch() bool {
	if o != nil && !common.IsNil(o.PriceMatch) {
		return true
	}
...
func (o *NewOrderResponseResult) SetPriceMatch(v string) {
	o.PriceMatch = &v
}

// GetSelfTradePreventionMode returns the SelfTradePreventionMode field value if set, zero value otherwise.
func (o *NewOrderResponseResult) GetSelfTradePreventionMode() string {
...
// and a boolean to check if the value has been set.
func (o *NewOrderResponseResult) GetSelfTradePreventionModeOk() (*string, bool) {
	if o == nil || common.IsNil(o.SelfTradePreventionMode) {
		return nil, false
	}
...
func (o *NewOrderResponseResult) HasSelfTradePreventionMode() bool {
	if o != nil && !common.IsNil(o.SelfTradePreventionMode) {
		return true
	}
...
func (o *NewOrderResponseResult) SetSelfTradePreventionMode(v string) {
	o.SelfTradePreventionMode = &v
}

// GetGoodTillDate returns the GoodTillDate field value if set, zero value otherwise.
func (o *NewOrderResponseResult) GetGoodTillDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *NewOrderResponseResult) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || common.IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *NewOrderResponseResult) HasGoodTillDate() bool {
	if o != nil && !common.IsNil(o.GoodTillDate) {
		return true
	}
...
func (o *NewOrderResponseResult) SetGoodTillDate(v int64) {
	o.GoodTillDate = &v
}
