...
type CancelAlgoOrderResponse struct {
	...
	Result               *CancelAlgoOrderResponseResult           `json:"result,omitempty"`
	RateLimits           []CancelAlgoOrderResponseRateLimitsInner `json:"rateLimits,omitempty"`
...
func (o *CancelAlgoOrderResponse) GetResult() CancelAlgoOrderResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret CancelAlgoOrderResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given CancelAlgoOrderResponseResult and assigns it to the Result field.
...
func (o *CancelAlgoOrderResponse) GetRateLimits() []CancelAlgoOrderResponseRateLimitsInner {
	if o == nil || common.IsNil(o.RateLimits) {
		var ret []CancelAlgoOrderResponseRateLimitsInner
		return ret
	}
	return o.RateLimits
}
...
// SetRateLimits gets a reference to the given []CancelAlgoOrderResponseRateLimitsInner and assigns it to the RateLimits field.
