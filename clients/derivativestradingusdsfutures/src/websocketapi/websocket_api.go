...
// WebsocketAPIClient manages communication with the Binance Binance Derivatives Trading USDS Futures WebSocket API WebSocketAPI v1.1.0
...
func NewWebsocketAPIClient(cfg *common.ConfigurationWebsocketApi) *WebsocketAPIClient {
	...
	c := &WebsocketAPIClient{
		cfg:                cfg,
		userAgent:          "binance-derivativestradingusdsfutures/1.1.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")",
		Ws:                 wsClient,
