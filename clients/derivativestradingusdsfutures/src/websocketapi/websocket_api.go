...
// WebsocketAPIClient manages communication with the Binance Futures (USDⓈ-M) WebSocket API WebSocketAPI v1.14.0
...
func NewWebsocketAPIClient(cfg *common.ConfigurationWebsocketApi) *WebsocketAPIClient {
	...
	c := &WebsocketAPIClient{
		cfg:                cfg,
		userAgent:          "binance-derivativestradingusdsfutures/1.14.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")",
		Ws:                 wsClient,
