...
// WebsocketAPIClient manages communication with the Binance Futures (USDⓈ-M) WebSocket API WebSocketAPI v1.18.1
...
func NewWebsocketAPIClient(cfg *common.ConfigurationWebsocketApi) *WebsocketAPIClient {
	...
	c := &WebsocketAPIClient{
		cfg:                cfg,
		userAgent:          "binance-derivativestradingusdsfutures/1.18.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")",
		Ws:                 wsClient,
