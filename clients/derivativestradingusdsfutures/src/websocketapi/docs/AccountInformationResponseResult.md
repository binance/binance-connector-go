...
**Positions** | Pointer to [**[]AccountInformationResponseResultPositionsInner**](AccountInformationResponseResultPositionsInner.md) | positions of all symbols in the market are returned | [optional] 
