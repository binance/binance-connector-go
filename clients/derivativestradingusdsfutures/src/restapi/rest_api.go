...
// RestAPIClient manages communication with the Futures (USDⓈ-M) REST API API v1.20.2
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingusdsfutures/1.20.2 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
