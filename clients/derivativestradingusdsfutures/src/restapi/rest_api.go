...
// RestAPIClient manages communication with the Binance Derivatives Trading USDS Futures REST API API v1.5.0
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-derivativestradingusdsfutures/1.5.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
