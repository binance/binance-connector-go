...
// checks if the QueryCurrentOpenOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &QueryCurrentOpenOrderResponse{}
...
func NewQueryCurrentOpenOrderResponse() *QueryCurrentOpenOrderResponse {
	this := QueryCurrentOpenOrderResponse{}
	return &this
}
...
func (o *QueryCurrentOpenOrderResponse) GetCumQuote() string {
...
// and a boolean to check if the value has been set.
func (o *QueryCurrentOpenOrderResponse) GetCumQuoteOk() (*string, bool) {
	if o == nil || common.IsNil(o.CumQuote) {
		return nil, false
	}
...
func (o *QueryCurrentOpenOrderResponse) HasCumQuote() bool {
	if o != nil && !common.IsNil(o.CumQuote) {
		return true
	}
...
func (o *QueryCurrentOpenOrderResponse) SetCumQuote(v string) {
	o.CumQuote = &v
}
...
func (o *QueryCurrentOpenOrderResponse) GetGoodTillDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *QueryCurrentOpenOrderResponse) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || common.IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *QueryCurrentOpenOrderResponse) HasGoodTillDate() bool {
	if o != nil && !common.IsNil(o.GoodTillDate) {
		return true
	}
...
func (o *QueryCurrentOpenOrderResponse) SetGoodTillDate(v int64) {
	o.GoodTillDate = &v
}

func (o QueryCurrentOpenOrderResponse) MarshalJSON() ([]byte, error) {
...
func (o QueryCurrentOpenOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QueryCurrentOpenOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varQueryCurrentOpenOrderResponse := _QueryCurrentOpenOrderResponse{}

	err = json.Unmarshal(data, &varQueryCurrentOpenOrderResponse)

	if err != nil {
		return err
	}

	*o = QueryCurrentOpenOrderResponse(varQueryCurrentOpenOrderResponse)
...
type NullableQueryCurrentOpenOrderResponse struct {
	value *QueryCurrentOpenOrderResponse
	isSet bool
}

func (v NullableQueryCurrentOpenOrderResponse) Get() *QueryCurrentOpenOrderResponse {
	return v.value
}

func (v *NullableQueryCurrentOpenOrderResponse) Set(val *QueryCurrentOpenOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryCurrentOpenOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryCurrentOpenOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryCurrentOpenOrderResponse(val *QueryCurrentOpenOrderResponse) *NullableQueryCurrentOpenOrderResponse {
	return &NullableQueryCurrentOpenOrderResponse{value: val, isSet: true}
}

func (v NullableQueryCurrentOpenOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryCurrentOpenOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
