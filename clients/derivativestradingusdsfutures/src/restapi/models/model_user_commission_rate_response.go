...
// GetRpiCommissionRate returns the RpiCommissionRate field value if set, zero value otherwise.
func (o *UserCommissionRateResponse) GetRpiCommissionRate() string {
	if o == nil || common.IsNil(o.RpiCommissionRate) {
		var ret string
		return ret
	}
	return *o.RpiCommissionRate
}

// GetRpiCommissionRateOk returns a tuple with the RpiCommissionRate field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UserCommissionRateResponse) GetRpiCommissionRateOk() (*string, bool) {
	if o == nil || common.IsNil(o.RpiCommissionRate) {
		return nil, false
	}
	return o.RpiCommissionRate, true
}

// HasRpiCommissionRate returns a boolean if a field has been set.
func (o *UserCommissionRateResponse) HasRpiCommissionRate() bool {
	if o != nil && !common.IsNil(o.RpiCommissionRate) {
		return true
	}
...
// SetRpiCommissionRate gets a reference to the given string and assigns it to the RpiCommissionRate field.
func (o *UserCommissionRateResponse) SetRpiCommissionRate(v string) {
	o.RpiCommissionRate = &v
}
...
func (o UserCommissionRateResponse) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.RpiCommissionRate) {
		toSerialize["rpiCommissionRate"] = o.RpiCommissionRate
	}
...
func (o *UserCommissionRateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	*o = UserCommissionRateResponse(varUserCommissionRateResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "rpiCommissionRate")
