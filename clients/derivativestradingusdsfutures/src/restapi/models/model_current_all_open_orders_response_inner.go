...
func (o *CurrentAllOpenOrdersResponseInner) GetCumQuote() string {
...
// and a boolean to check if the value has been set.
func (o *CurrentAllOpenOrdersResponseInner) GetCumQuoteOk() (*string, bool) {
	if o == nil || common.IsNil(o.CumQuote) {
		return nil, false
	}
...
func (o *CurrentAllOpenOrdersResponseInner) HasCumQuote() bool {
	if o != nil && !common.IsNil(o.CumQuote) {
		return true
	}
...
func (o *CurrentAllOpenOrdersResponseInner) SetCumQuote(v string) {
	o.CumQuote = &v
}
...
func (o *CurrentAllOpenOrdersResponseInner) GetGoodTillDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *CurrentAllOpenOrdersResponseInner) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || common.IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *CurrentAllOpenOrdersResponseInner) HasGoodTillDate() bool {
	if o != nil && !common.IsNil(o.GoodTillDate) {
		return true
	}
...
func (o *CurrentAllOpenOrdersResponseInner) SetGoodTillDate(v int64) {
	o.GoodTillDate = &v
}
