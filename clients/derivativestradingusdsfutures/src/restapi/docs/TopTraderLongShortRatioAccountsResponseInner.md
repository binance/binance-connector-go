...
### NewTopTraderLongShortRatioAccountsResponseInner
...
### NewTopTraderLongShortRatioAccountsResponseInnerWithDefaults
...
`func (o *TopTraderLongShortRatioAccountsResponseInner) GetSymbol() string`

GetSymbol returns the Symbol field if non-nil, zero value otherwise.

### GetSymbolOk

`func (o *TopTraderLongShortRatioAccountsResponseInner) GetSymbolOk() (*string, bool)`
...
`func (o *TopTraderLongShortRatioAccountsResponseInner) SetSymbol(v string)`

SetSymbol sets Symbol field to given value.

### HasSymbol

`func (o *TopTraderLongShortRatioAccountsResponseInner) HasSymbol() bool`
