...
### NewGetPositionMarginChangeHistoryResponseInner
...
### NewGetPositionMarginChangeHistoryResponseInnerWithDefaults
...
`func (o *GetPositionMarginChangeHistoryResponseInner) GetDeltaType() string`

GetDeltaType returns the DeltaType field if non-nil, zero value otherwise.

### GetDeltaTypeOk

`func (o *GetPositionMarginChangeHistoryResponseInner) GetDeltaTypeOk() (*string, bool)`
...
`func (o *GetPositionMarginChangeHistoryResponseInner) SetDeltaType(v string)`

SetDeltaType sets DeltaType field to given value.

### HasDeltaType

`func (o *GetPositionMarginChangeHistoryResponseInner) HasDeltaType() bool`
