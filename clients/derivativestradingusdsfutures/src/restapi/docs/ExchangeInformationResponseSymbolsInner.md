...
**DeliveryDate** | Pointer to **int64** | Delivery Date. | [optional] 
**OnboardDate** | Pointer to **int64** | Onboard Date. | [optional] 
...
**QuotePrecision** | Pointer to **int64** | Quote Precision. | [optional] 
**UnderlyingType** | Pointer to **string** |  | [optional] 
**UnderlyingSubType** | Pointer to **[]string** |  | [optional] 
**SettlePlan** | Pointer to **int64** |  | [optional] 
