...
**ActualOrderId** | Pointer to **string** | Empty string if not triggered; orderId if triggered. | [optional] 
**ActualPrice** | Pointer to **string** | 0 if not triggered; average price if filled/partially filled. | [optional] 
**ActualType** | Pointer to **string** | Optional field, only present when triggered. | [optional] 
**ActualQty** | Pointer to **string** | Optional field, only present when filled/partially filled. | [optional] 
