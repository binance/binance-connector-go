...
**PositionAmt** | Pointer to **string** | position amount, positive for long, negative for short | [optional] 
**EntryPrice** | Pointer to **string** | entry price | [optional] 
**BreakEvenPrice** | Pointer to **string** | break-even price | [optional] 
**MarkPrice** | Pointer to **string** | current mark price | [optional] 
...
**Notional** | Pointer to **string** | notional value of position | [optional] 
**MarginAsset** | Pointer to **string** | margin asset | [optional] 
**IsolatedWallet** | Pointer to **string** | isolated wallet (if isolated position) | [optional] 
**InitialMargin** | Pointer to **string** | initial margin required with current mark price | [optional] 
...
**Adl** | Pointer to **int64** | auto-deleverage ranking | [optional] 
**BidNotional** | Pointer to **string** | ignore | [optional] 
**AskNotional** | Pointer to **string** | ignore | [optional] 
