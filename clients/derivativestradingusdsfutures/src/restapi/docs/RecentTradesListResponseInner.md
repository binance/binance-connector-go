...
GetIsRPITrade returns the IsRPITrade field if non-nil, zero value otherwise.

### GetIsRPITradeOk

`func (o *RecentTradesListResponseInner) GetIsRPITradeOk() (*bool, bool)`

GetIsRPITradeOk returns a tuple with the IsRPITrade field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetIsRPITrade sets IsRPITrade field to given value.
