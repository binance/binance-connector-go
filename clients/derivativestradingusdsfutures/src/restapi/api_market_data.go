...
func (a *MarketDataAPIService) AdlRiskExecute(r ApiAdlRiskRequest) (*common.RestApiResponse[models.AdlRiskResponse], error) {
	...
	resp, err := SendRequest[models.AdlRiskResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) CompositeIndexSymbolInformationExecute(r ApiCompositeIndexSymbolInformationRequest) (*common.RestApiResponse[models.CompositeIndexSymbolInformationResponse], error) {
	...
	resp, err := SendRequest[models.CompositeIndexSymbolInformationResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) GetFundingRateHistoryExecute(r ApiGetFundingRateHistoryRequest) (*common.RestApiResponse[models.GetFundingRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFundingRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) MarkPriceExecute(r ApiMarkPriceRequest) (*common.RestApiResponse[models.MarkPriceResponse], error) {
	...
	resp, err := SendRequest[models.MarkPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) MultiAssetsModeAssetIndexExecute(r ApiMultiAssetsModeAssetIndexRequest) (*common.RestApiResponse[models.MultiAssetsModeAssetIndexResponse], error) {
	...
	resp, err := SendRequest[models.MultiAssetsModeAssetIndexResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) QuarterlyContractSettlementPriceExecute(r ApiQuarterlyContractSettlementPriceRequest) (*common.RestApiResponse[models.QuarterlyContractSettlementPriceResponse], error) {
	...
	resp, err := SendRequest[models.QuarterlyContractSettlementPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) QueryInsuranceFundBalanceSnapshotExecute(r ApiQueryInsuranceFundBalanceSnapshotRequest) (*common.RestApiResponse[models.QueryInsuranceFundBalanceSnapshotResponse], error) {
	...
	resp, err := SendRequest[models.QueryInsuranceFundBalanceSnapshotResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) RpiOrderBookExecute(r ApiRpiOrderBookRequest) (*common.RestApiResponse[models.RpiOrderBookResponse], error) {
	...
	resp, err := SendRequest[models.RpiOrderBookResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) SymbolPriceTickerV2Execute(r ApiSymbolPriceTickerV2Request) (*common.RestApiResponse[models.SymbolPriceTickerV2Response], error) {
	...
	resp, err := SendRequest[models.SymbolPriceTickerV2Response](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) TradingScheduleExecute(r ApiTradingScheduleRequest) (*common.RestApiResponse[models.TradingScheduleResponse], error) {
	...
	resp, err := SendRequest[models.TradingScheduleResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
