...
func (a *UserDataStreamsAPIService) KeepaliveUserDataStreamExecute(r ApiKeepaliveUserDataStreamRequest) (*common.RestApiResponse[models.KeepaliveUserDataStreamResponse], error) {
	...
	resp, err := SendRequest[models.KeepaliveUserDataStreamResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
