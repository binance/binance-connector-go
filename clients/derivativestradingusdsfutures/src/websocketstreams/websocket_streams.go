...
// WebsocketStreamsClient manages communication with the Binance Futures (USDⓈ-M) WebSocket Market Streams WebSocket Streams v1.20.2
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingusdsfutures/1.20.2 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
