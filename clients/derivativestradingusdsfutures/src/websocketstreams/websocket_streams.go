...
// WebsocketStreamsClient manages communication with the Binance Futures (USDⓈ-M) WebSocket Market Streams WebSocket Streams v1.14.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingusdsfutures/1.14.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
