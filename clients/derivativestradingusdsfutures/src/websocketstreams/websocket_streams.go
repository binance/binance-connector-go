...
// WebsocketStreamsClient manages communication with the Binance Binance Derivatives Trading USDS Futures WebSocket Market Streams WebSocket Streams v1.7.0
...
// NewWebsocketStreamsClient creates a new Binance Binance Derivatives Trading USDS Futures WebSocket Market Streams WebSocket Streams client
//
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingusdsfutures/1.7.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
...
func (c *WebsocketStreamsClient) SubscribeMarket(streams []string, id []any) error {
	return c.WsMarket.Subscribe(streams, id, false)
}
...
func (c *WebsocketStreamsClient) SubscribePublic(streams []string, id []any) error {
	return c.WsPublic.Subscribe(streams, id, false)
}
