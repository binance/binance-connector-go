...
// WebsocketStreamsClient manages communication with the Binance Binance Derivatives Trading USDS Futures WebSocket Market Streams WebSocket Streams v1.4.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-derivativestradingusdsfutures/1.4.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
