...
**N** | Pointer to **string** | Commission | [optional] 
**T** | Pointer to **int64** | Order Trade Time | [optional] 
**T** | Pointer to **int64** | Trade Id | [optional] 
**B** | Pointer to **string** | Bids Notional | [optional] 
**A** | Pointer to **string** | Ask Notional | [optional] 
...
**Ot** | Pointer to **string** | Original Order Type | [optional] 
...
**PP** | Pointer to **bool** | If price protection is turned on | [optional] 
**Si** | Pointer to **int64** | ignore | [optional] 
**Ss** | Pointer to **int64** | ignore | [optional] 
**Rp** | Pointer to **string** | Realized Profit of the trade | [optional] 
**V** | Pointer to **string** | STP mode | [optional] 
**Pm** | Pointer to **string** | Price match mode | [optional] 
**Gtd** | Pointer to **int64** | TIF GTD order auto cancel time | [optional] 
**Er** | Pointer to **string** | Expiry Reason | [optional] 
...
`func (o *OrderTradeUpdateO) GetSp() string`

GetSp returns the Sp field if non-nil, zero value otherwise.

### GetSpOk

`func (o *OrderTradeUpdateO) GetSpOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetSp(v string)`

SetSp sets Sp field to given value.

### HasSp

`func (o *OrderTradeUpdateO) HasSp() bool`
...
`func (o *OrderTradeUpdateO) GetWt() string`

GetWt returns the Wt field if non-nil, zero value otherwise.

### GetWtOk

`func (o *OrderTradeUpdateO) GetWtOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetWt(v string)`

SetWt sets Wt field to given value.

### HasWt

`func (o *OrderTradeUpdateO) HasWt() bool`
...
`func (o *OrderTradeUpdateO) GetPs() string`

GetPs returns the Ps field if non-nil, zero value otherwise.

### GetPsOk

`func (o *OrderTradeUpdateO) GetPsOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetPs(v string)`

SetPs sets Ps field to given value.

### HasPs

`func (o *OrderTradeUpdateO) HasPs() bool`

HasPs returns a boolean if a field has been set.

### GetCp

`func (o *OrderTradeUpdateO) GetCp() bool`

GetCp returns the Cp field if non-nil, zero value otherwise.

### GetCpOk

`func (o *OrderTradeUpdateO) GetCpOk() (*bool, bool)`
...
`func (o *OrderTradeUpdateO) SetCp(v bool)`

SetCp sets Cp field to given value.

### HasCp

`func (o *OrderTradeUpdateO) HasCp() bool`
...
`func (o *OrderTradeUpdateO) GetCr() string`

GetCr returns the Cr field if non-nil, zero value otherwise.

### GetCrOk

`func (o *OrderTradeUpdateO) GetCrOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetCr(v string)`

SetCr sets Cr field to given value.

### HasCr

`func (o *OrderTradeUpdateO) HasCr() bool`
...
`func (o *OrderTradeUpdateO) GetSi() int64`

GetSi returns the Si field if non-nil, zero value otherwise.

### GetSiOk

`func (o *OrderTradeUpdateO) GetSiOk() (*int64, bool)`
...
`func (o *OrderTradeUpdateO) SetSi(v int64)`

SetSi sets Si field to given value.

### HasSi

`func (o *OrderTradeUpdateO) HasSi() bool`

HasSi returns a boolean if a field has been set.

### GetSs

`func (o *OrderTradeUpdateO) GetSs() int64`

GetSs returns the Ss field if non-nil, zero value otherwise.

### GetSsOk

`func (o *OrderTradeUpdateO) GetSsOk() (*int64, bool)`

GetSsOk returns a tuple with the Ss field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetSs

`func (o *OrderTradeUpdateO) SetSs(v int64)`

SetSs sets Ss field to given value.

### HasSs

`func (o *OrderTradeUpdateO) HasSs() bool`
...
`func (o *OrderTradeUpdateO) GetPm() string`

GetPm returns the Pm field if non-nil, zero value otherwise.

### GetPmOk

`func (o *OrderTradeUpdateO) GetPmOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetPm(v string)`

SetPm sets Pm field to given value.

### HasPm

`func (o *OrderTradeUpdateO) HasPm() bool`

HasPm returns a boolean if a field has been set.

### GetGtd

`func (o *OrderTradeUpdateO) GetGtd() int64`

GetGtd returns the Gtd field if non-nil, zero value otherwise.

### GetGtdOk

`func (o *OrderTradeUpdateO) GetGtdOk() (*int64, bool)`
...
`func (o *OrderTradeUpdateO) SetGtd(v int64)`

SetGtd sets Gtd field to given value.

### HasGtd

`func (o *OrderTradeUpdateO) HasGtd() bool`

HasGtd returns a boolean if a field has been set.

### GetEr

`func (o *OrderTradeUpdateO) GetEr() string`

GetEr returns the Er field if non-nil, zero value otherwise.

### GetErOk

`func (o *OrderTradeUpdateO) GetErOk() (*string, bool)`
...
`func (o *OrderTradeUpdateO) SetEr(v string)`

SetEr sets Er field to given value.

### HasEr

`func (o *OrderTradeUpdateO) HasEr() bool`
