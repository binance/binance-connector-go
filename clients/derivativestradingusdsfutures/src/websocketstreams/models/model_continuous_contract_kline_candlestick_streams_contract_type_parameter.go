...
const (
	...
	ContinuousContractKlineCandlestickStreamsContractTypeParameterTradifiPerpetual ContinuousContractKlineCandlestickStreamsContractTypeParameter = "tradifi_perpetual"
)
