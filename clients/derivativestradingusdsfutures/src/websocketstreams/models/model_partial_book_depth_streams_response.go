...
func (o *PartialBookDepthStreamsResponse) GetSmallps() string {
...
// and a boolean to check if the value has been set.
func (o *PartialBookDepthStreamsResponse) GetSmallpsOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smallps) {
		return nil, false
	}
...
func (o *PartialBookDepthStreamsResponse) HasSmallps() bool {
	if o != nil && !common.IsNil(o.Smallps) {
		return true
	}
...
func (o *PartialBookDepthStreamsResponse) SetSmallps(v string) {
	o.Smallps = &v
}
...
func (o *PartialBookDepthStreamsResponse) HasSmallst() bool {
	if o != nil && !common.IsNil(o.Smallst) {
		return true
	}
