...
type AggregateTradeStreamsResponse struct {
	...
	Smallnq              *string `json:"nq,omitempty"`
...
func (o *AggregateTradeStreamsResponse) GetSmallnq() string {
	if o == nil || common.IsNil(o.Smallnq) {
		var ret string
		return ret
	}
	return *o.Smallnq
...
// and a boolean to check if the value has been set.
func (o *AggregateTradeStreamsResponse) GetSmallnqOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smallnq) {
		return nil, false
	}
	return o.Smallnq, true
}

// HasNq returns a boolean if a field has been set.
func (o *AggregateTradeStreamsResponse) HasSmallnq() bool {
	if o != nil && !common.IsNil(o.Smallnq) {
		return true
	}
...
func (o *AggregateTradeStreamsResponse) SetSmallnq(v string) {
	o.Smallnq = &v
}
...
func (o AggregateTradeStreamsResponse) ToMap() (map[string]interface{}, error) {
	...
	if !common.IsNil(o.Smallnq) {
		toSerialize["nq"] = o.Smallnq
	}
