...
type AccountConfigUpdate struct {
	...
	Smallai              *AccountConfigUpdateAi `json:"ai,omitempty"`
...
func (o *AccountConfigUpdate) GetSmallai() AccountConfigUpdateAi {
	if o == nil || common.IsNil(o.Smallai) {
		var ret AccountConfigUpdateAi
		return ret
	}
	return *o.Smallai
}
...
// and a boolean to check if the value has been set.
func (o *AccountConfigUpdate) GetSmallaiOk() (*AccountConfigUpdateAi, bool) {
	if o == nil || common.IsNil(o.Smallai) {
		return nil, false
	}
...
func (o *AccountConfigUpdate) HasSmallai() bool {
	if o != nil && !common.IsNil(o.Smallai) {
		return true
	}
...
// SetAi gets a reference to the given AccountConfigUpdateAi and assigns it to the Ai field.
func (o *AccountConfigUpdate) SetSmallai(v AccountConfigUpdateAi) {
	o.Smallai = &v
}
