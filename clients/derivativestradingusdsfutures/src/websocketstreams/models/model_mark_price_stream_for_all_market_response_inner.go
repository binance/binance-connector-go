...
func (o *MarkPriceStreamForAllMarketResponseInner) GetSmallst() int32 {
...
// and a boolean to check if the value has been set.
func (o *MarkPriceStreamForAllMarketResponseInner) GetSmallstOk() (*int32, bool) {
	if o == nil || common.IsNil(o.Smallst) {
		return nil, false
	}
...
func (o *MarkPriceStreamForAllMarketResponseInner) HasSmallst() bool {
	if o != nil && !common.IsNil(o.Smallst) {
		return true
	}
...
func (o *MarkPriceStreamForAllMarketResponseInner) SetSmallst(v int32) {
	o.Smallst = &v
}
