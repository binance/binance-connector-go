...
func Test_binancederivativestradingusdsfutureswebsocketapi_UserDataStreamsAPIService(t *testing.T) {
	...
	t.Run("Test UserDataStreamsAPIService CloseUserDataStream Execute Success", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Equal(t, "/userDataStream.stop"[1:], sentCheck["method"])
	...
	t.Run("Test UserDataStreamsAPIService KeepaliveUserDataStream Execute Success", func(t *testing.T) {
		...
		err = json.Unmarshal(mockWS.MessagesWritten[0], &sentCheck)
		require.NoError(t, err)
		require.Equal(t, "/userDataStream.ping"[1:], sentCheck["method"])
	...
	t.Run("Test UserDataStreamsAPIService StartUserDataStream AsyncExecute Success", func(t *testing.T) {
		...
		mockedJSON := `{"id":"123","status":200,"result":{"listenKey":"xs0mRXdAKlIPDRFrlPcw0qI41Eh3ixNntmymGyhrhgqo7L6FuLaWArTD7RLP"},"rateLimits":[{"rateLimitType":"REQUEST_WEIGHT","interval":"MINUTE","intervalNum":1,"limit":2400,"count":2}]}`
	...
	t.Run("Test UserDataStreamsAPIService StartUserDataStream Execute Success", func(t *testing.T) {
		...
		err = json.Unmarshal(mockWS.MessagesWritten[0], &sentCheck)
		require.NoError(t, err)
		require.Equal(t, "/userDataStream.start"[1:], sentCheck["method"])
