...
func ModifyMultipleOrders() {
	...
	resp, err := apiClient.RestApi.TradeAPI.ModifyMultipleOrders(context.Background()).BatchOrders([]models.ModifyMultipleOrdersBatchOrdersParameterInner{}).Execute()
	if err != nil {
		log.Println(err)
		return
	}
