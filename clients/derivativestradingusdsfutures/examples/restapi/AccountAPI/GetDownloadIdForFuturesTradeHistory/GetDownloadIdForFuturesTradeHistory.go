...
func GetDownloadIdForFuturesTradeHistory() {
	...
	resp, err := apiClient.RestApi.AccountAPI.GetDownloadIdForFuturesTradeHistory(context.Background()).StartTime(1623319461670).EndTime(1641782889000).Execute()
	if err != nil {
		log.Println(err)
		return
	}
