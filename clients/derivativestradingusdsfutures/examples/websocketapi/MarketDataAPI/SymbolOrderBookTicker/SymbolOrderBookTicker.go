...
func SymbolOrderBookTicker() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.MarketDataAPI.SymbolOrderBookTicker().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing SymbolOrderBookTicker request: %v\n", err)
		return
	}
