...
func CancelAlgoOrder() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.TradeAPI.CancelAlgoOrder().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing CancelAlgoOrder request: %v\n", err)
		return
	}
