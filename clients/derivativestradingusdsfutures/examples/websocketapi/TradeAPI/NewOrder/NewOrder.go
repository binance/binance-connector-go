...
func NewOrder() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.TradeAPI.NewOrder().Symbol("BTCUSDT").Side(models.ModifyOrderSideParameterBuy).Type(models.NewOrderTypeParameterLimit).ExecuteAsync()
	if err != nil {
