...
func (a *MarketDataAPIService) GetVIPLoanInterestRateHistoryExecute(r ApiGetVIPLoanInterestRateHistoryRequest) (*common.RestApiResponse[models.GetVIPLoanInterestRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetVIPLoanInterestRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
