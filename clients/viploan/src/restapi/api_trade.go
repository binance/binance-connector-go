...
func (a *TradeAPIService) VipLoanBorrowExecute(r ApiVipLoanBorrowRequest) (*common.RestApiResponse[models.VipLoanBorrowResponse], error) {
	...
	resp, err := SendRequest[models.VipLoanBorrowResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) VipLoanRenewExecute(r ApiVipLoanRenewRequest) (*common.RestApiResponse[models.VipLoanRenewResponse], error) {
	...
	resp, err := SendRequest[models.VipLoanRenewResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) VipLoanRepayExecute(r ApiVipLoanRepayRequest) (*common.RestApiResponse[models.VipLoanRepayResponse], error) {
	...
	resp, err := SendRequest[models.VipLoanRepayResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
