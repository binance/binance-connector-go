...
// RestAPIClient manages communication with the Binance VIP Loan REST API API v1.2.0
type RestAPIClient struct {
	...
	UserInformationAPI *UserInformationAPIService
}
...
// NewRestAPIClient creates a new Binance Binance VIP Loan REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-viploan/1.2.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
	...
	c.UserInformationAPI = &UserInformationAPIService{client: c}
