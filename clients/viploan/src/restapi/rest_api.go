...
// RestAPIClient manages communication with the VIP Loan REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance VIP Loan REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-viploan/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
