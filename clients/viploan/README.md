...
This is a client library for the Binance VIP Loan API, enabling developers to interact programmatically with Binance's VIP Loan trading platform. The library provides tools to interact with VIP Loan related functions like dust convert/ query balance etc through the REST API:
...
```bash
go get github.com/binance/binance-connector-go/clients/viploan
```
...
For information on migrating from previous versions of the Binance Go VIP Loan SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
