...
func PositionInformationV2() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.TradeAPI.PositionInformationV2().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing PositionInformationV2 request: %v\n", err)
		return
	}
