...
func NewOrder() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.TradeAPI.NewOrder().Symbol("symbol_example").Side(models.ModifyOrderSideParameterBuy).Type("type__example").ExecuteAsync()
	if err != nil {
