...
func FuturesAccountBalance() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.FuturesAccountBalance().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing FuturesAccountBalance request: %v\n", err)
		return
	}
