...
func AccountInformationV2() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.AccountInformationV2().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing AccountInformationV2 request: %v\n", err)
		return
	}
