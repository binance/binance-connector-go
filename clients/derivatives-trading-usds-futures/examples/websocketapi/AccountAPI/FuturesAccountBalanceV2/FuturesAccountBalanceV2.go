...
func FuturesAccountBalanceV2() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.FuturesAccountBalanceV2().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing FuturesAccountBalanceV2 request: %v\n", err)
		return
	}
