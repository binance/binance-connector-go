...
func (o *KeepaliveUserDataStreamResponse) GetRateLimits() []SymbolOrderBookTickerResponse1RateLimitsInner {
...
// and a boolean to check if the value has been set.
func (o *KeepaliveUserDataStreamResponse) GetRateLimitsOk() ([]SymbolOrderBookTickerResponse1RateLimitsInner, bool) {
	if o == nil || common.IsNil(o.RateLimits) {
		return nil, false
	}
...
func (o *KeepaliveUserDataStreamResponse) SetRateLimits(v []SymbolOrderBookTickerResponse1RateLimitsInner) {
	o.RateLimits = v
}
