...
### GetRpiCommissionRate

`func (o *UserCommissionRateResponse) GetRpiCommissionRate() string`

GetRpiCommissionRate returns the RpiCommissionRate field if non-nil, zero value otherwise.

### GetRpiCommissionRateOk

`func (o *UserCommissionRateResponse) GetRpiCommissionRateOk() (*string, bool)`

GetRpiCommissionRateOk returns a tuple with the RpiCommissionRate field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetRpiCommissionRate

`func (o *UserCommissionRateResponse) SetRpiCommissionRate(v string)`

SetRpiCommissionRate sets RpiCommissionRate field to given value.

### HasRpiCommissionRate
