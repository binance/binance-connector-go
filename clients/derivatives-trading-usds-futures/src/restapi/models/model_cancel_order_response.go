...
func (o *CancelOrderResponse) GetClientOrderId() string {
...
func (o *CancelOrderResponse) GetClientOrderIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.ClientOrderId) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasClientOrderId() bool {
	if o != nil && !common.IsNil(o.ClientOrderId) {
		return true
	}
...
func (o *CancelOrderResponse) SetClientOrderId(v string) {
	o.ClientOrderId = &v
}

// GetCumQty returns the CumQty field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetCumQty() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetCumQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.CumQty) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasCumQty() bool {
	if o != nil && !common.IsNil(o.CumQty) {
		return true
	}
...
func (o *CancelOrderResponse) SetCumQty(v string) {
	o.CumQty = &v
}

// GetCumQuote returns the CumQuote field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetCumQuote() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetCumQuoteOk() (*string, bool) {
	if o == nil || common.IsNil(o.CumQuote) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasCumQuote() bool {
	if o != nil && !common.IsNil(o.CumQuote) {
		return true
	}
...
func (o *CancelOrderResponse) SetCumQuote(v string) {
	o.CumQuote = &v
}

// GetExecutedQty returns the ExecutedQty field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetExecutedQty() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetExecutedQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.ExecutedQty) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasExecutedQty() bool {
	if o != nil && !common.IsNil(o.ExecutedQty) {
		return true
	}
...
func (o *CancelOrderResponse) SetExecutedQty(v string) {
	o.ExecutedQty = &v
}

// GetOrderId returns the OrderId field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetOrderId() int64 {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetOrderIdOk() (*int64, bool) {
	if o == nil || common.IsNil(o.OrderId) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasOrderId() bool {
	if o != nil && !common.IsNil(o.OrderId) {
		return true
	}
...
func (o *CancelOrderResponse) SetOrderId(v int64) {
	o.OrderId = &v
}

// GetOrigQty returns the OrigQty field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetOrigQty() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetOrigQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.OrigQty) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasOrigQty() bool {
	if o != nil && !common.IsNil(o.OrigQty) {
		return true
	}
...
func (o *CancelOrderResponse) GetPrice() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.Price) {
		return nil, false
	}
	return o.Price, true
...
func (o *CancelOrderResponse) GetReduceOnly() bool {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetReduceOnlyOk() (*bool, bool) {
	if o == nil || common.IsNil(o.ReduceOnly) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasReduceOnly() bool {
	if o != nil && !common.IsNil(o.ReduceOnly) {
		return true
	}
...
func (o *CancelOrderResponse) SetReduceOnly(v bool) {
	o.ReduceOnly = &v
}

// GetSide returns the Side field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetSide() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetSideOk() (*string, bool) {
	if o == nil || common.IsNil(o.Side) {
		return nil, false
	}
	return o.Side, true
...
func (o *CancelOrderResponse) HasSide() bool {
	if o != nil && !common.IsNil(o.Side) {
		return true
	}
...
func (o *CancelOrderResponse) SetSide(v string) {
	o.Side = &v
}

// GetPositionSide returns the PositionSide field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetPositionSide() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetPositionSideOk() (*string, bool) {
	if o == nil || common.IsNil(o.PositionSide) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasPositionSide() bool {
	if o != nil && !common.IsNil(o.PositionSide) {
		return true
	}
...
func (o *CancelOrderResponse) SetPositionSide(v string) {
	o.PositionSide = &v
}
...
func (o *CancelOrderResponse) GetStopPrice() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetStopPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.StopPrice) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasStopPrice() bool {
	if o != nil && !common.IsNil(o.StopPrice) {
		return true
	}
...
func (o *CancelOrderResponse) SetStopPrice(v string) {
	o.StopPrice = &v
}

// GetClosePosition returns the ClosePosition field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetClosePosition() bool {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetClosePositionOk() (*bool, bool) {
	if o == nil || common.IsNil(o.ClosePosition) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasClosePosition() bool {
	if o != nil && !common.IsNil(o.ClosePosition) {
		return true
	}
...
func (o *CancelOrderResponse) SetClosePosition(v bool) {
	o.ClosePosition = &v
}

// GetSymbol returns the Symbol field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetSymbol() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetSymbolOk() (*string, bool) {
	if o == nil || common.IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasSymbol() bool {
	if o != nil && !common.IsNil(o.Symbol) {
		return true
	}
...
func (o *CancelOrderResponse) SetSymbol(v string) {
	o.Symbol = &v
}

// GetTimeInForce returns the TimeInForce field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetTimeInForce() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetTimeInForceOk() (*string, bool) {
	if o == nil || common.IsNil(o.TimeInForce) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasTimeInForce() bool {
	if o != nil && !common.IsNil(o.TimeInForce) {
		return true
	}
...
func (o *CancelOrderResponse) SetTimeInForce(v string) {
	o.TimeInForce = &v
}
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetTypeOk() (*string, bool) {
	if o == nil || common.IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *CancelOrderResponse) HasType() bool {
	if o != nil && !common.IsNil(o.Type) {
		return true
	}
...
func (o *CancelOrderResponse) SetType(v string) {
	o.Type = &v
}

// GetActivatePrice returns the ActivatePrice field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetActivatePrice() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetActivatePriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.ActivatePrice) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasActivatePrice() bool {
	if o != nil && !common.IsNil(o.ActivatePrice) {
		return true
	}
...
func (o *CancelOrderResponse) SetActivatePrice(v string) {
	o.ActivatePrice = &v
}

// GetPriceRate returns the PriceRate field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetPriceRate() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetPriceRateOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceRate) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasPriceRate() bool {
	if o != nil && !common.IsNil(o.PriceRate) {
		return true
	}
...
func (o *CancelOrderResponse) SetPriceRate(v string) {
	o.PriceRate = &v
}

// GetUpdateTime returns the UpdateTime field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetUpdateTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetUpdateTimeOk() (*int64, bool) {
	if o == nil || common.IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasUpdateTime() bool {
	if o != nil && !common.IsNil(o.UpdateTime) {
		return true
	}
...
func (o *CancelOrderResponse) SetUpdateTime(v int64) {
	o.UpdateTime = &v
}

// GetWorkingType returns the WorkingType field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetWorkingType() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetWorkingTypeOk() (*string, bool) {
	if o == nil || common.IsNil(o.WorkingType) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasWorkingType() bool {
	if o != nil && !common.IsNil(o.WorkingType) {
		return true
	}
...
func (o *CancelOrderResponse) SetWorkingType(v string) {
	o.WorkingType = &v
}

// GetPriceProtect returns the PriceProtect field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetPriceProtect() bool {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetPriceProtectOk() (*bool, bool) {
	if o == nil || common.IsNil(o.PriceProtect) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasPriceProtect() bool {
	if o != nil && !common.IsNil(o.PriceProtect) {
		return true
	}
...
func (o *CancelOrderResponse) SetPriceProtect(v bool) {
	o.PriceProtect = &v
}

// GetPriceMatch returns the PriceMatch field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetPriceMatch() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetPriceMatchOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceMatch) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasPriceMatch() bool {
	if o != nil && !common.IsNil(o.PriceMatch) {
		return true
	}
...
func (o *CancelOrderResponse) SetPriceMatch(v string) {
	o.PriceMatch = &v
}

// GetSelfTradePreventionMode returns the SelfTradePreventionMode field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetSelfTradePreventionMode() string {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetSelfTradePreventionModeOk() (*string, bool) {
	if o == nil || common.IsNil(o.SelfTradePreventionMode) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasSelfTradePreventionMode() bool {
	if o != nil && !common.IsNil(o.SelfTradePreventionMode) {
		return true
	}
...
func (o *CancelOrderResponse) SetSelfTradePreventionMode(v string) {
	o.SelfTradePreventionMode = &v
}

// GetGoodTillDate returns the GoodTillDate field value if set, zero value otherwise.
func (o *CancelOrderResponse) GetGoodTillDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *CancelOrderResponse) GetGoodTillDateOk() (*int64, bool) {
	if o == nil || common.IsNil(o.GoodTillDate) {
		return nil, false
	}
...
func (o *CancelOrderResponse) HasGoodTillDate() bool {
	if o != nil && !common.IsNil(o.GoodTillDate) {
		return true
	}
...
func (o *CancelOrderResponse) SetGoodTillDate(v int64) {
	o.GoodTillDate = &v
}
