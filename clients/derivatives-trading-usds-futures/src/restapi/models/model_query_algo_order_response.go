...
// checks if the QueryAlgoOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &QueryAlgoOrderResponse{}
...
type _QueryAlgoOrderResponse QueryAlgoOrderResponse
...
func (o QueryAlgoOrderResponse) MarshalJSON() ([]byte, error) {
...
func (o QueryAlgoOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *QueryAlgoOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varQueryAlgoOrderResponse := _QueryAlgoOrderResponse{}

	err = json.Unmarshal(data, &varQueryAlgoOrderResponse)

	if err != nil {
		return err
	}

	*o = QueryAlgoOrderResponse(varQueryAlgoOrderResponse)
...
type NullableQueryAlgoOrderResponse struct {
	value *QueryAlgoOrderResponse
	isSet bool
}

func (v NullableQueryAlgoOrderResponse) Get() *QueryAlgoOrderResponse {
	return v.value
}

func (v *NullableQueryAlgoOrderResponse) Set(val *QueryAlgoOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableQueryAlgoOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableQueryAlgoOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQueryAlgoOrderResponse(val *QueryAlgoOrderResponse) *NullableQueryAlgoOrderResponse {
	return &NullableQueryAlgoOrderResponse{value: val, isSet: true}
}

func (v NullableQueryAlgoOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQueryAlgoOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
