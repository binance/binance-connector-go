...
func (a *TradeAPIService) CancelAlgoOrderExecute(r ApiCancelAlgoOrderRequest) (*common.RestApiResponse[models.CancelAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.CancelAlgoOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) CancelAllAlgoOpenOrdersExecute(r ApiCancelAllAlgoOpenOrdersRequest) (*common.RestApiResponse[models.CancelAllAlgoOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CancelAllAlgoOpenOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) ChangeMultiAssetsModeExecute(r ApiChangeMultiAssetsModeRequest) (*common.RestApiResponse[models.ChangeMultiAssetsModeResponse], error) {
	...
	resp, err := SendRequest[models.ChangeMultiAssetsModeResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) CurrentAllAlgoOpenOrdersExecute(r ApiCurrentAllAlgoOpenOrdersRequest) (*common.RestApiResponse[models.CurrentAllAlgoOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.CurrentAllAlgoOpenOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) FuturesTradfiPerpsContractExecute(r ApiFuturesTradfiPerpsContractRequest) (*common.RestApiResponse[models.FuturesTradfiPerpsContractResponse], error) {
	...
	resp, err := SendRequest[models.FuturesTradfiPerpsContractResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
@param reduceOnly -  \"true\" or \"false\". default \"false\". Cannot be sent in Hedge Mode; cannot be sent with `closePosition`=`true`
...
func (a *TradeAPIService) NewAlgoOrderExecute(r ApiNewAlgoOrderRequest) (*common.RestApiResponse[models.NewAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.NewAlgoOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) PositionInformationV2Execute(r ApiPositionInformationV2Request) (*common.RestApiResponse[models.PositionInformationV2Response], error) {
	...
	resp, err := SendRequest[models.PositionInformationV2Response](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) PositionInformationV3Execute(r ApiPositionInformationV3Request) (*common.RestApiResponse[models.PositionInformationV3Response], error) {
	...
	resp, err := SendRequest[models.PositionInformationV3Response](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) QueryAlgoOrderExecute(r ApiQueryAlgoOrderRequest) (*common.RestApiResponse[models.QueryAlgoOrderResponse], error) {
	...
	resp, err := SendRequest[models.QueryAlgoOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) QueryAllAlgoOrdersExecute(r ApiQueryAllAlgoOrdersRequest) (*common.RestApiResponse[models.QueryAllAlgoOrdersResponse], error) {
	...
	resp, err := SendRequest[models.QueryAllAlgoOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) TestOrderExecute(r ApiTestOrderRequest) (*common.RestApiResponse[models.TestOrderResponse], error) {
	...
	resp, err := SendRequest[models.TestOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
