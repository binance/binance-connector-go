...
func (o *OrderTradeUpdateO) GetSmallsi() int64 {
...
// and a boolean to check if the value has been set.
func (o *OrderTradeUpdateO) GetSmallsiOk() (*int64, bool) {
	if o == nil || common.IsNil(o.Smallsi) {
		return nil, false
	}
...
func (o *OrderTradeUpdateO) HasSmallsi() bool {
	if o != nil && !common.IsNil(o.Smallsi) {
		return true
	}
...
func (o *OrderTradeUpdateO) SetSmallsi(v int64) {
	o.Smallsi = &v
}

// GetSs returns the Ss field value if set, zero value otherwise.
func (o *OrderTradeUpdateO) GetSmallss() int64 {
...
// and a boolean to check if the value has been set.
func (o *OrderTradeUpdateO) GetSmallssOk() (*int64, bool) {
	if o == nil || common.IsNil(o.Smallss) {
		return nil, false
	}
...
func (o *OrderTradeUpdateO) HasSmallss() bool {
	if o != nil && !common.IsNil(o.Smallss) {
		return true
	}
...
// SetSs gets a reference to the given int64 and assigns it to the Ss field.
func (o *OrderTradeUpdateO) SetSmallss(v int64) {
	o.Smallss = &v
}
