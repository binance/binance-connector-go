...
func RollingWindowTicker() {
	...
	handler, err := wsClient.WebsocketStreams.DefaultAPI.RollingWindowTicker().Symbol("bnbusdt").WindowSize(models.AllMarketRollingWindowTickerWindowSizeParameterWindowSize1h).Execute()
	if err != nil {
