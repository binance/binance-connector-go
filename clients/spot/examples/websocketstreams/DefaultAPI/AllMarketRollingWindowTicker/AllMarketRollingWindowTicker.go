...
func AllMarketRollingWindowTicker() {
	...
	handler, err := wsClient.WebsocketStreams.DefaultAPI.AllMarketRollingWindowTicker().WindowSize(models.AllMarketRollingWindowTickerWindowSizeParameterWindowSize1h).Execute()
	if err != nil {
