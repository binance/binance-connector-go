...
func OrderListCancel() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.TradeAPI.OrderListCancel().Symbol("BNBUSDT").ExecuteAsync()
	if err != nil {
		log.Printf("Error executing OrderListCancel request: %v\n", err)
		return
	}
