...
func AccountRateLimitsOrders() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.AccountRateLimitsOrders().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing AccountRateLimitsOrders request: %v\n", err)
		return
	}
