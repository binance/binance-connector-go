...
func OpenOrderListsStatus() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.OpenOrderListsStatus().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing OpenOrderListsStatus request: %v\n", err)
		return
	}
