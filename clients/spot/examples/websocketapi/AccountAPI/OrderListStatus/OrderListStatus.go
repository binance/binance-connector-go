...
func OrderListStatus() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.OrderListStatus().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing OrderListStatus request: %v\n", err)
		return
	}
