...
func OpenOrdersStatus() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.OpenOrdersStatus().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing OpenOrdersStatus request: %v\n", err)
		return
	}
