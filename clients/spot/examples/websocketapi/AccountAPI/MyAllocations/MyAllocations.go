...
func MyAllocations() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.AccountAPI.MyAllocations().Symbol("BNBUSDT").ExecuteAsync()
	if err != nil {
		log.Printf("Error executing MyAllocations request: %v\n", err)
		return
	}
