...
func SessionSubscriptions() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.UserDataStreamAPI.SessionSubscriptions().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing SessionSubscriptions request: %v\n", err)
		return
	}
