...
func TickerTradingDay() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.MarketAPI.TickerTradingDay().ExecuteAsync()
	if err != nil {
		log.Printf("Error executing TickerTradingDay request: %v\n", err)
		return
	}
