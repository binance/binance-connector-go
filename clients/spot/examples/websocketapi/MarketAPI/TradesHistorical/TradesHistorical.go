...
func TradesHistorical() {
	...
	responseChan, errorChan, err := wsClient.WebsocketAPI.MarketAPI.TradesHistorical().Symbol("BNBUSDT").ExecuteAsync()
	if err != nil {
		log.Printf("Error executing TradesHistorical request: %v\n", err)
		return
	}
