...
// WebsocketAPIClient manages communication with the Binance Spot WebSocket API WebSocketAPI v1.14.1
...
func NewWebsocketAPIClient(cfg *common.ConfigurationWebsocketApi) *WebsocketAPIClient {
	...
	c := &WebsocketAPIClient{
		cfg:               cfg,
		userAgent:         "binance-spot/1.14.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")",
		Ws:                wsClient,
