...
func main() {
	...
	price := float32(1) // float32 |  (optional)
	...
	trailingDelta := float32(1) // float32 | See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq) (optional)
 ...
 **trailingDelta** | **float32** | See [Trailing Stop order FAQ](/products/spot/faqs/trailing-stop-faq) | 
