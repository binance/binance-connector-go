...
### NewReferencePriceCalculationResponseResult
...
### NewReferencePriceCalculationResponseResultWithDefaults
...
GetBucketWidthMs returns the BucketWidthMs field if non-nil, zero value otherwise.

### GetBucketWidthMsOk

`func (o *ReferencePriceCalculationResponseResult) GetBucketWidthMsOk() (*int64, bool)`

GetBucketWidthMsOk returns a tuple with the BucketWidthMs field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetBucketWidthMs sets BucketWidthMs field to given value.
...
### GetExternalCalculationId

`func (o *ReferencePriceCalculationResponseResult) GetExternalCalculationId() int64`

GetExternalCalculationId returns the ExternalCalculationId field if non-nil, zero value otherwise.

### GetExternalCalculationIdOk

`func (o *ReferencePriceCalculationResponseResult) GetExternalCalculationIdOk() (*int64, bool)`

GetExternalCalculationIdOk returns a tuple with the ExternalCalculationId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetExternalCalculationId

`func (o *ReferencePriceCalculationResponseResult) SetExternalCalculationId(v int64)`

SetExternalCalculationId sets ExternalCalculationId field to given value.

### HasExternalCalculationId
