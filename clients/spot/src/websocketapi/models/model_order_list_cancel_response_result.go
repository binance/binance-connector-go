...
// checks if the OrderListCancelResponseResult type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListCancelResponseResult{}

// OrderListCancelResponseResult struct for OrderListCancelResponseResult
type OrderListCancelResponseResult struct {
	...
	OrderReports         []OrderListCancelResponseResultOrderReportsInner `json:"orderReports,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderListCancelResponseResult OrderListCancelResponseResult
...
func NewOrderListCancelResponseResult() *OrderListCancelResponseResult {
	this := OrderListCancelResponseResult{}
	return &this
}
...
func (o *OrderListCancelResponseResult) GetOrders() []AllOrderListsResponseResultInnerOrdersInner {
...
// and a boolean to check if the value has been set.
func (o *OrderListCancelResponseResult) GetOrdersOk() ([]AllOrderListsResponseResultInnerOrdersInner, bool) {
	if o == nil || common.IsNil(o.Orders) {
		return nil, false
	}
...
func (o *OrderListCancelResponseResult) SetOrders(v []AllOrderListsResponseResultInnerOrdersInner) {
	o.Orders = v
}
...
func (o *OrderListCancelResponseResult) GetOrderReports() []OrderListCancelResponseResultOrderReportsInner {
	if o == nil || common.IsNil(o.OrderReports) {
		var ret []OrderListCancelResponseResultOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []OrderListCancelResponseResultOrderReportsInner and assigns it to the OrderReports field.
func (o *OrderListCancelResponseResult) SetOrderReports(v []OrderListCancelResponseResultOrderReportsInner) {
	o.OrderReports = v
}

func (o OrderListCancelResponseResult) MarshalJSON() ([]byte, error) {
...
func (o OrderListCancelResponseResult) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListCancelResponseResult) UnmarshalJSON(data []byte) (err error) {
	varOrderListCancelResponseResult := _OrderListCancelResponseResult{}

	err = json.Unmarshal(data, &varOrderListCancelResponseResult)

	if err != nil {
		return err
	}

	*o = OrderListCancelResponseResult(varOrderListCancelResponseResult)
...
type NullableOrderListCancelResponseResult struct {
	value *OrderListCancelResponseResult
	isSet bool
}

func (v NullableOrderListCancelResponseResult) Get() *OrderListCancelResponseResult {
	return v.value
}

func (v *NullableOrderListCancelResponseResult) Set(val *OrderListCancelResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListCancelResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListCancelResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListCancelResponseResult(val *OrderListCancelResponseResult) *NullableOrderListCancelResponseResult {
	return &NullableOrderListCancelResponseResult{value: val, isSet: true}
}

func (v NullableOrderListCancelResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListCancelResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
