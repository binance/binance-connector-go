...
// checks if the TradesAggregateResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &TradesAggregateResponse{}
...
type _TradesAggregateResponse TradesAggregateResponse
...
func (o *TradesAggregateResponse) GetResult() []TradesAggregateResponseResultInner {
	if o == nil || common.IsNil(o.Result) {
		var ret []TradesAggregateResponseResultInner
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []TradesAggregateResponseResultInner and assigns it to the Result field.
...
func (o TradesAggregateResponse) MarshalJSON() ([]byte, error) {
...
func (o *TradesAggregateResponse) UnmarshalJSON(data []byte) (err error) {
	varTradesAggregateResponse := _TradesAggregateResponse{}

	err = json.Unmarshal(data, &varTradesAggregateResponse)

	if err != nil {
		return err
	}

	*o = TradesAggregateResponse(varTradesAggregateResponse)
...
type NullableTradesAggregateResponse struct {
	value *TradesAggregateResponse
	isSet bool
}

func (v NullableTradesAggregateResponse) Get() *TradesAggregateResponse {
	return v.value
}

func (v *NullableTradesAggregateResponse) Set(val *TradesAggregateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTradesAggregateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTradesAggregateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTradesAggregateResponse(val *TradesAggregateResponse) *NullableTradesAggregateResponse {
	return &NullableTradesAggregateResponse{value: val, isSet: true}
}

func (v NullableTradesAggregateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTradesAggregateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
