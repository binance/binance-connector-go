...
// checks if the OrderListPlaceOtocoResponseResult type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListPlaceOtocoResponseResult{}

// OrderListPlaceOtocoResponseResult struct for OrderListPlaceOtocoResponseResult
type OrderListPlaceOtocoResponseResult struct {
	...
	Orders               []OrderListPlaceOtocoResponseResultOrdersInner       `json:"orders,omitempty"`
	OrderReports         []OrderListPlaceOtocoResponseResultOrderReportsInner `json:"orderReports,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderListPlaceOtocoResponseResult OrderListPlaceOtocoResponseResult
...
func NewOrderListPlaceOtocoResponseResult() *OrderListPlaceOtocoResponseResult {
	this := OrderListPlaceOtocoResponseResult{}
	return &this
}
...
func (o *OrderListPlaceOtocoResponseResult) GetOrders() []OrderListPlaceOtocoResponseResultOrdersInner {
	if o == nil || common.IsNil(o.Orders) {
		var ret []OrderListPlaceOtocoResponseResultOrdersInner
		return ret
	}
	return o.Orders
}
...
// SetOrders gets a reference to the given []OrderListPlaceOtocoResponseResultOrdersInner and assigns it to the Orders field.
...
func (o *OrderListPlaceOtocoResponseResult) GetOrderReports() []OrderListPlaceOtocoResponseResultOrderReportsInner {
	if o == nil || common.IsNil(o.OrderReports) {
		var ret []OrderListPlaceOtocoResponseResultOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []OrderListPlaceOtocoResponseResultOrderReportsInner and assigns it to the OrderReports field.
func (o *OrderListPlaceOtocoResponseResult) SetOrderReports(v []OrderListPlaceOtocoResponseResultOrderReportsInner) {
	o.OrderReports = v
}

func (o OrderListPlaceOtocoResponseResult) MarshalJSON() ([]byte, error) {
...
func (o OrderListPlaceOtocoResponseResult) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListPlaceOtocoResponseResult) UnmarshalJSON(data []byte) (err error) {
	varOrderListPlaceOtocoResponseResult := _OrderListPlaceOtocoResponseResult{}

	err = json.Unmarshal(data, &varOrderListPlaceOtocoResponseResult)

	if err != nil {
		return err
	}

	*o = OrderListPlaceOtocoResponseResult(varOrderListPlaceOtocoResponseResult)
...
type NullableOrderListPlaceOtocoResponseResult struct {
	value *OrderListPlaceOtocoResponseResult
	isSet bool
}

func (v NullableOrderListPlaceOtocoResponseResult) Get() *OrderListPlaceOtocoResponseResult {
	return v.value
}

func (v *NullableOrderListPlaceOtocoResponseResult) Set(val *OrderListPlaceOtocoResponseResult) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListPlaceOtocoResponseResult) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListPlaceOtocoResponseResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListPlaceOtocoResponseResult(val *OrderListPlaceOtocoResponseResult) *NullableOrderListPlaceOtocoResponseResult {
	return &NullableOrderListPlaceOtocoResponseResult{value: val, isSet: true}
}

func (v NullableOrderListPlaceOtocoResponseResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListPlaceOtocoResponseResult) UnmarshalJSON(src []byte) error {
	v.isSet = true
