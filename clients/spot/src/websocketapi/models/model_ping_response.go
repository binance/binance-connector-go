...
var _ common.MappedNullable = &PingResponse{}
...
func (o *PingResponse) GetResult() interface{} {
	return nil
}

// GetResultOk returns a tuple with the Result field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PingResponse) GetResultOk() (interface{}, bool) {
	return nil, true
}
...
func (o *PingResponse) SetResult(v []interface{}) {
	o.Result = v
}
...
func (o *PingResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varPingResponse)
