...
func (o *AccountCommissionResponse) GetResult() AccountCommissionResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret AccountCommissionResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given AccountCommissionResponseResult and assigns it to the Result field.
func (o *AccountCommissionResponse) SetResult(v AccountCommissionResponseResult) {
	o.Result = &v
}

// GetRateLimits returns the RateLimits field value if set, zero value otherwise.
func (o *AccountCommissionResponse) GetRateLimits() []AccountCommissionResponseRateLimitsInner {
...
// and a boolean to check if the value has been set.
func (o *AccountCommissionResponse) GetRateLimitsOk() ([]AccountCommissionResponseRateLimitsInner, bool) {
	if o == nil || common.IsNil(o.RateLimits) {
		return nil, false
	}
...
func (o *AccountCommissionResponse) SetRateLimits(v []AccountCommissionResponseRateLimitsInner) {
	o.RateLimits = v
}
