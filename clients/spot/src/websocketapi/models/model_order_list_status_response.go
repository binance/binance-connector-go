...
// checks if the OrderListStatusResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListStatusResponse{}
...
type _OrderListStatusResponse OrderListStatusResponse
...
func (o OrderListStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderListStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varOrderListStatusResponse := _OrderListStatusResponse{}

	err = json.Unmarshal(data, &varOrderListStatusResponse)

	if err != nil {
		return err
	}

	*o = OrderListStatusResponse(varOrderListStatusResponse)
...
type NullableOrderListStatusResponse struct {
	value *OrderListStatusResponse
	isSet bool
}

func (v NullableOrderListStatusResponse) Get() *OrderListStatusResponse {
	return v.value
}

func (v *NullableOrderListStatusResponse) Set(val *OrderListStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListStatusResponse(val *OrderListStatusResponse) *NullableOrderListStatusResponse {
	return &NullableOrderListStatusResponse{value: val, isSet: true}
}

func (v NullableOrderListStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
