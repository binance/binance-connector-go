...
type MyTradesResponse struct {
	...
	Result               []MyTradesResponseResultInner              `json:"result,omitempty"`
	RateLimits           []AccountCommissionResponseRateLimitsInner `json:"rateLimits,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MyTradesResponse MyTradesResponse
...
func (o *MyTradesResponse) GetResult() []MyTradesResponseResultInner {
	if o == nil || common.IsNil(o.Result) {
		var ret []MyTradesResponseResultInner
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []MyTradesResponseResultInner and assigns it to the Result field.
func (o *MyTradesResponse) SetResult(v []MyTradesResponseResultInner) {
	o.Result = v
}

// GetRateLimits returns the RateLimits field value if set, zero value otherwise.
func (o *MyTradesResponse) GetRateLimits() []AccountCommissionResponseRateLimitsInner {
...
// and a boolean to check if the value has been set.
func (o *MyTradesResponse) GetRateLimitsOk() ([]AccountCommissionResponseRateLimitsInner, bool) {
	if o == nil || common.IsNil(o.RateLimits) {
		return nil, false
	}
...
func (o *MyTradesResponse) SetRateLimits(v []AccountCommissionResponseRateLimitsInner) {
	o.RateLimits = v
}
...
func (o *MyTradesResponse) UnmarshalJSON(data []byte) (err error) {
	varMyTradesResponse := _MyTradesResponse{}

	err = json.Unmarshal(data, &varMyTradesResponse)

	if err != nil {
		return err
	}

	*o = MyTradesResponse(varMyTradesResponse)
