...
// checks if the Ticker24hrResponse2ResultInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &Ticker24hrResponse2ResultInner{}

// Ticker24hrResponse2ResultInner struct for Ticker24hrResponse2ResultInner
type Ticker24hrResponse2ResultInner struct {
...
type _Ticker24hrResponse2ResultInner Ticker24hrResponse2ResultInner

// NewTicker24hrResponse2ResultInner instantiates a new Ticker24hrResponse2ResultInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTicker24hrResponse2ResultInner() *Ticker24hrResponse2ResultInner {
	this := Ticker24hrResponse2ResultInner{}
	return &this
}

// NewTicker24hrResponse2ResultInnerWithDefaults instantiates a new Ticker24hrResponse2ResultInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTicker24hrResponse2ResultInnerWithDefaults() *Ticker24hrResponse2ResultInner {
	this := Ticker24hrResponse2ResultInner{}
	return &this
}

// GetSymbol returns the Symbol field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetSymbol() string {
...
func (o *Ticker24hrResponse2ResultInner) GetSymbolOk() (*string, bool) {
	if o == nil || common.IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasSymbol() bool {
	if o != nil && !common.IsNil(o.Symbol) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetSymbol(v string) {
	o.Symbol = &v
}

// GetPriceChange returns the PriceChange field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetPriceChange() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetPriceChangeOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceChange) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasPriceChange() bool {
	if o != nil && !common.IsNil(o.PriceChange) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetPriceChange(v string) {
	o.PriceChange = &v
}

// GetPriceChangePercent returns the PriceChangePercent field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetPriceChangePercent() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetPriceChangePercentOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceChangePercent) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasPriceChangePercent() bool {
	if o != nil && !common.IsNil(o.PriceChangePercent) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetPriceChangePercent(v string) {
	o.PriceChangePercent = &v
}

// GetWeightedAvgPrice returns the WeightedAvgPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetWeightedAvgPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetWeightedAvgPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.WeightedAvgPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasWeightedAvgPrice() bool {
	if o != nil && !common.IsNil(o.WeightedAvgPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetWeightedAvgPrice(v string) {
	o.WeightedAvgPrice = &v
}

// GetPrevClosePrice returns the PrevClosePrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetPrevClosePrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetPrevClosePriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.PrevClosePrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasPrevClosePrice() bool {
	if o != nil && !common.IsNil(o.PrevClosePrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetPrevClosePrice(v string) {
	o.PrevClosePrice = &v
}

// GetLastPrice returns the LastPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetLastPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetLastPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.LastPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasLastPrice() bool {
	if o != nil && !common.IsNil(o.LastPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetLastPrice(v string) {
	o.LastPrice = &v
}

// GetLastQty returns the LastQty field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetLastQty() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetLastQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.LastQty) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasLastQty() bool {
	if o != nil && !common.IsNil(o.LastQty) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetLastQty(v string) {
	o.LastQty = &v
}

// GetBidPrice returns the BidPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetBidPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetBidPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.BidPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasBidPrice() bool {
	if o != nil && !common.IsNil(o.BidPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetBidPrice(v string) {
	o.BidPrice = &v
}

// GetBidQty returns the BidQty field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetBidQty() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetBidQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.BidQty) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasBidQty() bool {
	if o != nil && !common.IsNil(o.BidQty) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetBidQty(v string) {
	o.BidQty = &v
}

// GetAskPrice returns the AskPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetAskPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetAskPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.AskPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasAskPrice() bool {
	if o != nil && !common.IsNil(o.AskPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetAskPrice(v string) {
	o.AskPrice = &v
}

// GetAskQty returns the AskQty field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetAskQty() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetAskQtyOk() (*string, bool) {
	if o == nil || common.IsNil(o.AskQty) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasAskQty() bool {
	if o != nil && !common.IsNil(o.AskQty) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetAskQty(v string) {
	o.AskQty = &v
}

// GetOpenPrice returns the OpenPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetOpenPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetOpenPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.OpenPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasOpenPrice() bool {
	if o != nil && !common.IsNil(o.OpenPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetOpenPrice(v string) {
	o.OpenPrice = &v
}

// GetHighPrice returns the HighPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetHighPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetHighPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.HighPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasHighPrice() bool {
	if o != nil && !common.IsNil(o.HighPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetHighPrice(v string) {
	o.HighPrice = &v
}

// GetLowPrice returns the LowPrice field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetLowPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetLowPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.LowPrice) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasLowPrice() bool {
	if o != nil && !common.IsNil(o.LowPrice) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetLowPrice(v string) {
	o.LowPrice = &v
}

// GetVolume returns the Volume field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetVolume() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetVolumeOk() (*string, bool) {
	if o == nil || common.IsNil(o.Volume) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasVolume() bool {
	if o != nil && !common.IsNil(o.Volume) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetVolume(v string) {
	o.Volume = &v
}

// GetQuoteVolume returns the QuoteVolume field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetQuoteVolume() string {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetQuoteVolumeOk() (*string, bool) {
	if o == nil || common.IsNil(o.QuoteVolume) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasQuoteVolume() bool {
	if o != nil && !common.IsNil(o.QuoteVolume) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetQuoteVolume(v string) {
	o.QuoteVolume = &v
}

// GetOpenTime returns the OpenTime field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetOpenTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetOpenTimeOk() (*int64, bool) {
	if o == nil || common.IsNil(o.OpenTime) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasOpenTime() bool {
	if o != nil && !common.IsNil(o.OpenTime) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetOpenTime(v int64) {
	o.OpenTime = &v
}

// GetCloseTime returns the CloseTime field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetCloseTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetCloseTimeOk() (*int64, bool) {
	if o == nil || common.IsNil(o.CloseTime) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasCloseTime() bool {
	if o != nil && !common.IsNil(o.CloseTime) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetCloseTime(v int64) {
	o.CloseTime = &v
}

// GetFirstId returns the FirstId field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetFirstId() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetFirstIdOk() (*int64, bool) {
	if o == nil || common.IsNil(o.FirstId) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasFirstId() bool {
	if o != nil && !common.IsNil(o.FirstId) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetFirstId(v int64) {
	o.FirstId = &v
}

// GetLastId returns the LastId field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetLastId() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetLastIdOk() (*int64, bool) {
	if o == nil || common.IsNil(o.LastId) {
		return nil, false
	}
...
func (o *Ticker24hrResponse2ResultInner) HasLastId() bool {
	if o != nil && !common.IsNil(o.LastId) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetLastId(v int64) {
	o.LastId = &v
}

// GetCount returns the Count field value if set, zero value otherwise.
func (o *Ticker24hrResponse2ResultInner) GetCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *Ticker24hrResponse2ResultInner) GetCountOk() (*int64, bool) {
	if o == nil || common.IsNil(o.Count) {
		return nil, false
	}
	return o.Count, true
...
func (o *Ticker24hrResponse2ResultInner) HasCount() bool {
	if o != nil && !common.IsNil(o.Count) {
		return true
	}
...
func (o *Ticker24hrResponse2ResultInner) SetCount(v int64) {
	o.Count = &v
}

func (o Ticker24hrResponse2ResultInner) MarshalJSON() ([]byte, error) {
...
func (o Ticker24hrResponse2ResultInner) ToMap() (map[string]interface{}, error) {
...
func (o *Ticker24hrResponse2ResultInner) UnmarshalJSON(data []byte) (err error) {
	varTicker24hrResponse2ResultInner := _Ticker24hrResponse2ResultInner{}

	err = json.Unmarshal(data, &varTicker24hrResponse2ResultInner)

	if err != nil {
		return err
	}

	*o = Ticker24hrResponse2ResultInner(varTicker24hrResponse2ResultInner)
...
type NullableTicker24hrResponse2ResultInner struct {
	value *Ticker24hrResponse2ResultInner
	isSet bool
}

func (v NullableTicker24hrResponse2ResultInner) Get() *Ticker24hrResponse2ResultInner {
	return v.value
}

func (v *NullableTicker24hrResponse2ResultInner) Set(val *Ticker24hrResponse2ResultInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTicker24hrResponse2ResultInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTicker24hrResponse2ResultInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTicker24hrResponse2ResultInner(val *Ticker24hrResponse2ResultInner) *NullableTicker24hrResponse2ResultInner {
	return &NullableTicker24hrResponse2ResultInner{value: val, isSet: true}
}

func (v NullableTicker24hrResponse2ResultInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTicker24hrResponse2ResultInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
