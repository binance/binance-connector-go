...
// checks if the OpenOrderListsStatusResponseResultInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OpenOrderListsStatusResponseResultInner{}

// OpenOrderListsStatusResponseResultInner struct for OpenOrderListsStatusResponseResultInner
type OpenOrderListsStatusResponseResultInner struct {
	...
	Orders               []OpenOrderListsStatusResponseResultInnerOrdersInner `json:"orders,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OpenOrderListsStatusResponseResultInner OpenOrderListsStatusResponseResultInner
...
func NewOpenOrderListsStatusResponseResultInner() *OpenOrderListsStatusResponseResultInner {
	this := OpenOrderListsStatusResponseResultInner{}
	return &this
}
...
func (o *OpenOrderListsStatusResponseResultInner) GetOrders() []OpenOrderListsStatusResponseResultInnerOrdersInner {
	if o == nil || common.IsNil(o.Orders) {
		var ret []OpenOrderListsStatusResponseResultInnerOrdersInner
		return ret
	}
	return o.Orders
}
...
// SetOrders gets a reference to the given []OpenOrderListsStatusResponseResultInnerOrdersInner and assigns it to the Orders field.
func (o *OpenOrderListsStatusResponseResultInner) SetOrders(v []OpenOrderListsStatusResponseResultInnerOrdersInner) {
	o.Orders = v
}

func (o OpenOrderListsStatusResponseResultInner) MarshalJSON() ([]byte, error) {
...
func (o OpenOrderListsStatusResponseResultInner) ToMap() (map[string]interface{}, error) {
...
func (o *OpenOrderListsStatusResponseResultInner) UnmarshalJSON(data []byte) (err error) {
	varOpenOrderListsStatusResponseResultInner := _OpenOrderListsStatusResponseResultInner{}

	err = json.Unmarshal(data, &varOpenOrderListsStatusResponseResultInner)

	if err != nil {
		return err
	}

	*o = OpenOrderListsStatusResponseResultInner(varOpenOrderListsStatusResponseResultInner)
...
type NullableOpenOrderListsStatusResponseResultInner struct {
	value *OpenOrderListsStatusResponseResultInner
	isSet bool
}

func (v NullableOpenOrderListsStatusResponseResultInner) Get() *OpenOrderListsStatusResponseResultInner {
	return v.value
}

func (v *NullableOpenOrderListsStatusResponseResultInner) Set(val *OpenOrderListsStatusResponseResultInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenOrderListsStatusResponseResultInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenOrderListsStatusResponseResultInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenOrderListsStatusResponseResultInner(val *OpenOrderListsStatusResponseResultInner) *NullableOpenOrderListsStatusResponseResultInner {
	return &NullableOpenOrderListsStatusResponseResultInner{value: val, isSet: true}
}

func (v NullableOpenOrderListsStatusResponseResultInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenOrderListsStatusResponseResultInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
