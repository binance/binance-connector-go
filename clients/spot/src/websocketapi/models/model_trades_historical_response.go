...
// checks if the TradesHistoricalResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &TradesHistoricalResponse{}
...
type _TradesHistoricalResponse TradesHistoricalResponse
...
func (o *TradesHistoricalResponse) GetResult() []TradesHistoricalResponseResultInner {
	if o == nil || common.IsNil(o.Result) {
		var ret []TradesHistoricalResponseResultInner
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []TradesHistoricalResponseResultInner and assigns it to the Result field.
...
func (o TradesHistoricalResponse) MarshalJSON() ([]byte, error) {
...
func (o TradesHistoricalResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TradesHistoricalResponse) UnmarshalJSON(data []byte) (err error) {
	varTradesHistoricalResponse := _TradesHistoricalResponse{}

	err = json.Unmarshal(data, &varTradesHistoricalResponse)

	if err != nil {
		return err
	}

	*o = TradesHistoricalResponse(varTradesHistoricalResponse)
...
type NullableTradesHistoricalResponse struct {
	value *TradesHistoricalResponse
	isSet bool
}

func (v NullableTradesHistoricalResponse) Get() *TradesHistoricalResponse {
	return v.value
}

func (v *NullableTradesHistoricalResponse) Set(val *TradesHistoricalResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTradesHistoricalResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTradesHistoricalResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTradesHistoricalResponse(val *TradesHistoricalResponse) *NullableTradesHistoricalResponse {
	return &NullableTradesHistoricalResponse{value: val, isSet: true}
}

func (v NullableTradesHistoricalResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTradesHistoricalResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
