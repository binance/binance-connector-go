...
type ExecutionRulesResponse struct {
	...
	Result               *ExecutionRulesResponseResult `json:"result,omitempty"`
...
func (o *ExecutionRulesResponse) GetResult() ExecutionRulesResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret ExecutionRulesResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ExecutionRulesResponseResult and assigns it to the Result field.
