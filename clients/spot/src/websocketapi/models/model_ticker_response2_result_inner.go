...
// checks if the TickerResponse2ResultInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &TickerResponse2ResultInner{}

// TickerResponse2ResultInner struct for TickerResponse2ResultInner
type TickerResponse2ResultInner struct {
...
type _TickerResponse2ResultInner TickerResponse2ResultInner

// NewTickerResponse2ResultInner instantiates a new TickerResponse2ResultInner object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTickerResponse2ResultInner() *TickerResponse2ResultInner {
	this := TickerResponse2ResultInner{}
	return &this
}

// NewTickerResponse2ResultInnerWithDefaults instantiates a new TickerResponse2ResultInner object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTickerResponse2ResultInnerWithDefaults() *TickerResponse2ResultInner {
	this := TickerResponse2ResultInner{}
	return &this
}

// GetSymbol returns the Symbol field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetSymbol() string {
...
func (o *TickerResponse2ResultInner) GetSymbolOk() (*string, bool) {
	if o == nil || common.IsNil(o.Symbol) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasSymbol() bool {
	if o != nil && !common.IsNil(o.Symbol) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetSymbol(v string) {
	o.Symbol = &v
}

// GetPriceChange returns the PriceChange field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetPriceChange() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetPriceChangeOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceChange) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasPriceChange() bool {
	if o != nil && !common.IsNil(o.PriceChange) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetPriceChange(v string) {
	o.PriceChange = &v
}

// GetPriceChangePercent returns the PriceChangePercent field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetPriceChangePercent() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetPriceChangePercentOk() (*string, bool) {
	if o == nil || common.IsNil(o.PriceChangePercent) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasPriceChangePercent() bool {
	if o != nil && !common.IsNil(o.PriceChangePercent) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetPriceChangePercent(v string) {
	o.PriceChangePercent = &v
}

// GetWeightedAvgPrice returns the WeightedAvgPrice field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetWeightedAvgPrice() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetWeightedAvgPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.WeightedAvgPrice) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasWeightedAvgPrice() bool {
	if o != nil && !common.IsNil(o.WeightedAvgPrice) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetWeightedAvgPrice(v string) {
	o.WeightedAvgPrice = &v
}

// GetOpenPrice returns the OpenPrice field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetOpenPrice() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetOpenPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.OpenPrice) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasOpenPrice() bool {
	if o != nil && !common.IsNil(o.OpenPrice) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetOpenPrice(v string) {
	o.OpenPrice = &v
}

// GetHighPrice returns the HighPrice field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetHighPrice() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetHighPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.HighPrice) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasHighPrice() bool {
	if o != nil && !common.IsNil(o.HighPrice) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetHighPrice(v string) {
	o.HighPrice = &v
}

// GetLowPrice returns the LowPrice field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetLowPrice() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetLowPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.LowPrice) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasLowPrice() bool {
	if o != nil && !common.IsNil(o.LowPrice) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetLowPrice(v string) {
	o.LowPrice = &v
}

// GetLastPrice returns the LastPrice field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetLastPrice() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetLastPriceOk() (*string, bool) {
	if o == nil || common.IsNil(o.LastPrice) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasLastPrice() bool {
	if o != nil && !common.IsNil(o.LastPrice) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetLastPrice(v string) {
	o.LastPrice = &v
}

// GetVolume returns the Volume field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetVolume() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetVolumeOk() (*string, bool) {
	if o == nil || common.IsNil(o.Volume) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasVolume() bool {
	if o != nil && !common.IsNil(o.Volume) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetVolume(v string) {
	o.Volume = &v
}

// GetQuoteVolume returns the QuoteVolume field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetQuoteVolume() string {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetQuoteVolumeOk() (*string, bool) {
	if o == nil || common.IsNil(o.QuoteVolume) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasQuoteVolume() bool {
	if o != nil && !common.IsNil(o.QuoteVolume) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetQuoteVolume(v string) {
	o.QuoteVolume = &v
}

// GetOpenTime returns the OpenTime field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetOpenTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetOpenTimeOk() (*int64, bool) {
	if o == nil || common.IsNil(o.OpenTime) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasOpenTime() bool {
	if o != nil && !common.IsNil(o.OpenTime) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetOpenTime(v int64) {
	o.OpenTime = &v
}

// GetCloseTime returns the CloseTime field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetCloseTime() int64 {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetCloseTimeOk() (*int64, bool) {
	if o == nil || common.IsNil(o.CloseTime) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasCloseTime() bool {
	if o != nil && !common.IsNil(o.CloseTime) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetCloseTime(v int64) {
	o.CloseTime = &v
}

// GetFirstId returns the FirstId field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetFirstId() int64 {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetFirstIdOk() (*int64, bool) {
	if o == nil || common.IsNil(o.FirstId) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasFirstId() bool {
	if o != nil && !common.IsNil(o.FirstId) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetFirstId(v int64) {
	o.FirstId = &v
}

// GetLastId returns the LastId field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetLastId() int64 {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetLastIdOk() (*int64, bool) {
	if o == nil || common.IsNil(o.LastId) {
		return nil, false
	}
...
func (o *TickerResponse2ResultInner) HasLastId() bool {
	if o != nil && !common.IsNil(o.LastId) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetLastId(v int64) {
	o.LastId = &v
}

// GetCount returns the Count field value if set, zero value otherwise.
func (o *TickerResponse2ResultInner) GetCount() int64 {
...
// and a boolean to check if the value has been set.
func (o *TickerResponse2ResultInner) GetCountOk() (*int64, bool) {
	if o == nil || common.IsNil(o.Count) {
		return nil, false
	}
	return o.Count, true
...
func (o *TickerResponse2ResultInner) HasCount() bool {
	if o != nil && !common.IsNil(o.Count) {
		return true
	}
...
func (o *TickerResponse2ResultInner) SetCount(v int64) {
	o.Count = &v
}

func (o TickerResponse2ResultInner) MarshalJSON() ([]byte, error) {
...
func (o TickerResponse2ResultInner) ToMap() (map[string]interface{}, error) {
...
func (o *TickerResponse2ResultInner) UnmarshalJSON(data []byte) (err error) {
	varTickerResponse2ResultInner := _TickerResponse2ResultInner{}

	err = json.Unmarshal(data, &varTickerResponse2ResultInner)

	if err != nil {
		return err
	}

	*o = TickerResponse2ResultInner(varTickerResponse2ResultInner)
...
type NullableTickerResponse2ResultInner struct {
	value *TickerResponse2ResultInner
	isSet bool
}

func (v NullableTickerResponse2ResultInner) Get() *TickerResponse2ResultInner {
	return v.value
}

func (v *NullableTickerResponse2ResultInner) Set(val *TickerResponse2ResultInner) {
	v.value = val
	v.isSet = true
}

func (v NullableTickerResponse2ResultInner) IsSet() bool {
	return v.isSet
}

func (v *NullableTickerResponse2ResultInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTickerResponse2ResultInner(val *TickerResponse2ResultInner) *NullableTickerResponse2ResultInner {
	return &NullableTickerResponse2ResultInner{value: val, isSet: true}
}

func (v NullableTickerResponse2ResultInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTickerResponse2ResultInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
