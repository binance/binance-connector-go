...
// checks if the OpenOrdersStatusResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OpenOrdersStatusResponse{}
...
type _OpenOrdersStatusResponse OpenOrdersStatusResponse
...
func (o *OpenOrdersStatusResponse) GetResult() []OpenOrdersStatusResponseResultInner {
	if o == nil || common.IsNil(o.Result) {
		var ret []OpenOrdersStatusResponseResultInner
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []OpenOrdersStatusResponseResultInner and assigns it to the Result field.
...
func (o OpenOrdersStatusResponse) MarshalJSON() ([]byte, error) {
...
func (o OpenOrdersStatusResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OpenOrdersStatusResponse) UnmarshalJSON(data []byte) (err error) {
	varOpenOrdersStatusResponse := _OpenOrdersStatusResponse{}

	err = json.Unmarshal(data, &varOpenOrdersStatusResponse)

	if err != nil {
		return err
	}

	*o = OpenOrdersStatusResponse(varOpenOrdersStatusResponse)
...
type NullableOpenOrdersStatusResponse struct {
	value *OpenOrdersStatusResponse
	isSet bool
}

func (v NullableOpenOrdersStatusResponse) Get() *OpenOrdersStatusResponse {
	return v.value
}

func (v *NullableOpenOrdersStatusResponse) Set(val *OpenOrdersStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenOrdersStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenOrdersStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenOrdersStatusResponse(val *OpenOrdersStatusResponse) *NullableOpenOrdersStatusResponse {
	return &NullableOpenOrdersStatusResponse{value: val, isSet: true}
}

func (v NullableOpenOrdersStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenOrdersStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
