...
// checks if the OrderListCancelResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListCancelResponse{}
...
type _OrderListCancelResponse OrderListCancelResponse
...
func (o *OrderListCancelResponse) GetResult() OrderListCancelResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret OrderListCancelResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderListCancelResponseResult and assigns it to the Result field.
...
func (o OrderListCancelResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderListCancelResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListCancelResponse) UnmarshalJSON(data []byte) (err error) {
	varOrderListCancelResponse := _OrderListCancelResponse{}

	err = json.Unmarshal(data, &varOrderListCancelResponse)

	if err != nil {
		return err
	}

	*o = OrderListCancelResponse(varOrderListCancelResponse)
...
type NullableOrderListCancelResponse struct {
	value *OrderListCancelResponse
	isSet bool
}

func (v NullableOrderListCancelResponse) Get() *OrderListCancelResponse {
	return v.value
}

func (v *NullableOrderListCancelResponse) Set(val *OrderListCancelResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListCancelResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListCancelResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListCancelResponse(val *OrderListCancelResponse) *NullableOrderListCancelResponse {
	return &NullableOrderListCancelResponse{value: val, isSet: true}
}

func (v NullableOrderListCancelResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListCancelResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
