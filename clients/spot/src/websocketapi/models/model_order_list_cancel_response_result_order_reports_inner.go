...
// checks if the OrderListCancelResponseResultOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListCancelResponseResultOrderReportsInner{}

// OrderListCancelResponseResultOrderReportsInner struct for OrderListCancelResponseResultOrderReportsInner
type OrderListCancelResponseResultOrderReportsInner struct {
...
type _OrderListCancelResponseResultOrderReportsInner OrderListCancelResponseResultOrderReportsInner
...
func NewOrderListCancelResponseResultOrderReportsInner() *OrderListCancelResponseResultOrderReportsInner {
	this := OrderListCancelResponseResultOrderReportsInner{}
	return &this
}
...
func (o OrderListCancelResponseResultOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o OrderListCancelResponseResultOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListCancelResponseResultOrderReportsInner) UnmarshalJSON(data []byte) (err error) {
	varOrderListCancelResponseResultOrderReportsInner := _OrderListCancelResponseResultOrderReportsInner{}

	err = json.Unmarshal(data, &varOrderListCancelResponseResultOrderReportsInner)

	if err != nil {
		return err
	}

	*o = OrderListCancelResponseResultOrderReportsInner(varOrderListCancelResponseResultOrderReportsInner)
...
type NullableOrderListCancelResponseResultOrderReportsInner struct {
	value *OrderListCancelResponseResultOrderReportsInner
	isSet bool
}

func (v NullableOrderListCancelResponseResultOrderReportsInner) Get() *OrderListCancelResponseResultOrderReportsInner {
	return v.value
}

func (v *NullableOrderListCancelResponseResultOrderReportsInner) Set(val *OrderListCancelResponseResultOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListCancelResponseResultOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListCancelResponseResultOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListCancelResponseResultOrderReportsInner(val *OrderListCancelResponseResultOrderReportsInner) *NullableOrderListCancelResponseResultOrderReportsInner {
	return &NullableOrderListCancelResponseResultOrderReportsInner{value: val, isSet: true}
}

func (v NullableOrderListCancelResponseResultOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListCancelResponseResultOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
