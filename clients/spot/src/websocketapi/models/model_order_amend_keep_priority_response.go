...
func (o *OrderAmendKeepPriorityResponse) GetId() string {
...
func (o *OrderAmendKeepPriorityResponse) GetIdOk() (*string, bool) {
	if o == nil || common.IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *OrderAmendKeepPriorityResponse) HasId() bool {
	if o != nil && !common.IsNil(o.Id) {
		return true
	}
...
func (o *OrderAmendKeepPriorityResponse) SetId(v string) {
	o.Id = &v
}

// GetStatus returns the Status field value if set, zero value otherwise.
func (o *OrderAmendKeepPriorityResponse) GetStatus() int64 {
...
// and a boolean to check if the value has been set.
func (o *OrderAmendKeepPriorityResponse) GetStatusOk() (*int64, bool) {
	if o == nil || common.IsNil(o.Status) {
		return nil, false
	}
...
func (o *OrderAmendKeepPriorityResponse) HasStatus() bool {
	if o != nil && !common.IsNil(o.Status) {
		return true
	}
...
func (o *OrderAmendKeepPriorityResponse) SetStatus(v int64) {
	o.Status = &v
}

// GetResult returns the Result field value if set, zero value otherwise.
func (o *OrderAmendKeepPriorityResponse) GetResult() OrderAmendKeepPriorityResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret OrderAmendKeepPriorityResponseResult
		return ret
	}
	return *o.Result
}
...
// and a boolean to check if the value has been set.
func (o *OrderAmendKeepPriorityResponse) GetResultOk() (*OrderAmendKeepPriorityResponseResult, bool) {
	if o == nil || common.IsNil(o.Result) {
		return nil, false
	}
...
func (o *OrderAmendKeepPriorityResponse) HasResult() bool {
	if o != nil && !common.IsNil(o.Result) {
		return true
	}
...
// SetResult gets a reference to the given OrderAmendKeepPriorityResponseResult and assigns it to the Result field.
func (o *OrderAmendKeepPriorityResponse) SetResult(v OrderAmendKeepPriorityResponseResult) {
	o.Result = &v
}

// GetRateLimits returns the RateLimits field value if set, zero value otherwise.
func (o *OrderAmendKeepPriorityResponse) GetRateLimits() []RateLimits {
...
// and a boolean to check if the value has been set.
func (o *OrderAmendKeepPriorityResponse) GetRateLimitsOk() ([]RateLimits, bool) {
	if o == nil || common.IsNil(o.RateLimits) {
		return nil, false
	}
...
func (o *OrderAmendKeepPriorityResponse) HasRateLimits() bool {
	if o != nil && !common.IsNil(o.RateLimits) {
		return true
	}
...
func (o *OrderAmendKeepPriorityResponse) SetRateLimits(v []RateLimits) {
	o.RateLimits = v
}
