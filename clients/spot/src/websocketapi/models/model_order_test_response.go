...
type OrderTestResponse struct {
	...
	Result               *OrderTestResponseResult `json:"result,omitempty"`
...
func (o *OrderTestResponse) GetResult() OrderTestResponseResult {
	if o == nil || common.IsNil(o.Result) {
		var ret OrderTestResponseResult
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given OrderTestResponseResult and assigns it to the Result field.
