...
func (o *AllOrderListsResponse) GetRateLimits() []AccountCommissionResponseRateLimitsInner {
...
// and a boolean to check if the value has been set.
func (o *AllOrderListsResponse) GetRateLimitsOk() ([]AccountCommissionResponseRateLimitsInner, bool) {
	if o == nil || common.IsNil(o.RateLimits) {
		return nil, false
	}
...
func (o *AllOrderListsResponse) SetRateLimits(v []AccountCommissionResponseRateLimitsInner) {
	o.RateLimits = v
}
