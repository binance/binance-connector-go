...
// checks if the OrderListPlaceOtocoResponseResultOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListPlaceOtocoResponseResultOrderReportsInner{}

// OrderListPlaceOtocoResponseResultOrderReportsInner struct for OrderListPlaceOtocoResponseResultOrderReportsInner
type OrderListPlaceOtocoResponseResultOrderReportsInner struct {
...
type _OrderListPlaceOtocoResponseResultOrderReportsInner OrderListPlaceOtocoResponseResultOrderReportsInner
...
func NewOrderListPlaceOtocoResponseResultOrderReportsInner() *OrderListPlaceOtocoResponseResultOrderReportsInner {
	this := OrderListPlaceOtocoResponseResultOrderReportsInner{}
	return &this
}
...
func (o OrderListPlaceOtocoResponseResultOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o OrderListPlaceOtocoResponseResultOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListPlaceOtocoResponseResultOrderReportsInner) UnmarshalJSON(data []byte) (err error) {
	varOrderListPlaceOtocoResponseResultOrderReportsInner := _OrderListPlaceOtocoResponseResultOrderReportsInner{}

	err = json.Unmarshal(data, &varOrderListPlaceOtocoResponseResultOrderReportsInner)

	if err != nil {
		return err
	}

	*o = OrderListPlaceOtocoResponseResultOrderReportsInner(varOrderListPlaceOtocoResponseResultOrderReportsInner)
...
type NullableOrderListPlaceOtocoResponseResultOrderReportsInner struct {
	value *OrderListPlaceOtocoResponseResultOrderReportsInner
	isSet bool
}

func (v NullableOrderListPlaceOtocoResponseResultOrderReportsInner) Get() *OrderListPlaceOtocoResponseResultOrderReportsInner {
	return v.value
}

func (v *NullableOrderListPlaceOtocoResponseResultOrderReportsInner) Set(val *OrderListPlaceOtocoResponseResultOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListPlaceOtocoResponseResultOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListPlaceOtocoResponseResultOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListPlaceOtocoResponseResultOrderReportsInner(val *OrderListPlaceOtocoResponseResultOrderReportsInner) *NullableOrderListPlaceOtocoResponseResultOrderReportsInner {
	return &NullableOrderListPlaceOtocoResponseResultOrderReportsInner{value: val, isSet: true}
}

func (v NullableOrderListPlaceOtocoResponseResultOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListPlaceOtocoResponseResultOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
