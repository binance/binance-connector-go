...
func (a *TradeAPIService) DeleteOpenOrdersExecute(r ApiDeleteOpenOrdersRequest) (*common.RestApiResponse[models.DeleteOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.DeleteOpenOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) DeleteOrderExecute(r ApiDeleteOrderRequest) (*common.RestApiResponse[models.DeleteOrderResponse], error) {
	...
	resp, err := SendRequest[models.DeleteOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) DeleteOrderListExecute(r ApiDeleteOrderListRequest) (*common.RestApiResponse[models.DeleteOrderListResponse], error) {
	...
	resp, err := SendRequest[models.DeleteOrderListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderAmendKeepPriorityExecute(r ApiOrderAmendKeepPriorityRequest) (*common.RestApiResponse[models.OrderAmendKeepPriorityResponse], error) {
	...
	resp, err := SendRequest[models.OrderAmendKeepPriorityResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderCancelReplaceExecute(r ApiOrderCancelReplaceRequest) (*common.RestApiResponse[models.OrderCancelReplaceResponse], error) {
	...
	resp, err := SendRequest[models.OrderCancelReplaceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderListOcoExecute(r ApiOrderListOcoRequest) (*common.RestApiResponse[models.OrderListOcoResponse], error) {
	...
	resp, err := SendRequest[models.OrderListOcoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderListOpoExecute(r ApiOrderListOpoRequest) (*common.RestApiResponse[models.OrderListOpoResponse], error) {
	...
	resp, err := SendRequest[models.OrderListOpoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderListOpocoExecute(r ApiOrderListOpocoRequest) (*common.RestApiResponse[models.OrderListOpocoResponse], error) {
	...
	resp, err := SendRequest[models.OrderListOpocoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderListOtoExecute(r ApiOrderListOtoRequest) (*common.RestApiResponse[models.OrderListOtoResponse], error) {
	...
	resp, err := SendRequest[models.OrderListOtoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderListOtocoExecute(r ApiOrderListOtocoRequest) (*common.RestApiResponse[models.OrderListOtocoResponse], error) {
	...
	resp, err := SendRequest[models.OrderListOtocoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderOcoExecute(r ApiOrderOcoRequest) (*common.RestApiResponse[models.OrderOcoResponse], error) {
	...
	resp, err := SendRequest[models.OrderOcoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) OrderTestExecute(r ApiOrderTestRequest) (*common.RestApiResponse[models.OrderTestResponse], error) {
	...
	resp, err := SendRequest[models.OrderTestResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) SorOrderExecute(r ApiSorOrderRequest) (*common.RestApiResponse[models.SorOrderResponse], error) {
	...
	resp, err := SendRequest[models.SorOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *TradeAPIService) SorOrderTestExecute(r ApiSorOrderTestRequest) (*common.RestApiResponse[models.SorOrderTestResponse], error) {
	...
	resp, err := SendRequest[models.SorOrderTestResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
