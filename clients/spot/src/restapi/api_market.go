...
func (a *MarketAPIService) AggTradesExecute(r ApiAggTradesRequest) (*common.RestApiResponse[models.AggTradesResponse], error) {
	...
	resp, err := SendRequest[models.AggTradesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) AvgPriceExecute(r ApiAvgPriceRequest) (*common.RestApiResponse[models.AvgPriceResponse], error) {
	...
	resp, err := SendRequest[models.AvgPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) DepthExecute(r ApiDepthRequest) (*common.RestApiResponse[models.DepthResponse], error) {
	...
	resp, err := SendRequest[models.DepthResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) GetTradesExecute(r ApiGetTradesRequest) (*common.RestApiResponse[models.GetTradesResponse], error) {
	...
	resp, err := SendRequest[models.GetTradesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) HistoricalTradesExecute(r ApiHistoricalTradesRequest) (*common.RestApiResponse[models.HistoricalTradesResponse], error) {
	...
	resp, err := SendRequest[models.HistoricalTradesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) KlinesExecute(r ApiKlinesRequest) (*common.RestApiResponse[models.KlinesResponse], error) {
	...
	resp, err := SendRequest[models.KlinesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) TickerExecute(r ApiTickerRequest) (*common.RestApiResponse[models.TickerResponse], error) {
	...
	resp, err := SendRequest[models.TickerResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) Ticker24hrExecute(r ApiTicker24hrRequest) (*common.RestApiResponse[models.Ticker24hrResponse], error) {
	...
	resp, err := SendRequest[models.Ticker24hrResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) TickerBookTickerExecute(r ApiTickerBookTickerRequest) (*common.RestApiResponse[models.TickerBookTickerResponse], error) {
	...
	resp, err := SendRequest[models.TickerBookTickerResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) TickerPriceExecute(r ApiTickerPriceRequest) (*common.RestApiResponse[models.TickerPriceResponse], error) {
	...
	resp, err := SendRequest[models.TickerPriceResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) TickerTradingDayExecute(r ApiTickerTradingDayRequest) (*common.RestApiResponse[models.TickerTradingDayResponse], error) {
	...
	resp, err := SendRequest[models.TickerTradingDayResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketAPIService) UiKlinesExecute(r ApiUiKlinesRequest) (*common.RestApiResponse[models.UiKlinesResponse], error) {
	...
	resp, err := SendRequest[models.UiKlinesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
