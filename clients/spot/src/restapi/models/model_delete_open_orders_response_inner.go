...
// checks if the DeleteOpenOrdersResponseInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &DeleteOpenOrdersResponseInner{}

// DeleteOpenOrdersResponseInner struct for DeleteOpenOrdersResponseInner
type DeleteOpenOrdersResponseInner struct {
...
type _DeleteOpenOrdersResponseInner DeleteOpenOrdersResponseInner
...
func NewDeleteOpenOrdersResponseInner() *DeleteOpenOrdersResponseInner {
	this := DeleteOpenOrdersResponseInner{}
	return &this
}
...
func (o DeleteOpenOrdersResponseInner) MarshalJSON() ([]byte, error) {
...
func (o DeleteOpenOrdersResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteOpenOrdersResponseInner) UnmarshalJSON(data []byte) (err error) {
	varDeleteOpenOrdersResponseInner := _DeleteOpenOrdersResponseInner{}

	err = json.Unmarshal(data, &varDeleteOpenOrdersResponseInner)

	if err != nil {
		return err
	}

	*o = DeleteOpenOrdersResponseInner(varDeleteOpenOrdersResponseInner)
...
type NullableDeleteOpenOrdersResponseInner struct {
	value *DeleteOpenOrdersResponseInner
	isSet bool
}

func (v NullableDeleteOpenOrdersResponseInner) Get() *DeleteOpenOrdersResponseInner {
	return v.value
}

func (v *NullableDeleteOpenOrdersResponseInner) Set(val *DeleteOpenOrdersResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteOpenOrdersResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteOpenOrdersResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteOpenOrdersResponseInner(val *DeleteOpenOrdersResponseInner) *NullableDeleteOpenOrdersResponseInner {
	return &NullableDeleteOpenOrdersResponseInner{value: val, isSet: true}
}

func (v NullableDeleteOpenOrdersResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteOpenOrdersResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
