...
// checks if the OrderListOtocoResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListOtocoResponse{}

// OrderListOtocoResponse struct for OrderListOtocoResponse
type OrderListOtocoResponse struct {
	...
	Orders               []OrderListOtocoResponseOrdersInner       `json:"orders,omitempty"`
	OrderReports         []OrderListOtocoResponseOrderReportsInner `json:"orderReports,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderListOtocoResponse OrderListOtocoResponse
...
func (o *OrderListOtocoResponse) GetOrders() []OrderListOtocoResponseOrdersInner {
	if o == nil || common.IsNil(o.Orders) {
		var ret []OrderListOtocoResponseOrdersInner
		return ret
	}
	return o.Orders
}
...
// SetOrders gets a reference to the given []OrderListOtocoResponseOrdersInner and assigns it to the Orders field.
...
func (o *OrderListOtocoResponse) GetOrderReports() []OrderListOtocoResponseOrderReportsInner {
	if o == nil || common.IsNil(o.OrderReports) {
		var ret []OrderListOtocoResponseOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []OrderListOtocoResponseOrderReportsInner and assigns it to the OrderReports field.
func (o *OrderListOtocoResponse) SetOrderReports(v []OrderListOtocoResponseOrderReportsInner) {
	o.OrderReports = v
}

func (o OrderListOtocoResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderListOtocoResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListOtocoResponse) UnmarshalJSON(data []byte) (err error) {
	varOrderListOtocoResponse := _OrderListOtocoResponse{}

	err = json.Unmarshal(data, &varOrderListOtocoResponse)

	if err != nil {
		return err
	}

	*o = OrderListOtocoResponse(varOrderListOtocoResponse)
...
type NullableOrderListOtocoResponse struct {
	value *OrderListOtocoResponse
	isSet bool
}

func (v NullableOrderListOtocoResponse) Get() *OrderListOtocoResponse {
	return v.value
}

func (v *NullableOrderListOtocoResponse) Set(val *OrderListOtocoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListOtocoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListOtocoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListOtocoResponse(val *OrderListOtocoResponse) *NullableOrderListOtocoResponse {
	return &NullableOrderListOtocoResponse{value: val, isSet: true}
}

func (v NullableOrderListOtocoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListOtocoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
