...
// checks if the OrderListOpoResponseOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListOpoResponseOrderReportsInner{}

// OrderListOpoResponseOrderReportsInner struct for OrderListOpoResponseOrderReportsInner
type OrderListOpoResponseOrderReportsInner struct {
...
type _OrderListOpoResponseOrderReportsInner OrderListOpoResponseOrderReportsInner
...
func NewOrderListOpoResponseOrderReportsInner() *OrderListOpoResponseOrderReportsInner {
	this := OrderListOpoResponseOrderReportsInner{}
	return &this
}
...
func (o OrderListOpoResponseOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o OrderListOpoResponseOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListOpoResponseOrderReportsInner) UnmarshalJSON(data []byte) (err error) {
	varOrderListOpoResponseOrderReportsInner := _OrderListOpoResponseOrderReportsInner{}

	err = json.Unmarshal(data, &varOrderListOpoResponseOrderReportsInner)

	if err != nil {
		return err
	}

	*o = OrderListOpoResponseOrderReportsInner(varOrderListOpoResponseOrderReportsInner)
...
type NullableOrderListOpoResponseOrderReportsInner struct {
	value *OrderListOpoResponseOrderReportsInner
	isSet bool
}

func (v NullableOrderListOpoResponseOrderReportsInner) Get() *OrderListOpoResponseOrderReportsInner {
	return v.value
}

func (v *NullableOrderListOpoResponseOrderReportsInner) Set(val *OrderListOpoResponseOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListOpoResponseOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListOpoResponseOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListOpoResponseOrderReportsInner(val *OrderListOpoResponseOrderReportsInner) *NullableOrderListOpoResponseOrderReportsInner {
	return &NullableOrderListOpoResponseOrderReportsInner{value: val, isSet: true}
}

func (v NullableOrderListOpoResponseOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListOpoResponseOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
