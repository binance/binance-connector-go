...
type _DeleteOrderResponse DeleteOrderResponse
...
func (o *DeleteOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varDeleteOrderResponse := _DeleteOrderResponse{}

	err = json.Unmarshal(data, &varDeleteOrderResponse)

	if err != nil {
		return err
	}

	*o = DeleteOrderResponse(varDeleteOrderResponse)
