...
type NewOrderResponse struct {
	...
	Fills                   []NewOrderResponseFillsInner `json:"fills,omitempty"`
...
func (o *NewOrderResponse) GetFills() []NewOrderResponseFillsInner {
	if o == nil || common.IsNil(o.Fills) {
		var ret []NewOrderResponseFillsInner
		return ret
	}
	return o.Fills
}
...
// SetFills gets a reference to the given []NewOrderResponseFillsInner and assigns it to the Fills field.
