...
// checks if the OrderOcoResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderOcoResponse{}

// OrderOcoResponse struct for OrderOcoResponse
type OrderOcoResponse struct {
	...
	Orders               []OrderOcoResponseOrdersInner       `json:"orders,omitempty"`
	OrderReports         []OrderOcoResponseOrderReportsInner `json:"orderReports,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderOcoResponse OrderOcoResponse
...
func (o *OrderOcoResponse) GetOrders() []OrderOcoResponseOrdersInner {
	if o == nil || common.IsNil(o.Orders) {
		var ret []OrderOcoResponseOrdersInner
		return ret
	}
	return o.Orders
}
...
// SetOrders gets a reference to the given []OrderOcoResponseOrdersInner and assigns it to the Orders field.
...
func (o *OrderOcoResponse) GetOrderReports() []OrderOcoResponseOrderReportsInner {
	if o == nil || common.IsNil(o.OrderReports) {
		var ret []OrderOcoResponseOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []OrderOcoResponseOrderReportsInner and assigns it to the OrderReports field.
func (o *OrderOcoResponse) SetOrderReports(v []OrderOcoResponseOrderReportsInner) {
	o.OrderReports = v
}

func (o OrderOcoResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderOcoResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrderOcoResponse) UnmarshalJSON(data []byte) (err error) {
	varOrderOcoResponse := _OrderOcoResponse{}

	err = json.Unmarshal(data, &varOrderOcoResponse)

	if err != nil {
		return err
	}

	*o = OrderOcoResponse(varOrderOcoResponse)
...
type NullableOrderOcoResponse struct {
	value *OrderOcoResponse
	isSet bool
}

func (v NullableOrderOcoResponse) Get() *OrderOcoResponse {
	return v.value
}

func (v *NullableOrderOcoResponse) Set(val *OrderOcoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderOcoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderOcoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderOcoResponse(val *OrderOcoResponse) *NullableOrderOcoResponse {
	return &NullableOrderOcoResponse{value: val, isSet: true}
}

func (v NullableOrderOcoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderOcoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
