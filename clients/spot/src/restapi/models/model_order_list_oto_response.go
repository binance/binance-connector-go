...
// checks if the OrderListOtoResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &OrderListOtoResponse{}

// OrderListOtoResponse struct for OrderListOtoResponse
type OrderListOtoResponse struct {
	...
	Orders               []OrderListOtoResponseOrdersInner       `json:"orders,omitempty"`
	OrderReports         []OrderListOtoResponseOrderReportsInner `json:"orderReports,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderListOtoResponse OrderListOtoResponse
...
func (o *OrderListOtoResponse) GetOrders() []OrderListOtoResponseOrdersInner {
	if o == nil || common.IsNil(o.Orders) {
		var ret []OrderListOtoResponseOrdersInner
		return ret
	}
	return o.Orders
}
...
// SetOrders gets a reference to the given []OrderListOtoResponseOrdersInner and assigns it to the Orders field.
...
func (o *OrderListOtoResponse) GetOrderReports() []OrderListOtoResponseOrderReportsInner {
	if o == nil || common.IsNil(o.OrderReports) {
		var ret []OrderListOtoResponseOrderReportsInner
		return ret
	}
...
// SetOrderReports gets a reference to the given []OrderListOtoResponseOrderReportsInner and assigns it to the OrderReports field.
func (o *OrderListOtoResponse) SetOrderReports(v []OrderListOtoResponseOrderReportsInner) {
	o.OrderReports = v
}

func (o OrderListOtoResponse) MarshalJSON() ([]byte, error) {
...
func (o OrderListOtoResponse) ToMap() (map[string]interface{}, error) {
...
func (o *OrderListOtoResponse) UnmarshalJSON(data []byte) (err error) {
	varOrderListOtoResponse := _OrderListOtoResponse{}

	err = json.Unmarshal(data, &varOrderListOtoResponse)

	if err != nil {
		return err
	}

	*o = OrderListOtoResponse(varOrderListOtoResponse)
...
type NullableOrderListOtoResponse struct {
	value *OrderListOtoResponse
	isSet bool
}

func (v NullableOrderListOtoResponse) Get() *OrderListOtoResponse {
	return v.value
}

func (v *NullableOrderListOtoResponse) Set(val *OrderListOtoResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderListOtoResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderListOtoResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderListOtoResponse(val *OrderListOtoResponse) *NullableOrderListOtoResponse {
	return &NullableOrderListOtoResponse{value: val, isSet: true}
}

func (v NullableOrderListOtoResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderListOtoResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
