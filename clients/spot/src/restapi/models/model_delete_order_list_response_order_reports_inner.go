...
// checks if the DeleteOrderListResponseOrderReportsInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &DeleteOrderListResponseOrderReportsInner{}

// DeleteOrderListResponseOrderReportsInner struct for DeleteOrderListResponseOrderReportsInner
type DeleteOrderListResponseOrderReportsInner struct {
...
type _DeleteOrderListResponseOrderReportsInner DeleteOrderListResponseOrderReportsInner
...
func NewDeleteOrderListResponseOrderReportsInner() *DeleteOrderListResponseOrderReportsInner {
	this := DeleteOrderListResponseOrderReportsInner{}
	return &this
}
...
func (o *DeleteOrderListResponseOrderReportsInner) GetSelfTradePreventionMode() string {
...
// and a boolean to check if the value has been set.
func (o *DeleteOrderListResponseOrderReportsInner) GetSelfTradePreventionModeOk() (*string, bool) {
	if o == nil || common.IsNil(o.SelfTradePreventionMode) {
		return nil, false
	}
...
func (o *DeleteOrderListResponseOrderReportsInner) HasSelfTradePreventionMode() bool {
	if o != nil && !common.IsNil(o.SelfTradePreventionMode) {
		return true
	}
...
func (o *DeleteOrderListResponseOrderReportsInner) SetSelfTradePreventionMode(v string) {
	o.SelfTradePreventionMode = &v
}

func (o DeleteOrderListResponseOrderReportsInner) MarshalJSON() ([]byte, error) {
...
func (o DeleteOrderListResponseOrderReportsInner) ToMap() (map[string]interface{}, error) {
...
func (o *DeleteOrderListResponseOrderReportsInner) UnmarshalJSON(data []byte) (err error) {
	varDeleteOrderListResponseOrderReportsInner := _DeleteOrderListResponseOrderReportsInner{}

	err = json.Unmarshal(data, &varDeleteOrderListResponseOrderReportsInner)

	if err != nil {
		return err
	}

	*o = DeleteOrderListResponseOrderReportsInner(varDeleteOrderListResponseOrderReportsInner)
...
type NullableDeleteOrderListResponseOrderReportsInner struct {
	value *DeleteOrderListResponseOrderReportsInner
	isSet bool
}

func (v NullableDeleteOrderListResponseOrderReportsInner) Get() *DeleteOrderListResponseOrderReportsInner {
	return v.value
}

func (v *NullableDeleteOrderListResponseOrderReportsInner) Set(val *DeleteOrderListResponseOrderReportsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableDeleteOrderListResponseOrderReportsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableDeleteOrderListResponseOrderReportsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeleteOrderListResponseOrderReportsInner(val *DeleteOrderListResponseOrderReportsInner) *NullableDeleteOrderListResponseOrderReportsInner {
	return &NullableDeleteOrderListResponseOrderReportsInner{value: val, isSet: true}
}

func (v NullableDeleteOrderListResponseOrderReportsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeleteOrderListResponseOrderReportsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
