...
// checks if the TickerResponse2Inner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &TickerResponse2Inner{}

// TickerResponse2Inner struct for TickerResponse2Inner
type TickerResponse2Inner struct {
...
type _TickerResponse2Inner TickerResponse2Inner
...
func (o TickerResponse2Inner) MarshalJSON() ([]byte, error) {
...
func (o TickerResponse2Inner) ToMap() (map[string]interface{}, error) {
...
func (o *TickerResponse2Inner) UnmarshalJSON(data []byte) (err error) {
	varTickerResponse2Inner := _TickerResponse2Inner{}

	err = json.Unmarshal(data, &varTickerResponse2Inner)

	if err != nil {
		return err
	}

	*o = TickerResponse2Inner(varTickerResponse2Inner)
...
type NullableTickerResponse2Inner struct {
	value *TickerResponse2Inner
	isSet bool
}

func (v NullableTickerResponse2Inner) Get() *TickerResponse2Inner {
	return v.value
}

func (v *NullableTickerResponse2Inner) Set(val *TickerResponse2Inner) {
	v.value = val
	v.isSet = true
}

func (v NullableTickerResponse2Inner) IsSet() bool {
	return v.isSet
}

func (v *NullableTickerResponse2Inner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTickerResponse2Inner(val *TickerResponse2Inner) *NullableTickerResponse2Inner {
	return &NullableTickerResponse2Inner{value: val, isSet: true}
}

func (v NullableTickerResponse2Inner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTickerResponse2Inner) UnmarshalJSON(src []byte) error {
	v.isSet = true
