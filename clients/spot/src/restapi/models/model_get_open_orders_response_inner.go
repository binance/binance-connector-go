...
// checks if the GetOpenOrdersResponseInner type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &GetOpenOrdersResponseInner{}

// GetOpenOrdersResponseInner struct for GetOpenOrdersResponseInner
type GetOpenOrdersResponseInner struct {
...
type _GetOpenOrdersResponseInner GetOpenOrdersResponseInner
...
func NewGetOpenOrdersResponseInner() *GetOpenOrdersResponseInner {
	this := GetOpenOrdersResponseInner{}
	return &this
}
...
func (o GetOpenOrdersResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetOpenOrdersResponseInner) ToMap() (map[string]interface{}, error) {
...
func (o *GetOpenOrdersResponseInner) UnmarshalJSON(data []byte) (err error) {
	varGetOpenOrdersResponseInner := _GetOpenOrdersResponseInner{}

	err = json.Unmarshal(data, &varGetOpenOrdersResponseInner)

	if err != nil {
		return err
	}

	*o = GetOpenOrdersResponseInner(varGetOpenOrdersResponseInner)
...
type NullableGetOpenOrdersResponseInner struct {
	value *GetOpenOrdersResponseInner
	isSet bool
}

func (v NullableGetOpenOrdersResponseInner) Get() *GetOpenOrdersResponseInner {
	return v.value
}

func (v *NullableGetOpenOrdersResponseInner) Set(val *GetOpenOrdersResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetOpenOrdersResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetOpenOrdersResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetOpenOrdersResponseInner(val *GetOpenOrdersResponseInner) *NullableGetOpenOrdersResponseInner {
	return &NullableGetOpenOrdersResponseInner{value: val, isSet: true}
}

func (v NullableGetOpenOrdersResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetOpenOrdersResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
