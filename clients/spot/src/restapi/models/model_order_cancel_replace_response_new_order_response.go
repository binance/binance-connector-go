...
type OrderCancelReplaceResponseNewOrderResponse struct {
	...
	Fills                   []OrderCancelReplaceResponseNewOrderResponseFillsInner `json:"fills,omitempty"`
...
func (o *OrderCancelReplaceResponseNewOrderResponse) GetFills() []OrderCancelReplaceResponseNewOrderResponseFillsInner {
	if o == nil || common.IsNil(o.Fills) {
		var ret []OrderCancelReplaceResponseNewOrderResponseFillsInner
		return ret
	}
	return o.Fills
}
...
// SetFills gets a reference to the given []OrderCancelReplaceResponseNewOrderResponseFillsInner and assigns it to the Fills field.
