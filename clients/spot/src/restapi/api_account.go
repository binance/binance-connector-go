...
func (a *AccountAPIService) AccountCommissionExecute(r ApiAccountCommissionRequest) (*common.RestApiResponse[models.AccountCommissionResponse], error) {
	...
	resp, err := SendRequest[models.AccountCommissionResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) AllOrderListExecute(r ApiAllOrderListRequest) (*common.RestApiResponse[models.AllOrderListResponse], error) {
	...
	resp, err := SendRequest[models.AllOrderListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) GetAccountExecute(r ApiGetAccountRequest) (*common.RestApiResponse[models.GetAccountResponse], error) {
	...
	resp, err := SendRequest[models.GetAccountResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) GetOpenOrdersExecute(r ApiGetOpenOrdersRequest) (*common.RestApiResponse[models.GetOpenOrdersResponse], error) {
	...
	resp, err := SendRequest[models.GetOpenOrdersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) GetOrderExecute(r ApiGetOrderRequest) (*common.RestApiResponse[models.GetOrderResponse], error) {
	...
	resp, err := SendRequest[models.GetOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) GetOrderListExecute(r ApiGetOrderListRequest) (*common.RestApiResponse[models.GetOrderListResponse], error) {
	...
	resp, err := SendRequest[models.GetOrderListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) MyAllocationsExecute(r ApiMyAllocationsRequest) (*common.RestApiResponse[models.MyAllocationsResponse], error) {
	...
	resp, err := SendRequest[models.MyAllocationsResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) MyFiltersExecute(r ApiMyFiltersRequest) (*common.RestApiResponse[models.MyFiltersResponse], error) {
	...
	resp, err := SendRequest[models.MyFiltersResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) MyPreventedMatchesExecute(r ApiMyPreventedMatchesRequest) (*common.RestApiResponse[models.MyPreventedMatchesResponse], error) {
	...
	resp, err := SendRequest[models.MyPreventedMatchesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) MyTradesExecute(r ApiMyTradesRequest) (*common.RestApiResponse[models.MyTradesResponse], error) {
	...
	resp, err := SendRequest[models.MyTradesResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) OpenOrderListExecute(r ApiOpenOrderListRequest) (*common.RestApiResponse[models.OpenOrderListResponse], error) {
	...
	resp, err := SendRequest[models.OpenOrderListResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) OrderAmendmentsExecute(r ApiOrderAmendmentsRequest) (*common.RestApiResponse[models.OrderAmendmentsResponse], error) {
	...
	resp, err := SendRequest[models.OrderAmendmentsResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) RateLimitOrderExecute(r ApiRateLimitOrderRequest) (*common.RestApiResponse[models.RateLimitOrderResponse], error) {
	...
	resp, err := SendRequest[models.RateLimitOrderResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
