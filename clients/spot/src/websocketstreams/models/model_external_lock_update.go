...
func (o *ExternalLockUpdate) GetSmalla() string {
...
// and a boolean to check if the value has been set.
func (o *ExternalLockUpdate) GetSmallaOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smalla) {
		return nil, false
	}
...
func (o *ExternalLockUpdate) HasSmalla() bool {
	if o != nil && !common.IsNil(o.Smalla) {
		return true
	}
...
func (o *ExternalLockUpdate) SetSmalla(v string) {
	o.Smalla = &v
}

// GetD returns the D field value if set, zero value otherwise.
func (o *ExternalLockUpdate) GetSmalld() string {
...
// and a boolean to check if the value has been set.
func (o *ExternalLockUpdate) GetSmalldOk() (*string, bool) {
	if o == nil || common.IsNil(o.Smalld) {
		return nil, false
	}
...
func (o *ExternalLockUpdate) HasSmalld() bool {
	if o != nil && !common.IsNil(o.Smalld) {
		return true
	}
...
func (o *ExternalLockUpdate) SetSmalld(v string) {
	o.Smalld = &v
}
