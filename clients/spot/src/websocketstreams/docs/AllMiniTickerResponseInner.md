...
### NewAllMiniTickerResponseInnerWithDefaults
...
`func (o *AllMiniTickerResponseInner) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *AllMiniTickerResponseInner) GetEOk() (*string, bool)`
...
`func (o *AllMiniTickerResponseInner) SetE(v string)`
