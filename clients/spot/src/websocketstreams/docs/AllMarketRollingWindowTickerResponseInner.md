...
### NewAllMarketRollingWindowTickerResponseInner
...
### NewAllMarketRollingWindowTickerResponseInnerWithDefaults
...
`func (o *AllMarketRollingWindowTickerResponseInner) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *AllMarketRollingWindowTickerResponseInner) GetEOk() (*string, bool)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) SetE(v string)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) GetO() string`

GetO returns the O field if non-nil, zero value otherwise.

### GetOOk

`func (o *AllMarketRollingWindowTickerResponseInner) GetOOk() (*string, bool)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) SetO(v string)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) GetL() string`

GetL returns the L field if non-nil, zero value otherwise.

### GetLOk

`func (o *AllMarketRollingWindowTickerResponseInner) GetLOk() (*string, bool)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) SetL(v string)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) GetC() string`

GetC returns the C field if non-nil, zero value otherwise.

### GetCOk

`func (o *AllMarketRollingWindowTickerResponseInner) GetCOk() (*string, bool)`
...
`func (o *AllMarketRollingWindowTickerResponseInner) SetC(v string)`
