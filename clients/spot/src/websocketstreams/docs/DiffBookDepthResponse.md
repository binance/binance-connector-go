...
### NewDiffBookDepthResponseWithDefaults
...
`func (o *DiffBookDepthResponse) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *DiffBookDepthResponse) GetEOk() (*string, bool)`
...
`func (o *DiffBookDepthResponse) SetE(v string)`
