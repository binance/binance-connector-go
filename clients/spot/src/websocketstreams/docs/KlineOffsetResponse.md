...
### NewKlineOffsetResponseWithDefaults
...
`func (o *KlineOffsetResponse) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *KlineOffsetResponse) GetEOk() (*string, bool)`
...
`func (o *KlineOffsetResponse) SetE(v string)`
