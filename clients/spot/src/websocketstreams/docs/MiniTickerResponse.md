...
### NewMiniTickerResponseWithDefaults
...
`func (o *MiniTickerResponse) GetE() string`

GetE returns the E field if non-nil, zero value otherwise.

### GetEOk

`func (o *MiniTickerResponse) GetEOk() (*string, bool)`
...
`func (o *MiniTickerResponse) SetE(v string)`
