...
func (a *StableRateAPIService) CheckCollateralRepayRateStableRateExecute(r ApiCheckCollateralRepayRateStableRateRequest) (*common.RestApiResponse[models.CheckCollateralRepayRateStableRateResponse], error) {
	...
	resp, err := SendRequest[models.CheckCollateralRepayRateStableRateResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *StableRateAPIService) GetCryptoLoansIncomeHistoryExecute(r ApiGetCryptoLoansIncomeHistoryRequest) (*common.RestApiResponse[models.GetCryptoLoansIncomeHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetCryptoLoansIncomeHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *StableRateAPIService) GetLoanBorrowHistoryExecute(r ApiGetLoanBorrowHistoryRequest) (*common.RestApiResponse[models.GetLoanBorrowHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetLoanBorrowHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *StableRateAPIService) GetLoanLtvAdjustmentHistoryExecute(r ApiGetLoanLtvAdjustmentHistoryRequest) (*common.RestApiResponse[models.GetLoanLtvAdjustmentHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetLoanLtvAdjustmentHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *StableRateAPIService) GetLoanRepaymentHistoryExecute(r ApiGetLoanRepaymentHistoryRequest) (*common.RestApiResponse[models.GetLoanRepaymentHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetLoanRepaymentHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
