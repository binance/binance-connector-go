...
```bash
go get github.com/binance/binance-connector-go/clients/cryptoloan
```
...
For information on migrating from previous versions of the Binance Go Crypto Loan SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
