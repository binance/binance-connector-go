...
------------ | ------------- | ------------- | -------------
**TokenId** | Pointer to **string** | Unique token identifier. | [optional] 
**ChainId** | Pointer to **string** | Chain ID. | [optional] 
**ChainIconUrl** | Pointer to **string** | Chain icon URL. | [optional] 
**ChainName** | Pointer to **string** | Chain name. | [optional] 
**ContractAddress** | Pointer to **string** | Token contract address. | [optional] 
**Name** | Pointer to **string** | Token name. | [optional] 
**Symbol** | Pointer to **string** | Token symbol. | [optional] 
**IconUrl** | Pointer to **string** | Token icon URL. | [optional] 
**Price** | Pointer to **string** | Latest token price. | [optional] 
**PercentChange24h** | Pointer to **string** | 24-hour price change percentage. | [optional] 
**Volume24h** | Pointer to **string** | 24-hour trading volume. | [optional] 
...
**AlphaId** | Pointer to **string** | ALPHA token ID, e.g. ALPHA_175. | [optional] 
