...
// RestAPIClient manages communication with the Alpha Trading REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Alpha Trading REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-alpha/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
