...
// checks if the FullDepthResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &FullDepthResponse{}

// FullDepthResponse struct for FullDepthResponse
type FullDepthResponse struct {
	...
	Data                 *FullDepthResponseData `json:"data,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _FullDepthResponse FullDepthResponse
...
// SetData gets a reference to the given FullDepthResponseData and assigns it to the Data field.
func (o *FullDepthResponse) SetData(v FullDepthResponseData) {
	o.Data = &v
}

func (o FullDepthResponse) MarshalJSON() ([]byte, error) {
...
func (o FullDepthResponse) ToMap() (map[string]interface{}, error) {
...
func (o *FullDepthResponse) UnmarshalJSON(data []byte) (err error) {
	varFullDepthResponse := _FullDepthResponse{}

	err = json.Unmarshal(data, &varFullDepthResponse)

	if err != nil {
		return err
	}

	*o = FullDepthResponse(varFullDepthResponse)
...
type NullableFullDepthResponse struct {
	value *FullDepthResponse
	isSet bool
}

func (v NullableFullDepthResponse) Get() *FullDepthResponse {
	return v.value
}

func (v *NullableFullDepthResponse) Set(val *FullDepthResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFullDepthResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFullDepthResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFullDepthResponse(val *FullDepthResponse) *NullableFullDepthResponse {
	return &NullableFullDepthResponse{value: val, isSet: true}
}

func (v NullableFullDepthResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFullDepthResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
