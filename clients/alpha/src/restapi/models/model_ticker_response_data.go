...
type _TickerResponseData TickerResponseData
...
func (o TickerResponseData) MarshalJSON() ([]byte, error) {
...
func (o TickerResponseData) ToMap() (map[string]interface{}, error) {
...
func (o *TickerResponseData) UnmarshalJSON(data []byte) (err error) {
	varTickerResponseData := _TickerResponseData{}

	err = json.Unmarshal(data, &varTickerResponseData)

	if err != nil {
		return err
	}

	*o = TickerResponseData(varTickerResponseData)
...
type NullableTickerResponseData struct {
	value *TickerResponseData
	isSet bool
}

func (v NullableTickerResponseData) Get() *TickerResponseData {
	return v.value
}

func (v *NullableTickerResponseData) Set(val *TickerResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableTickerResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableTickerResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTickerResponseData(val *TickerResponseData) *NullableTickerResponseData {
	return &NullableTickerResponseData{value: val, isSet: true}
}

func (v NullableTickerResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTickerResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
