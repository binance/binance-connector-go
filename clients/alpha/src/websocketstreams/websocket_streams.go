...
// WebsocketStreamsClient manages communication with the Binance Alpha WebSocket Market Streams WebSocket Streams v1.9.0
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-alpha/1.9.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
