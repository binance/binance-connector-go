...
// WebsocketStreamsClient manages communication with the Binance Alpha WebSocket Market Streams WebSocket Streams v1.10.1
...
func NewWebsocketStreamsClient(cfg *common.ConfigurationWebsocketStreams) *WebsocketStreamsClient {
	...
	c.userAgent = "binance-alpha/1.10.1 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
