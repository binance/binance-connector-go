...
type ApiDepositRequest struct {
	...
	currency         *string
	apiPaymentMethod *models.DepositRequestApiPaymentMethod
	amount           *string
	recvWindow       *int64
...
func (r ApiDepositRequest) ApiPaymentMethod(apiPaymentMethod models.DepositRequestApiPaymentMethod) ApiDepositRequest {
	r.apiPaymentMethod = &apiPaymentMethod
	return r
}

// deposit amount
func (r ApiDepositRequest) Amount(amount string) ApiDepositRequest {
	r.amount = &amount
	return r
}
...
*/
func (a *DefaultAPIService) Deposit(ctx context.Context) ApiDepositRequest {
	return ApiDepositRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) DepositExecute(r ApiDepositRequest) (*common.RestApiResponse[models.DepositResponse], error) {
	...
	resp, err := SendRequest[models.DepositResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
type ApiFiatWithdrawRequest struct {
	...
	ApiService       *DefaultAPIService
	currency         *string
	apiPaymentMethod *models.FiatWithdrawRequestApiPaymentMethod
	amount           *int64
	accountInfo      *models.FiatWithdrawRequestAccountInfo
	recvWindow       *int64
	ext              *map[string]interface{}
}
...
func (r ApiFiatWithdrawRequest) ApiPaymentMethod(apiPaymentMethod models.FiatWithdrawRequestApiPaymentMethod) ApiFiatWithdrawRequest {
	r.apiPaymentMethod = &apiPaymentMethod
	return r
}
...
func (r ApiFiatWithdrawRequest) AccountInfo(accountInfo models.FiatWithdrawRequestAccountInfo) ApiFiatWithdrawRequest {
...
/*
FiatWithdraw Fiat Withdraw (TRADE)
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param currency -  Fiat currency, such as BRL, ARS, MXN
@param apiPaymentMethod -
...
*/
func (a *DefaultAPIService) FiatWithdraw(ctx context.Context) ApiFiatWithdrawRequest {
	return ApiFiatWithdrawRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) FiatWithdrawExecute(r ApiFiatWithdrawRequest) (*common.RestApiResponse[models.FiatWithdrawResponse], error) {
	localVarHTTPMethod := http.MethodPost
	...
	resp, err := SendRequest[models.FiatWithdrawResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
*/
func (a *DefaultAPIService) GetFiatDepositWithdrawHistory(ctx context.Context) ApiGetFiatDepositWithdrawHistoryRequest {
	return ApiGetFiatDepositWithdrawHistoryRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) GetFiatDepositWithdrawHistoryExecute(r ApiGetFiatDepositWithdrawHistoryRequest) (*common.RestApiResponse[models.GetFiatDepositWithdrawHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFiatDepositWithdrawHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
*/
func (a *DefaultAPIService) GetFiatPaymentsHistory(ctx context.Context) ApiGetFiatPaymentsHistoryRequest {
	return ApiGetFiatPaymentsHistoryRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) GetFiatPaymentsHistoryExecute(r ApiGetFiatPaymentsHistoryRequest) (*common.RestApiResponse[models.GetFiatPaymentsHistoryResponse], error) {
	localVarHTTPMethod := http.MethodGet
	...
	resp, err := SendRequest[models.GetFiatPaymentsHistoryResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
...
@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@param orderNo -  Order ID retrieved from the withdrawal API
@param recvWindow -
@return ApiGetOrderDetailRequest
*/
func (a *DefaultAPIService) GetOrderDetail(ctx context.Context) ApiGetOrderDetailRequest {
	return ApiGetOrderDetailRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) GetOrderDetailExecute(r ApiGetOrderDetailRequest) (*common.RestApiResponse[models.GetOrderDetailResponse], error) {
	localVarHTTPMethod := http.MethodGet
	...
	resp, err := SendRequest[models.GetOrderDetailResponse](
		r.ctx,
		localVarPath,
		localVarHTTPMethod,
		localVarQueryParams,
