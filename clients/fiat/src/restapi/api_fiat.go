...
func (a *FiatAPIService) DepositExecute(r ApiDepositRequest) (*common.RestApiResponse[models.DepositResponse], error) {
	...
	resp, err := SendRequest[models.DepositResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FiatAPIService) FiatWithdrawExecute(r ApiFiatWithdrawRequest) (*common.RestApiResponse[models.FiatWithdrawResponse], error) {
	...
	resp, err := SendRequest[models.FiatWithdrawResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FiatAPIService) GetFiatDepositWithdrawHistoryExecute(r ApiGetFiatDepositWithdrawHistoryRequest) (*common.RestApiResponse[models.GetFiatDepositWithdrawHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFiatDepositWithdrawHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FiatAPIService) GetFiatPaymentsHistoryExecute(r ApiGetFiatPaymentsHistoryRequest) (*common.RestApiResponse[models.GetFiatPaymentsHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetFiatPaymentsHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *FiatAPIService) GetOrderDetailExecute(r ApiGetOrderDetailRequest) (*common.RestApiResponse[models.GetOrderDetailResponse], error) {
	...
	resp, err := SendRequest[models.GetOrderDetailResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
