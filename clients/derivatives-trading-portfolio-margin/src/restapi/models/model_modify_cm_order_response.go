...
// checks if the ModifyCmOrderResponse type satisfies the MappedNullable interface at compile time
var _ common.MappedNullable = &ModifyCmOrderResponse{}
...
type _ModifyCmOrderResponse ModifyCmOrderResponse
...
func (o ModifyCmOrderResponse) MarshalJSON() ([]byte, error) {
...
func (o ModifyCmOrderResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ModifyCmOrderResponse) UnmarshalJSON(data []byte) (err error) {
	varModifyCmOrderResponse := _ModifyCmOrderResponse{}

	err = json.Unmarshal(data, &varModifyCmOrderResponse)

	if err != nil {
		return err
	}

	*o = ModifyCmOrderResponse(varModifyCmOrderResponse)
...
type NullableModifyCmOrderResponse struct {
	value *ModifyCmOrderResponse
	isSet bool
}

func (v NullableModifyCmOrderResponse) Get() *ModifyCmOrderResponse {
	return v.value
}

func (v *NullableModifyCmOrderResponse) Set(val *ModifyCmOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableModifyCmOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableModifyCmOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModifyCmOrderResponse(val *ModifyCmOrderResponse) *NullableModifyCmOrderResponse {
	return &NullableModifyCmOrderResponse{value: val, isSet: true}
}

func (v NullableModifyCmOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModifyCmOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
