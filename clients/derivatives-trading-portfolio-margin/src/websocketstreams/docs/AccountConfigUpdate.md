...
`func (o *AccountConfigUpdate) GetFs() string`

GetFs returns the Fs field if non-nil, zero value otherwise.

### GetFsOk

`func (o *AccountConfigUpdate) GetFsOk() (*string, bool)`
...
`func (o *AccountConfigUpdate) SetFs(v string)`

SetFs sets Fs field to given value.

### HasFs

`func (o *AccountConfigUpdate) HasFs() bool`
