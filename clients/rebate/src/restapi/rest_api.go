...
// RestAPIClient manages communication with the Rebate REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Rebate REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-rebate/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
