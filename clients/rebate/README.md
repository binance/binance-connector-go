...
```bash
go get github.com/binance/binance-connector-go/clients/rebate
```
...
For information on migrating from previous versions of the Binance Go Rebate SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
