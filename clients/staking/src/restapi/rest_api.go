...
// RestAPIClient manages communication with the Staking REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Staking REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-staking/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
