...
func (a *EthStakingAPIService) EthStakingAccountExecute(r ApiEthStakingAccountRequest) (*common.RestApiResponse[models.EthStakingAccountResponse], error) {
	...
	resp, err := SendRequest[models.EthStakingAccountResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetCurrentEthStakingQuotaExecute(r ApiGetCurrentEthStakingQuotaRequest) (*common.RestApiResponse[models.GetCurrentEthStakingQuotaResponse], error) {
	...
	resp, err := SendRequest[models.GetCurrentEthStakingQuotaResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetEthRedemptionHistoryExecute(r ApiGetEthRedemptionHistoryRequest) (*common.RestApiResponse[models.GetEthRedemptionHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetEthRedemptionHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetEthStakingHistoryExecute(r ApiGetEthStakingHistoryRequest) (*common.RestApiResponse[models.GetEthStakingHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetEthStakingHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetWbethRateHistoryExecute(r ApiGetWbethRateHistoryRequest) (*common.RestApiResponse[models.GetWbethRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetWbethRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetWbethRewardsHistoryExecute(r ApiGetWbethRewardsHistoryRequest) (*common.RestApiResponse[models.GetWbethRewardsHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetWbethRewardsHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetWbethUnwrapHistoryExecute(r ApiGetWbethUnwrapHistoryRequest) (*common.RestApiResponse[models.GetWbethUnwrapHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetWbethUnwrapHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) GetWbethWrapHistoryExecute(r ApiGetWbethWrapHistoryRequest) (*common.RestApiResponse[models.GetWbethWrapHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetWbethWrapHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) RedeemEthExecute(r ApiRedeemEthRequest) (*common.RestApiResponse[models.RedeemEthResponse], error) {
	...
	resp, err := SendRequest[models.RedeemEthResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) SubscribeEthStakingExecute(r ApiSubscribeEthStakingRequest) (*common.RestApiResponse[models.SubscribeEthStakingResponse], error) {
	...
	resp, err := SendRequest[models.SubscribeEthStakingResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *EthStakingAPIService) WrapBethExecute(r ApiWrapBethRequest) (*common.RestApiResponse[models.WrapBethResponse], error) {
	...
	resp, err := SendRequest[models.WrapBethResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
