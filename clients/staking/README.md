...
func ClaimBoostRewards() {
	...
	resp, err := apiClient.RestApi.AssetManagementAPI.ClaimBoostRewards(context.Background()).Execute()
	if err != nil {
		log.Println(err)
		return
	}
...
For information on migrating from previous versions of the Binance Go Staking SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
