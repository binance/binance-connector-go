...
// RestAPIClient manages communication with the Gift Card REST API API v1.10.0
...
// NewRestAPIClient creates a new Binance Gift Card REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-giftcard/1.10.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
