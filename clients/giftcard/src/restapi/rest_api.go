...
// RestAPIClient manages communication with the Binance Gift Card REST API API v1.3.0
...
// NewRestAPIClient creates a new Binance Binance Gift Card REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-giftcard/1.3.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
