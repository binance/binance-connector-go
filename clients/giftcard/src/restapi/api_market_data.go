...
func (a *MarketDataAPIService) CreateADualTokenGiftCardExecute(r ApiCreateADualTokenGiftCardRequest) (*common.RestApiResponse[models.CreateADualTokenGiftCardResponse], error) {
	...
	resp, err := SendRequest[models.CreateADualTokenGiftCardResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) CreateASingleTokenGiftCardExecute(r ApiCreateASingleTokenGiftCardRequest) (*common.RestApiResponse[models.CreateASingleTokenGiftCardResponse], error) {
	...
	resp, err := SendRequest[models.CreateASingleTokenGiftCardResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) FetchRsaPublicKeyExecute(r ApiFetchRsaPublicKeyRequest) (*common.RestApiResponse[models.FetchRsaPublicKeyResponse], error) {
	...
	resp, err := SendRequest[models.FetchRsaPublicKeyResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) FetchTokenLimitExecute(r ApiFetchTokenLimitRequest) (*common.RestApiResponse[models.FetchTokenLimitResponse], error) {
	...
	resp, err := SendRequest[models.FetchTokenLimitResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) RedeemABinanceGiftCardExecute(r ApiRedeemABinanceGiftCardRequest) (*common.RestApiResponse[models.RedeemABinanceGiftCardResponse], error) {
	...
	resp, err := SendRequest[models.RedeemABinanceGiftCardResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *MarketDataAPIService) VerifyBinanceGiftCardByGiftCardNumberExecute(r ApiVerifyBinanceGiftCardByGiftCardNumberRequest) (*common.RestApiResponse[models.VerifyBinanceGiftCardByGiftCardNumberResponse], error) {
	...
	resp, err := SendRequest[models.VerifyBinanceGiftCardByGiftCardNumberResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
