...
For information on migrating from previous versions of the Binance Go Sub Account SDK, please refer to the [Migration Guide](./docs/migration-guide.md).
