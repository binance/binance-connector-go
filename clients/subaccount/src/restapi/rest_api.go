...
// RestAPIClient manages communication with the Sub Account REST API API v1.13.0
...
// NewRestAPIClient creates a new Binance Sub Account REST API REST API client
//
...
func NewRestAPIClient(cfg *common.ConfigurationRestAPI) *RestAPIClient {
	...
	customHeaders["User-Agent"] = "binance-subaccount/1.13.0 (Go/" + runtime.Version() + "; " + runtime.GOOS + "; " + runtime.GOARCH + ")"
