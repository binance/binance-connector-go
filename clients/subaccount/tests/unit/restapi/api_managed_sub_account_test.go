...
func Test_binancesubaccountrestapi_ManagedSubAccountAPIService(t *testing.T) {
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountAssetDetails Success", func(t *testing.T) {
		...
		var mockedJSON string
		mockedJSON = `[{"coin":"INJ","name":"Injective Protocol","totalBalance":"0","availableBalance":"0","inOrder":"0","btcValue":"0"}]`
		if mockedJSON == "" {
			mockedJSON = `{}`
		}
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountAssetDetails(context.Background()).Email("abc@test.com").Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountFuturesAssetDetails Success", func(t *testing.T) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountFuturesAssetDetails(context.Background()).Email("abc@test.com").Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountMarginAssetDetails Success", func(t *testing.T) {
		...
		var mockedJSON string
		mockedJSON = `{"marginLevel":"999","totalAssetOfBtc":"0","totalLiabilityOfBtc":"0","totalNetAssetOfBtc":"0","userAssets":[{"asset":"MATIC","borrowed":"0","free":"0","interest":"0","locked":"0","netAsset":"0"}]}`
		if mockedJSON == "" {
			mockedJSON = `{}`
		}
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountMarginAssetDetails(context.Background()).Email("abc@test.com").Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountSnapshot Success", func(t *testing.T) {
		...
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			require.Equal(t, "abc@test.com", r.URL.Query().Get("email"))
			require.Equal(t, string(models.QueryManagedSubAccountSnapshotTypeParameterSpot), r.URL.Query().Get("type"))
			w.Header().Set("Content-Type", "application/json")
			_, _ = w.Write([]byte(mockedJSON))
		}))
		defer mockServer.Close()
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountTransferLogMasterAccountInvestor Success", func(t *testing.T) {
		...
		var mockedJSON string
		mockedJSON = `{"managerSubTransferHistoryVos":[{"fromEmail":"test_0_virtual@kq3kno9imanagedsub.com","fromAccountType":"SPOT","toEmail":"wdywl0lddakh@test.com","toAccountType":"SPOT","asset":"BNB","amount":"0.01","scheduledData":1679416673000,"createTime":1679416673000,"status":"SUCCESS","tranId":91077779}],"count":2}`
		if mockedJSON == "" {
			mockedJSON = `{}`
		}
		mockServer := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountTransferLogMasterAccountInvestor(context.Background()).Email("abc@test.com").StartTime(int64(1623319461670)).EndTime(int64(1641782889000)).Page(int64(1)).Limit(int64(1)).Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountTransferLogMasterAccountTrading Success", func(t *testing.T) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountTransferLogMasterAccountTrading(context.Background()).Email("abc@test.com").StartTime(int64(1623319461670)).EndTime(int64(1641782889000)).Page(int64(1)).Limit(int64(10)).Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
	...
	t.Run("Test ManagedSubAccountAPIService QueryManagedSubAccountTransferLogSubAccountTrading Success", func(t *testing.T) {
		...
		resp, err := apiClient.RestApi.ManagedSubAccountAPI.QueryManagedSubAccountTransferLogSubAccountTrading(context.Background()).StartTime(int64(1623319461670)).EndTime(int64(1641782889000)).Page(int64(1)).Limit(int64(10)).Execute()
		require.NoError(t, err)
		require.NotNil(t, resp)
		require.Equal(
			t,
