...
func (a *RwusdAPIService) GetRwusdAccountExecute(r ApiGetRwusdAccountRequest) (*common.RestApiResponse[models.GetRwusdAccountResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdAccountResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) GetRwusdQuotaDetailsExecute(r ApiGetRwusdQuotaDetailsRequest) (*common.RestApiResponse[models.GetRwusdQuotaDetailsResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdQuotaDetailsResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) GetRwusdRateHistoryExecute(r ApiGetRwusdRateHistoryRequest) (*common.RestApiResponse[models.GetRwusdRateHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdRateHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) GetRwusdRedemptionHistoryExecute(r ApiGetRwusdRedemptionHistoryRequest) (*common.RestApiResponse[models.GetRwusdRedemptionHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdRedemptionHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) GetRwusdRewardsHistoryExecute(r ApiGetRwusdRewardsHistoryRequest) (*common.RestApiResponse[models.GetRwusdRewardsHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdRewardsHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) GetRwusdSubscriptionHistoryExecute(r ApiGetRwusdSubscriptionHistoryRequest) (*common.RestApiResponse[models.GetRwusdSubscriptionHistoryResponse], error) {
	...
	resp, err := SendRequest[models.GetRwusdSubscriptionHistoryResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) RedeemRwusdExecute(r ApiRedeemRwusdRequest) (*common.RestApiResponse[models.RedeemRwusdResponse], error) {
	...
	resp, err := SendRequest[models.RedeemRwusdResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *RwusdAPIService) SubscribeRwusdExecute(r ApiSubscribeRwusdRequest) (*common.RestApiResponse[models.SubscribeRwusdResponse], error) {
	...
	resp, err := SendRequest[models.SubscribeRwusdResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
