...
func (a *AccountAPIService) AccountApiTradingStatusExecute(r ApiAccountApiTradingStatusRequest) (*common.RestApiResponse[models.AccountApiTradingStatusResponse], error) {
	...
	resp, err := SendRequest[models.AccountApiTradingStatusResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) AccountInfoExecute(r ApiAccountInfoRequest) (*common.RestApiResponse[models.AccountInfoResponse], error) {
	...
	resp, err := SendRequest[models.AccountInfoResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) AccountStatusExecute(r ApiAccountStatusRequest) (*common.RestApiResponse[models.AccountStatusResponse], error) {
	...
	resp, err := SendRequest[models.AccountStatusResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) DailyAccountSnapshotExecute(r ApiDailyAccountSnapshotRequest) (*common.RestApiResponse[models.DailyAccountSnapshotResponse], error) {
	...
	resp, err := SendRequest[models.DailyAccountSnapshotResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
...
func (a *AccountAPIService) GetApiKeyPermissionExecute(r ApiGetApiKeyPermissionRequest) (*common.RestApiResponse[models.GetApiKeyPermissionResponse], error) {
	...
	resp, err := SendRequest[models.GetApiKeyPermissionResponse](r.ctx, localVarPath, localVarHTTPMethod, localVarQueryParams, localVarBodyParameters, a.client.cfg)
	if err != nil || resp == nil {
		return nil, err
	}
